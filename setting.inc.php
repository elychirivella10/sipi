...
/* Ubicación o Ruta para los Oficios de Devoluciones Generados */
$ruta_devolucion = "$doc_root/apl/sipi/documentos/devueltas";
...
$substind     = "SIPI - SubSistema de Indicaciones Geogr&aacute;ficas";
