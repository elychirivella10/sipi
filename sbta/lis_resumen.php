...
// (Lis_resumen.php por Busqueda en el resumen de las patentes)
...
// Realizando Consulta por Campo resumen de la patente
$valor1 = $_POST["resumen"];
...
$criterio="Criterio: Resumen= ".$valor1; 
  ...
  switch($modoconsulta)
   {
	 ...
	 $resultado=pg_exec("SELECT stzderec.solicitud, stzderec.nombre 
			...
			WHERE stppatee.resumen like '$valor1' 
