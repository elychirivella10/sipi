<?php 
// Programa PHP. Pantalla de Busqueda por Clasificación Locarno
// (blocarno.php por Clasificacion Locarno) 
...
<td valign="top" bgcolor="#fffff8">
		...
		<p align="left"><font face="Tahoma" size="2"><b>B&uacute;squeda por Clasificaci&oacute;n Locarno</b></font></p>

   <table border="1" width="95%" height="89">
    <tr>
      <td width="100%" height="19" class="celda1">
       Coloque la Clasificaci&oacute;n que desea Buscar: (Formato: 99-99)
      </td>
    </tr>
	 <tr>
    <td width="100%" height="16" class="celda2"><p>
	    <form method="POST" action="listado_locar.php">
	 	 <p style="line-height: 100%"> 
	       ...
	       <input type="text" size="5" name="locarno" maxlength="5">
