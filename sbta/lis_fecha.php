...
// (Lis_fecha.php por Fecha de publicacion de la patente)
...
$criterio="Criterio: Publicaci&oacute;n= ".$valor1; 
...
//$resultado=pg_exec("SELECT * FROM stppatee WHERE fecha_publi='$valor1' and registro!='' OFFSET $inicio LIMIT $cuanto ");

$resultado=pg_exec("SELECT solicitud, nombre
                        FROM stzderec 
                        WHERE tipo_mp='P' 
		        AND fecha_publi = '$valor1' OFFSET $inicio LIMIT $cuanto  ");
$cantidad=pg_exec("SELECT solicitud, nombre
                        FROM stzderec 
                        WHERE tipo_mp='P' 
		        AND fecha_publi = '$valor1'");       
...
<table border="0" width="100%">
  <tr>
    ...
    <td width="71%"><div class="h1bar" align="center">SIPI - Servicio Aut&oacute;nomo de la Propiedad Intelectual</div>
      <center><b>
Sistema de B&uacute;squeda de Patentes
    ...
    <!--<td width="15%">
      <b><img border="0" src="logo-mpc-trans.gif" width="66" height="34" align="right">
</b>
    </td>-->
</tr>
</table>
...
<form method="POST" action="lis_fecha.php">
