<?php 
// Programa PHP. Pantalla de Busqueda de Resumen de Patentes 
// (bresumen.php por Resumen de las patentes) 
...
<td valign="top" bgcolor="#fffff8">
	...
	<p align="left"><font face="Tahoma" size="2"><b>B&uacute;squeda por Resumen </b></font></p>
   <table border="1" width="95%" height="89">
    <tr>
      <td width="100%" height="19" class="celda1">
       Coloque cualquier palabra que desee buscar en el resumen del Documento 
      </td>
    </tr>
	 <tr>
    <td width="100%" height="16" class="celda2"><p>
		 <form method="POST" action="lis_resumen.php">     
           ...
           <option value="<?= BÚSQUEDA_NOMBRE_PALABRA_CONTENIDA ?>">contengan la porci&oacute;n de texto</option>
		     ...
		     <input type="text" name="resumen" onKeyPress="javascript:this.value=this.value.toUpperCase();">
