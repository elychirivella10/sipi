...
$smarty ->assign('fechahoy',$fecha); 
   ...
   $vtipest=array(2002,2023,2024,2030,2006,2101,2102,2103,2200,2119,2025,2910,2752,2750,2090,2209,2208,2207,2206,2205,2009,2556,2917,2918,2800,2801,2802,2804,2805,2806,2809,2821,2833,2835,2836,2837,2838,2840,2921,2922);
   $vtipsol=array("Orden de Publicacion","Publicacion Prensa Extemporanea","Publicacion Prensa Defectuosa","Perimidas por NO Publicacion Prensa","Solicitadas","Concedidas","Negadas","Devueltas por Fondo","Devueltas por Forma","Denegadas","Prioridad Extinguida","Desistidas",
                  "Sin Efecto por NO Pago de Concesion","Anuladas","Abandonadas","Cambios de Titular","Cambios de Domicilio","Licencias de Uso","Fusiones","Cesiones","Oposiciones","Rehabilitacion","Sin Efecto Falto de Pago","Sin Efecto por Vencimiento","Ratificacion Estatus 800","Ratificacion Estatus 801",
                  "Ratificacion Estatus 802","Ratificacion Estatus 804","Ratificacion Estatus 805","Ratificacion Estatus 806","Ratificacion Estatus 809","Ratificacion Estatus 821","Ratificacion Estatus 833","Ratificacion Estatus 835","Ratificacion Estatus 836","Ratificacion Estatus 837","Ratificacion Estatus 838","Ratificacion Estatus 840","Ratificacion Estatus 921","Ratificacion Estatus 922");
   ...
   if ($vopc==3 || $vopc==2) {
	...
	pg_exec("COMMIT WORK"); 
      ...
      if ($vtip==2002 || $vtip==2023 || $vtip==2024 || $vtip==2030
                      ...
                      || $vtip==2836 || $vtip==2837 || $vtip==2838 || $vtip==2840 || $vtip==2921 || $vtip==2922) {
         if ($vtip==2556) {
