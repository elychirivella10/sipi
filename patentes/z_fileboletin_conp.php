...
<?php
// *************************************************************************************
// Programa: z_fileboletin_con.php 
...
if ($vopc==2) {
 ...
 $ejecute1 = pg_exec("select '414' as t1, '3115457' as telefono, concat('SAPI INFORMA: SU SOLICITUD 0000-000000 FUE CONCEDIDA EN EL BOLETIN ',$boletin,'. PARA MAYOR INFORMACION INGRESE EN WEBPI.') as mensaje
UNION
select '412' as t1, '0259949' as telefono, concat('SAPI INFORMA: SU SOLICITUD 0000-000000 FUE CONCEDIDA EN EL BOLETIN ',$boletin,'. PARA MAYOR INFORMACION INGRESE EN WEBPI.') as mensaje
UNION
SELECT substr(trim(telefono1),2,3) as t1, substr(trim(telefono1),6,7) as telefono, concat('SAPI INFORMA: SU SOLICITUD ',solicitud,' FUE CONCEDIDA EN EL BOLETIN ',$boletin,'. PARA MAYOR INFORMACION INGRESE EN WEBPI.') as mensaje
 FROM stzderec a, stzevtrd b, stzottid c, stzsolic d
	WHERE a.nro_derecho=b.nro_derecho and a.tipo_mp='P' and
              ...
              b.evento-2000 in (122,930) and b.estat_ant-2000 in (101,1,191,8) and
              b.documento=$boletin and
              trim(d.telefono1)<>'' and substr(trim(d.telefono1),1,4) in ('0414','0424','0416','0426','0412')
UNION
SELECT substr(trim(telefono2),2,3) as t1, substr(trim(telefono2),6,7) as telefono, concat('SAPI INFORMA: SU SOLICITUD ',solicitud,' FUE CONCEDIDA EN EL BOLETIN ',$boletin,'. PARA MAYOR INFORMACION INGRESE EN WEBPI.') as mensaje
 FROM stzderec a, stzevtrd b, stzottid c, stzsolic d
	WHERE a.nro_derecho=b.nro_derecho and a.tipo_mp='P' and
              a.nro_derecho=c.nro_derecho and c.titular=d.titular and c.titular>0 and
              b.evento-2000 in (122,930) and b.estat_ant-2000 in (101,1,191,8) and
...
SELECT substr(trim(telefono2),2,3) as t1, substr(trim(telefono2),6,7) as telefono, concat('SAPI INFORMA: SU SOLICITUD ',solicitud,' FUE CONCEDIDA EN EL BOLETIN ',$boletin,'. PARA MAYOR INFORMACION INGRESE EN WEBPI.') as mensaje
 FROM stzderec a, stzevtrd b, stzagenr d
	WHERE a.nro_derecho=b.nro_derecho and a.tipo_mp='P' and
              ...
              trim(d.telefono2)<>'' and substr(trim(d.telefono2),1,4) in ('0414','0424','0416','0426','0412')
UNION
SELECT substr(trim(telefono1),2,3) as t1, substr(trim(telefono1),6,7) as telefono, concat('SAPI INFORMA: EL LAPSO PARA CANCELAR DERECHOS DE REGISTRO O CONCESION DE SU SOLICITUD Nro. ',solicitud,' VENCE EL PROXIMO ','$fechapub','. PARA MAYOR INFORMACI0N INGRESE EN WEBPI.') as mensaje
 FROM stzderec a, stzevtrd b, stzottid c, stzsolic d
	WHERE a.nro_derecho=b.nro_derecho and a.tipo_mp='P' and
              a.nro_derecho=c.nro_derecho and c.titular=d.titular and c.titular>0 and
              b.evento-2000 in (122,930) and b.estat_ant-2000 in (101,1,191,8) and
              ...
              trim(d.telefono1)<>'' and substr(trim(d.telefono1),1,4) in ('0414','0424','0416','0426','0412')
UNION
SELECT substr(trim(telefono2),2,3) as t1, substr(trim(telefono2),6,7) as telefono, concat('SAPI INFORMA: EL LAPSO PARA CANCELAR DERECHOS DE REGISTRO O CONCESION DE SU SOLICITUD Nro. ',solicitud,' VENCE EL PROXIMO ','$fechapub','. PARA MAYOR INFORMACI0N INGRESE EN WEBPI.') as mensaje
 FROM stzderec a, stzevtrd b, stzottid c, stzsolic d
	WHERE a.nro_derecho=b.nro_derecho and a.tipo_mp='P' and
              a.nro_derecho=c.nro_derecho and c.titular=d.titular and c.titular>0 and
              b.evento-2000 in (122,930) and b.estat_ant-2000 in (101,1,191,8) and
...
//Crea el archivo
$vruta="../../sms/";
$txt=$vruta.'Boletin'.$boletin.'_sms_concedidas_p.txt';
$open=fopen($vruta.'Boletin'.$boletin.'_sms_concedidas_p.txt',"w+");
...
fclose($open);  
 ...
 $adjuntos[$count+1]['filename']=$vruta.'Boletin'.$boletin.'_sms_concedidas_p.txt';
...
$smarty->display('z_fileboletin_conp.tpl');
$smarty->display('pie_pag.tpl');
...
// $mail->Subject = "Envio de Solicitud(es) de Busqueda(s) en Linea, Tramite WEBPI No. ".$tramite;
 ...
 $mail->Subject = "SAPI - Mensajes de Texto - Boletin ".$boletin." CONCEDIDAS";
...
//  $mail->AddAttachment($filetxt);
 ...
 $body .= "Anexo al presente, se hace entrega de archivo plano con los datos de las solicitudes de patentes publicadas como CONCEDIDAS ";
