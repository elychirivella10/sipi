...
$smarty->assign('subtitulo','Estadisticas - Relacion Concedidas-Pagadas');
...
$resultado=pg_exec("SELECT count(*) FROM stzderec a, stzevtrd b
	WHERE a.nro_derecho=b.nro_derecho and tipo_mp='P' and
              b.evento-2000 in (122,930) and
              b.estat_ant-2000 in (101,1,191,8) and
              b.documento='$cont'".$pquery2);
$registro=pg_fetch_array($resultado);	
$cant_con=$registro[0];
// concedidas con pago de derecho
$resultado=pg_exec("SELECT count(*) FROM stzderec a, stzevtrd b
	WHERE a.nro_derecho=b.nro_derecho and tipo_mp='P' and
              b.evento-2000 in (122,930) and
              b.estat_ant-2000 in (101,1,191,8) and
              b.documento='$cont' and 
              a.nro_derecho in (select nro_derecho from stzevtrd where evento=2066)".$pquery2);
...
// Setup the titles
if ($boletin2==$boletin) {
$graph->title->Set("RELACION DE PATENTES CONCEDIDAS Y PAGADAS".$ptit." (Boletin ".$boletin.")\n \n "); 
} else {
$graph->title->Set("RELACION DE PATENTES CONCEDIDAS Y PAGADAS".$ptit." (Boletines: ".$boletin."-".$boletin2.")\n \n ");
}
...
$t1 = new Text("Concedidas: ".$tcon." (100%)    Pagadas: ".
...
<tr><td class="cnt"><a href="p_est_rconpag.php?vopc=0"><img src="../imagenes/salir_f2.png" border="0"></a>  Salir  </td></tr></table><?php
...
$smarty->display('p_est_rconpag.tpl');
$smarty->display('pie_pag.tpl');
}
