...
$resultado=pg_exec("SELECT count(*) FROM stzderec a, stzevtrd b
	WHERE a.nro_derecho=b.nro_derecho and tipo_mp='P' and
              ...
              a.nro_derecho in (select nro_derecho from stzevtrd where evento=2022)".$pquery2);
...
// Setup the titles
if ($boletin2==$boletin) {
$graph->title->Set("RELACION DE PATENTES CON ORDEN PUB.PRENSA Y PAGADAS".$ptit." (Boletin ".$boletin.")\n \n "); 
} else {
$graph->title->Set("RELACION DE PATENTES CON ORDEN PUB.PRENSA Y PAGADAS".$ptit." (Boletines: ".$boletin."-".$boletin2.")\n \n ");
}
...
<tr><td class="cnt"><a href="p_est_rordpag.php?vopc=0"><img src="../imagenes/salir_f2.png" border="0"></a>  Salir  </td></tr></table><?php
...
$smarty->display('p_est_rordpag.tpl');
$smarty->display('pie_pag.tpl');
}
