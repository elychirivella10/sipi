...
if ($vopc==1) {
  ...
  //  Mensajenew("Solicitud en estatus NO Modificable ...!!!","p_infosol.php?vopc=4","N");
  //  $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
  //}
...
if (($vopc==2) || ($vopc==6)) {
  ...
  if ($accion==1) {
    ...
    if ($numtitu==0 AND $numcip==0 AND $numprio==0 AND $numagen==0 AND 
      ...
      Mensajenew("DATOS GUARDADOS CORRECTAMENTE ...!!!","p_manlpi55_cualquierestatus.php?vopc=4&nconexion=".$nconexion."&nveces=".$nveces,"S");
      $smarty->display('pie_pag.tpl'); exit();
    } 
    else {
...
$smarty->display('p_manlpi55_cualquierestatus.tpl');
