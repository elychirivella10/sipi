...
$resultado=pg_exec("SELECT * FROM stptmpinv WHERE solicitud='$vsoli'");
...
echo "    <td bgcolor='#CCCCCC' align='left' width='40%'>Nombre</td>";
echo "    <td bgcolor='#CCCCCC' align='left' width='20%'>Nacionalidad</td></tr>";
