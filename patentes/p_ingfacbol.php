...
$fecha   = fechahoy();
$vopc    = $_GET['vopc'];
$subtitulo = "Pago de Derechos de Registros de Patentes";

// ****************************************
$smarty->assign('titulo',$substpat);
$smarty->assign('subtitulo','Pago de Derechos de Registros de Patentes'); 
...
//$manphp = vman_php("p_ingfacbol.php");
//if ($manphp==1) {
...
$smarty->display('p_ingfacbol.tpl');
