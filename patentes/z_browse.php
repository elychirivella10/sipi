...
$smarty->assign('subtitulo','Resultado de Busqueda');
...
if ($vopc==4) {
   ...
   echo " <td width='1%' bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font color='#000000'></font><b>$modoabr</b></td>";
   echo "</tr>";
   
   echo "<form name='formab' method='POST' action='z_browse.php?vopc=1'>"; 
   ...
   for($cont=0;$cont<$filas_resultado;$cont++) {
	 ...
	 echo "<td bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font     color='#000000'>$reg[$namecampo]</font></td>";} 
