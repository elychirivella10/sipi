...
function browseautoriza(var1,var2,var3) {
  open("adm_autorizap.php?vcod="+var1.value+"&vtex="+var2.value+"&vmod="+var3.value,"Ventana", "scrollbars=yes,toolbar=no,directories=no,menubar=no,status=no"); }

function cntrlcertificado(var1,var2,var3,var4) {
  open("adm_ctrlcertip.php?vreg="+var1.value+var2.value+"&vmod="+var3.value+"&vcod="+var4.value,"Ventana", "scrollbars=yes,toolbar=no,directories=no,menubar=no,status=no"); }
...
$smarty->assign('subtitulo','Control de Certificados de Registros de Patentes');
...
$smarty->display('p_controlcert.tpl');
