...
if ($vtp==0) {
  $smarty->assign('subtitulo','B&uacute;squeda Externa de Diseño Industrial'); }
else {
...
if ($vopc==4) {
   ...
   if ($vtp==1) {
     ...
     $imagenbusq="../graficos/patentes/di".$dirano."/".$vs1.$vs2.".jpg"; 
     echo "<td align='center' width='50%'>";
     echo "<font color='#000000'>&nbsp;</font></br>";
     echo "<font color='#000000'>&nbsp;&nbsp;Solicitud No: $vsol1</font></br>";
     echo "<font color='#000000'>&nbsp;&nbsp;en Clase    : $clase</font></br>";
     echo "</td>";
     echo "<td align='center' width='50%'>";
     echo "&nbsp;";
     echo "</td>";
   ...
   echo "<tr>";
   if ($vtp==1) {
     echo "<form name='formab' method='POST' action='z_browdis.php?vopc=1&vtp=1'>"; }
   else {
     echo "<form name='formab' method='POST' action='z_browdis.php?vopc=1&vtp=0'>"; }
    ...
    while ( $fila <= 2 ) {
     ...
     while ( $colu <= 6 )
     {
       if ($vexp<=$filas_resultado) {
         ...
         for($cont2=0;$cont2<$cantcampos;$cont2++) {
             $namecampo=$vectorcampos[$cont2];
               ...
               case "solicitud":
                 ...
                 $nameimagen="../graficos/patentes/di".$dirano."/".$vs1.$vs2.".jpg"; 
                 break;
               case "clase":
                 $vclase = $reg['clase_locarno'];
                 break;
             }
         } 
         ...
         echo "<a href='$nameimagen' target='_blank'><img border='1' src='$nameimagen' width='152%' height='152'></a>"; 
         echo "<font color='#000000'>  Clase:  $vclase  </font>";
