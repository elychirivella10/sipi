...
//$smarty->display('encabezado1.tpl');
  ...
  //}
   ...
   $vtipest=array(2002,2023,2024,2030,2006,2101,2102,2103,2200,2119,2025,2032,2910,2752,2750,2090,2009,2556,2917,2918,2800,2801,2802,2804,2805,2806,2809,2821,2833,2835,2836,2837,2838,2840,2921,2922);
   ...
   if ($vopc==1) {
      ...
      if ($vtip==2025) {$codeve=2123; $vcomen="PRIORIDAD EXTINGUIDA FORMA EN BOLETIN $vbol";}
      if ($vtip==2032) {$codeve=2123; $vcomen="PRIORIDAD EXTINGUIDA FONDO EN BOLETIN $vbol";}
      ...
      if ($vtip==2009) {$codeve=2122; $vcomen="CON OPOSICION BOLETIN $vbol";}
      ...
      //echo "DESCRIPCION=$deseve ";

      //Estatus final
      if ($tipeve=='M') {
        $resule=pg_exec("SELECT * FROM stzmigrr WHERE evento='$codeve' and estatus_ini='$vtip' and tipo_mp='P'");
