...
//Table Base Classs
include ("b_funcionme.php");
include ("b_funcionpe.php");
include ("b_funcionre.php");
...
$smarty->assign('subtitulo','Generación de Boletín Nacionalidad EXTRANJERA');
...
// Despligue de mensajes  
  echo "<H3><p> $msj </p></H3>"; 
  Mensajenew('BOLETIN DE NACIONALIDAD EXTRANJERA GENERADO CORRECTAMENTE !!!','b_genbole.php?vopc=5','S'); 
  $smarty->display('pie_pag.tpl'); exit();
