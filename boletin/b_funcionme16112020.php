...
// *************************************************************************************
 ...
 $vnomsolmare= "boletin_sol_mar_ext"."_".$fechagen."_".$horagen.".pdf";
...
// Montando los resultados en el formato boletin solicitadas
      ...
      $pdf->MultiCell(190,5,utf8_decode('MARCAS EXTRANJERAS SOLICITADAS A EFECTO DE OPOSICIÓN'),0,'C',0);
      $pdf->ln(6); 
...
$pdf->Output("../../boletin/".$vnomsolmare);
$pdf->Output("../respaldoboletin/".$vnomsolmare);
...
$tipo_derecho='M';
$indrec==0;
$titulo='SOLICITUDES DE MARCAS EXTRANJERAS DE PRODUCTOS CONCEDIDAS';
...
//Eliminacion de todo el Estatus 6 de stztmpbo1 
$delbol1    = pg_exec("DELETE FROM stztmpbo1 WHERE estatus= '1101' AND boletin= '$boletin'");
...
//       $pdf->MultiCell(190,5,utf8_decode($registrador5),0,'C',0);         
  ...
  $counter = $counter + 1; 
  if($counter==2) { $tipo_derecho='N'; $titulo='SOLICITUDES DE NOMBRES COMERCIALES EXTRANJERAS CONCEDIDAS';}
  if($counter==3) { $tipo_derecho='L'; $titulo='SOLICITUDES DE LEMAS COMERCIALES EXTRANJERAS CONCEDIDAS';}
  if($counter==4) { $tipo_derecho='S'; $titulo='SOLICITUDES DE MARCAS DE SERVICIOS EXTRANJERAS CONCEDIDAS';}
  if($counter==5) { $tipo_derecho='C'; $titulo='SOLICITUDES DE MARCAS COLECTIVAS EXTRANJERAS CONCEDIDAS ';}
  if($counter==6) { $tipo_derecho='O'; $titulo='SOLICITUDES DE DENOMINACIÓN DE ORIGEN EXTRANJERAS CONCEDIDAS';}
  if($counter==7) { $tipo_derecho='M'; $estatus=1390; $indrec=1; $titulo='RECLASIFICADAS MARCAS EXTRANJERAS DE PRODUCTOS CONCEDIDAS';}
  if($counter==8) { $tipo_derecho='N'; $estatus=1390; $indrec=1; $titulo='RECLASIFICADAS NOMBRE COMERCIALES EXTRANJERAS CONCEDIDAS';}
  if($counter==9) { $tipo_derecho='L'; $estatus=1390; $indrec=1; $titulo='RECLASIFICADAS LEMAS COMERCIALES EXTRANJERAS CONCEDIDAS'; }
  if($counter==10) { $tipo_derecho='S'; $estatus=1390; $indrec=1; $titulo='RECLASIFICADAS MARCAS DE SERVICIOS EXTRANJERAS CONCEDIDAS';}
  if($counter==11) { $tipo_derecho='C'; $estatus=1390; $indrec=1; $titulo='RECLASIFICADAS MARCAS COLECTIVAS EXTRANJERAS CONCEDIDAS';}
  if($counter==12) { $tipo_derecho='O'; $estatus=1390; $indrec=1; $titulo='RECLASIFICADAS DENOMINACIÓN DE ORIGEN EXTRANJERAS CONCEDIDAS'; }
  if($counter==13) { $tipo_derecho='D'; $titulo='SOLICITUDES DE DENOMINACION COMERCIAL EXTRANJERAS CONCEDIDAS';}
}//fin del while
 //echo " fin del while ";
 //Salida del Reporte
 //$pdf->Output("../../boletin/boletin_con.pdf");        
 $vnomconmar= "boletin_con_mar_ext"."_".$fechagen."_".$horagen.".pdf";
...
// Armando el query segun las opciones
$resultado=pg_exec("SELECT b.solicitud, b.nombre, a.modalidad, a.clase, b.nro_derecho,b.agente, b.tramitante, b.poder, b.fecha_solic, b.tramitewebpi,a.distingue 	
	FROM  stmmarce a, stzderec b, stztmpbo1 c
	WHERE c.estatus='1002'
    AND c.boletin = '$boletin'
    AND c.tipo = 'M'
...
//	ORDER BY b.solicitud");	
  ...
  if ($filas_resultadoc==0) { $mensaje= $mensaje.' - No se genero Orden de Publicación  '; } 
    ...
    $pdf->ln(4); 
    $pdf->Setfont('Arial','B',12);
    $pdf->MultiCell(190,5,utf8_decode('ORDEN DE PUBLICACIÓN EN PRENSA DE MARCAS EXTRANJERAS'),0,'C',0);
 ...
 $vnomprenmar= "boletin_pren_mar_ext"."_".$fechagen."_".$horagen.".pdf";
...
while ( $counter <= 4) {
  switch ($articulo) {
     case 27:
       $tituloneg = "Negadas de Nacionalidad Extranjeras (Artículo 27 L.P.I)";
       ...
       break;
     case 28:
       $tituloneg = "Negadas de Nacionalidad Extranjeras (Artículo 28 L.P.I)";
       ...
       break;
     case 29:
       $tituloneg = "Negadas de Nacionalidad Extranjeras (Artículo 29 L.P.I)";
       ...
       break;
     case 35:
       $tituloneg = "Negadas de Nacionalidad Extranjeras (Artículo 35 L.P.I)";
  ...
  $resultado=pg_exec("SELECT stmmarce.clase,stmmarce.modalidad, stztmpbo1.solicitud, stmliaor.*, stzderec.nombre,stzderec.fecha_solic,stzderec.tramitante,stzderec.agente,stzderec.poder,stzderec.tramitewebpi
			...
			AND stztmpbo1.tipo_nacionalidad = 'E'
...
while ( $counter <= 2) {
  if ($articulo == 33) { $tope = 12; $tituloneg = "Negadas de Nacionalidad Extranjeras (Artículo 33 L.P.I)"; }
  if ($articulo == 34) { $tope = 2;  $tituloneg = "Negadas de Nacionalidad Extranjeras (Artículo 34 L.P.I)"; }
 ...
 //Salida del Reporte
 $vnomnegmar= "boletin_neg_mar_ext"."_".$fechagen."_".$horagen.".pdf";
...
// Armando el query segun las opciones
$resultado=pg_exec("SELECT b.solicitud, b.nombre, a.clase, b.nro_derecho,b.agente, b.tramitante, b.poder, b.tramitewebpi 	
	FROM  stmmarce a, stzderec b, stztmpbo1 c
	WHERE c.estatus='1200'
    AND c.boletin = '$boletin'
    AND c.tipo = 'M'
...
//      $pdf->MultiCell(190,5,utf8_decode('DEVUELTAS DE FORMA POR REQUISITOS MINIMOS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode('MARCAS EXTRANJERAS DEVUELTAS DE FORMA'),0,'C',0);
...
if ($filas_resultadod==0) {$mensaje= $mensaje.' - No se genero Devueltas de Fondo';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('DEVUELTAS DE FONDO MARCAS EXTRANJERAS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_devu)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
//      $pdf->MultiCell(190,5,utf8_decode('OBSERVADAS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode('NOTIFICACION DE SOLICITUDES DE MARCAS EXTRANJERAS CON OPOSICIÓN'),0,'C',0);
...
//Eliminacion de todo el Estatus 914 de stztmpbo1 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Desistidas de Observacion por Ley';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE NACIONALIDAD EXTRANJERA DESISTIDAS POR DISPOSICION DE LA LEY'),0,'C',0);
...
// Armando el query segun las opciones
$resultado=pg_exec("SELECT distinct on (b.solicitud) b.solicitud, b.nombre, a.clase, b.nro_derecho,b.agente, b.tramitante, b.poder, b.tramitewebpi 	
	FROM  stmmarce a, stzderec b, stztmpbo1 c
	WHERE c.estatus='1025'
    AND c.boletin = '$boletin'
    AND c.tipo = 'M'
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Prioridades Extinguidas';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE NACIONALIDAD EXTRANJERA DECLARADAS CON PRIORIDAD EXTINGUIDA'),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Perimidas por no Publicación en Prensa';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE MARCAS DE NACIONALIDAD EXTRANJERA PERIMIDAS POR NO PUBLICAR EN PRENSA'),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Caducas';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE MARCAS CADUCAS DE NACIONALIDAD EXTRANJERA POR NO PAGO DE DERECHO'),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Registros de Anotaciones Marginales de Renovación';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RENOVACIONES DE NACIONALIDAD EXTRANJERA DE MARCAS Y OTROS SIGNOS DISTINTIVOS'),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Registros de Anotaciones Marginales de Cambio de Nombre';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('CAMBIO DE NOMBRE DE NACIONALIDAD EXTRANJERA DE MARCAS Y OTROS SIGNOS DISTINTIVOS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_anot)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Registros de Anotaciones Marginales de Cesiones';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('CESIONES DE NACIONALIDAD EXTRANJERA DE MARCAS Y OTROS SIGNOS DISTINTIVOS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_anot)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Registros de Anotaciones Marginales de Fusiones';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('FUSIONES DE NACIONALIDAD EXTRANJERA DE MARCAS Y OTROS SIGNOS DISTINTIVOS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_anot)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Registros de Anotaciones Marginales de Cambio de Domicilio';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('CAMBIO DE DOMICILIO DE NACIONALIDAD EXTRANJERA DE MARCAS Y OTROS SIGNOS DISTINTIVOS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_anot)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Registros de Anotaciones Marginales de Licencias';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('LICENCIAS DE USO DE NACIONALIDAD EXTRANJERA DE MARCAS Y OTROS SIGNOS DISTINTIVOS'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_anot)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
$vnommar= "boletin_mar_ext"."_".$fechagen."_".$horagen.".pdf";
