...
// *************************************************************************************
 ...
 $fec_obse=strtolower(Cambiar_fecha_mes($fec_801));
 //echo " $tipo bol= $tipbol "; exit();
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones Prioridades EXtinguidas';} else {
      ...
      $pdf->MultiCell(190,5,'Caracas, '.$fec_obse,0,'J',0);           
      $pdf->Setfont('Arial','B',8);
      $pdf->MultiCell(190,5,$anoi.', '.$anof.' y '.$anor,0,'J',0);
      $pdf->MultiCell(190,5,utf8_decode('DRPI-RESOLUCION N° '.$nro_resoluc),0,'J',0);
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A PRIORIDADES EXTINGUIDAS DE SOLICITUDES DE MARCAS NACIONALES PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Negadas de Oficio';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES NEGADAS DE OFICIO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Resolucion a Observaciones';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN CON RESOLUCION DE OBSERVACIONES DE MARCAS NACIONALES PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Perencion de Procedimiento';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CON PERENCION DE PROCEDIMIENTO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Prioridad Extinguida Publicacion Extemporanea';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CON PRIORIDAD EXTINGUIDA POR PUBLICACIÓN EN PRENSA EXTEMPORANEA PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Perencion de Procedimiento por NO publicacion en Prensa.';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CON PERENCION DE PROCEDIMIENTO POR NO PUBLICACIÓN EN PRENSA PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones Caducas';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CADUCAS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Solicitudes Desistidas por Ley';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES DESISTIDAS POR LEY POR NO CONTESTAR OPOSICIÓN PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideraciones a Prioridad Extinguida Publicacion Defectuosa';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CON PRIORIDAD EXTINGUIDA POR PUBLICACIÓN EN PRENSA DEFECTUOSA PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Nulidad a Concesion por Notificar';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CON ESCRITOS DE NULIDAD A LA CONCESIÓN PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Peticion de Nulidad del Acto Administrativo';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES EN TRAMITE CON PETICIÓN DE NULIDAD DEL ACTO ADMINISTRATIVO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Nulidad de Acto Administrativo de Oficio';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN A MARCAS NACIONALES CON NULIDAD DEL ACTO ADMINISTRATIVO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Peticion de Nulidad de Acto Administrativo Notificada ';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PETICIONES DE NULIDAD DE ACTO ADMINISTRATIVO DE MARCAS NACIONALES EN TRAMITE PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Nulidad de Acto Administrativo de Oficio Notificada';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE SOLICITUD DE MARCAS NACIONALES CON NULIDAD DE ACTO ADMINISTRATIVO DE OFICIO NOTIFICADAS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Recurso a Nulidad de Concesion Notificada';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE RECURSOS DE NULIDAD A LA CONCESION DE MARCAS NACIONALES NOTIFICADOS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Caducidad por NO Uso por Notificar';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE SOLICITUDES DE CANCELACIÓN O CADUCIDAD DE MARCAS NACIONALES POR NO USO PENDIENTES DE NOTIFICAR PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Caducidad por NO Uso Notificada';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE SOLICITUDES DE CANCELACIÓN O CADUCIDAD DE MARCAS NACIONALES POR NO USO NOTIFICADAS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideracion Disposicion Administrativa que Afecta al Registro';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE RECURSOS DE RECONSIDERACION POR DISPOSICIONES ADMINISTRATIVAS QUE AFECTAN EL REGISTRO DE MARCA NACIONALES RELACIONADOS CON CANCELACIONES POR FALTA DE USO O CADUCIDAD POR NO USO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Marca con Solicitud de Nulidad por Notificar';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE SOLICITUDES DE NULIDAD DE MARCAS NACIONALES PENDIENTES DE NOTIFICACION PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Registro con Solicitud de Nulidad Notificada';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PROCEDIMIENTOS DE SOLICITUDES DE NULIDAD DE MARCAS NACIONALES NOTIFICADAS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Registro con Nulidad por Disposicion Administrativa';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE NULIDAD DE MARCAS NACIONALES POR DISPOSICION ADMINISTRATIVA PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_obse==0) {$mensaje= $mensaje.' - No se genero Reconsideracion a Disposicion Administrativa de Nulidad de Registro';} else {
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACION A DISPOSICIONES ADMINISTRATIVAS QUE RESUELVEN ACCIONES DE NULIDAD AL REGISTRO DE MARCAS NACIONALES PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($tit_obse)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
$resultadopais=pg_exec("SELECT b.nro_derecho, b.solicitud, c.boletin, c.estatus, 'P' as tipo, d.pais_domicilio, d.nacionalidad
    INTO temp stptmpbo800
...
$resultado1 = pg_exec("INSERT INTO stztmpbo1
SELECT distinct on (nro_derecho) nro_derecho, solicitud, boletin, estatus, tipo, pais_domicilio, nacionalidad
    FROM  stptmpbo800
    WHERE estatus='2800'
    AND boletin = '$boletin'
    AND nacionalidad = 'VE'");
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 800 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACION A PATENTES NACIONALES CON PRIORIDAD EXTINGUIDA  PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 801 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACION A PATENTES NACIONALES NEGADAS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 802 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACION A PATENTES NACIONALES DENEGADAS PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 804 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACION A PATENTES NACIONALES DECLARADAS CON PRIORIDAD EXTINGUIDA POR PUBLICACION DEFECTUOSA PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 805 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACION A PATENTES NACIONALES DECLARADAS CON PERENCION DE PROCEDIMIENTO  PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 806 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PATENTES NACIONALES ABANDONADAS CON ESCRITO DE RECONSIDERACIÓN PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 809 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE PATENTES NACIONALES CON ESCRITOS DE NULIDAD A LA CONCESIÓN PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 821 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PETICIÓN DE NULIDAD DEL ACTO ADMINISTRATIVO DE SOLICITUDES DE PATENTES NACIONALES EN TRÁMITE  PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 833 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERARON DE PATENTES NACIONALES AFECTADAS POR DISPOSICIÓN ADMINISTRATIVA PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 835 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE NULIDAD DE PATENTES NACIONALES PENDIENTES DE NOTIFICACIÓN PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 836 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE NULIDAD DE PATENTES NACIONALES NOTIFICADAS  PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
$resultado1 = pg_exec("INSERT INTO stztmpbo1
SELECT distinct on (nro_derecho) nro_derecho, solicitud, boletin, estatus, tipo, pais_domicilio, nacionalidad,nacionalidad
    FROM  stptmpbo837
    WHERE estatus='2837'
    AND boletin = '$boletin'
    AND nacionalidad = 'VE'");
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 838 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN -DISPOSICIÓN ADMINISTRATIVA DE NULIDAD DE REGISTRO DE PATENTE NACIONALES PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,mb_strtoupper(utf8_decode('Visto que en fecha 12 de noviembre de 2018, este Registro de la Propiedad Industrial, publicó el Aviso Oficial N.º DRPI-AO-N°72, en el Boletín de la Propiedad Industrial Nº 588 de fecha 12 de noviembre de 2018, y vencido el plazo otorgado en el mismo, de conformidad con lo dispuesto en el artículo 64 de la Ley Orgánica de Procedimientos Administrativos, se declara la perención de los Recursos de Reconsideración -Disposición Administrativa de Nulidad de Registro de Patente que se identifican a continuación:')),0,'J',0);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 840 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE PATENTE NACIONALES DESISTIDAS CON RECURSO DE RECONSIDERACIÓN PERIMIDAS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 921 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN DE SOLICITUDES DE PATENTE NACIONALES SIN EFECTO POR FALTA DE PAGO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Estatus 922 ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('RECURSOS DE RECONSIDERACIÓN DE SOLICITUDES DE PATENTE NACIONALES SIN EFECTO POR VENCIMIENTO DEL TÉRMINO PERIMIDOS POR NO RATIFICACIÓN'),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
$vnommar= "boletin_rec_nac"."_".$fechagen."_".$horagen.".pdf";
