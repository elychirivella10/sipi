...
// Modificado por Romulo Mendoza 20/09/2011: faltaban las siguientes variables $negad,$fecp_nega,$titp_nega   
 function patentes($nbol,$anoi,$anof,$nro_resol,$solip,$fecp_soli,$titp_soli, $concp,$fecp_conc,$titp_conc,$ordep,$fecp_orde,$titp_orden,$devup,$fecp_devu,$titp_devu,$priop,$fecp_prio,$titp_prio,$prio_extep,$fecp_prio_exte, $titp_prio_exte, $prio_defep,$fecp_prio_defe,$titp_prio_defe, $perip, $fecp_peri,$titp_peri,$denep,$fecp_dene,$titp_dene,$desip,$fecp_desi,$titp_desi,$aband,$fecp_aban,$titp_aban, $negad,$fecp_nega,$titp_nega, $oposi,$fecp_opos,$titp_opos, $rehab,$fecp_reha,$titp_reha, $titul,$fecp_titu,$titp_titu, $psefp,$fecp_sefp,$titp_sefp, $psevt,$fecp_sevt,$titp_sevt) {
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Patentes sin Efecto por Vencimiento del Termino'.$titulo;} 
else { $nro_resoluc = $nro_resoluc+1;
      $pdf->AddPage();
      $pdf->Setfont('Arial','B',12);
      $pdf->MultiCell(190,5,'_______________________________________________________________________________',0,'J',0);
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PATENTES SIN EFECTO POR VENCIMIENTO DEL TERMINO '.$titulo),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($titp_desi)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode(   
