...
// Montando los resultados en el formato boletin solicitadas
      ...
      $pdf->MultiCell(59,5,'REPUBLICA BOLIVARIANA DE VENEZUELA, MINISTERIO DEL PODER POPULAR PARA EL COMERCIO - SERVICIO AUTONOMO DE LA PROPIEDAD INTELECTUAL - REGISTRO DE LA PROPIEDAD INDUSTRIAL',0,'J',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(2); 
      $pdf->MultiCell(59,5,'Caracas, '.strtolower(Cambiar_fecha_mes($fec_soli)),0,'J',0);     $pdf->Setfont('Arial','B',8);
      $pdf->MultiCell(59,5,$anoi.' y '.$anof,0,'J',0);
      $pdf->MultiCell(59,5,utf8_decode('RESOLUCIÓN N° '.$nro_resoluc),0,'J',0);
      $pdf->ln(4); 
