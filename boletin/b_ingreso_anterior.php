...
if ($vopc==2) {
  ...
  $req_fields = array("fecha_pub","anoi","anof");
  ...
  if ($accion=="I") { //Comienzo de INCLUIR   
    ...
    $col_campos = "nro_boletin,fecha_pub,fecha_gen, hora_gen, anoi, anof, resoluci,usuario,generado";
    $insert_str = "'$nbol','$fecha_pub','$fechahoy','$horactual','$anoi','$anof', '$resoluci','$usuario','N'";
   ...
   //Incluir
    ...
    $update_str = "fecha_pub = '$fecha_pub',anoi= '$anoi', anof = '$anof', resoluci= '$resoluci'";
...
if (!empty($fecp_sefp)) {$texto3 = $texto3.", fecp_sevt         = '$fecp_sevt'";}
if (empty($fecp_sefp)) {pg_exec("update stzdetbol SET fecp_sevt=NULL WHERE nro_boletin= '$nbol'"); }
...
$smarty->assign('campo4','A&ntilde;o de Independencia:');
$smarty->assign('campo5','A&ntilde;o de Federaci&oacute;n:');
