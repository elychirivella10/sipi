...
// Modificado Año ... 2017, 2018, 2019, 2022
// *************************************************************************************
 ...
 $registrador1= "";
 $registrador2= "HENDRICK JOSÉ PERDOMO COLMENARES";
...
//      $pdf->MultiCell(190,5,'MARCAS COMERCIALES SOLICITADAS',0,'C',0);
   ...
   if (($modalidad == 'M') OR ($modalidad == 'G')) {
      ...
      $texto_etiqueta= "[b]".utf8_decode("DESCRIPCIÓN DE ETIQUETA:   ")."[/b] ".$etiqueta;
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Desistidas';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE MARCAS NACIONALES DESISTIDAS'),0,'C',0);
