...
// Modificado por Romulo Mendoza 20/09/2011: faltaban las siguientes variables $negad,$fecp_nega,$titp_nega   
 ...
 $vnomsolpat= "boletin_sol_pat_ext"."_".$fechagen."_".$horagen.".pdf";
...
// Montando los resultados en el formato boletin solicitadas
      ...
      $pdf->MultiCell(190,5,utf8_decode('SOLICITADAS DE PATENTES EXTRANJERAS'),0,'C',0);
      $pdf->ln(4); 
...
//      $pdf->MultiCell(190,5,'SOLICITADAS DE '.utf8_decode($titulo),0,'C',0);
      $pdf->MultiCell(190,5,'SOLICITUDES EXTRANJERAS DE '.utf8_decode($titulo).' PUBLICADAS A EFECTO DE OPOSICIONES',0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('DE CONFORMIDAD CON EL ARTÍCULO 60 DE LA LEY DE PROPIEDAD INDUSTRIAL, Y POR CUANTO LOS INTERESADOS HAN CUMPLIDO DE ACUERDO A LA LEY CON LAS ÓRDENES DE PUBLICACIÓN EN PRENSA QUE SE HICIERA EN EL BOLETÍN DE LA PROPIEDAD INDUSTRIAL CORRESPONDIENTE, SE PROCEDE A PUBLICAR LAS SIGUIENTES SOLICITUDES DE REGISTRO DE '.$titulo.' CON EL FIN DE QUIEN TENGA LEGÍTIMO INTERÉS PUEDA PRESENTAR SUS OPOSICIONES DE ACUERDO A LO ESTABLECIDO EN EL ARTÍCULO 63 DE LA LEY DE PROPIEDAD INDUSTRIAL.'),0,'J',0);      
...
// Montando los resultados en el formato boletin orden de publicacion
      ...
      $pdf->ln(4); 
      $pdf->Setfont('Arial','B',12);
      $pdf->MultiCell(190,5,utf8_decode('ORDEN DE PUBLICACIÓN EN PRENSA DE SOLICITUDES EXTRANJERAS DE PATENTE '.$titulo),0,'C',0);
...
if ($filas_resultado==0) {$mensaje= $mensaje.'  - No se genero Devueltas '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES EXTRANJERAS DE PATENTES '.$titulo.' DEVUELTAS POR EXAMEN DE FORMA'),0,'C',0);
   ...
   $data[3]['TEXT'] = trim(utf8_decode($tram)); 
	...
	$pdf->Draw_Data($data);
      ...
      // Fin de Pagina (Firma del Registrador)
       ...
       //$pdf->ln(8); 
       $pdf->Setfont('Arial','',8);
       //$pdf->MultiCell(190,5,utf8_decode('SE ADVIERTE A LOS INTERESADOS QUE DE ACUERDO AL ARTÍCULO 61 (PRIMER APARTE) DEL CITADO ARTÍCULO, LA PRIORIDAD EN LA PRESENTACIÓN DE ESTAS SOLICITUDES, SE EXTINGUIRA, SI NO CUMPLEN CON LOS REQUISITOS INDICADOS EN UN PLAZO DE TREINTA (30) DÍAS HÁBILES A PARTIR DE LA FECHA DE LA PRESENTE PUBLICACIÓN EN EL BOLETÍN DE LA PROPIEDAD INDUSTRIAL.'),0,'J',0);
       $pdf->Setfont('Arial','B',8);
       $pdf->ln(10); 
       $pdf->MultiCell(190,5,utf8_decode('Publíquese,'),0,'L',0);
       $pdf->ln(30); 
...
if ($filas_resultado==0) {$mensaje= $mensaje.'  - No se genero Devueltas '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES EXTRANJERAS DE PATENTES '.$titulo.' DEVUELTAS POR EXAMEN DE FONDO'),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($titp_devu)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
// Montando los resultados en el formato boletin solicitadas
      ...
      $pdf->ln(4); 
      $pdf->Setfont('Arial','B',12);
      $pdf->MultiCell(190,5,'PATENTES EXTRANJERAS '.utf8_decode($titulo).' CONCEDIDAS',0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      //if($counter==4) {
      if($counter==3) {
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Prioridades Extinguidas Forma '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4);
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES EXTRANJERAS DE PATENTE '.$titulo.' DECLARADAS CON PRIORIDAD EXTINGUIDA POR EXAMEN DE FORMA'),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Prioridades Extinguidas Fondo '.$titulo;} 
else { $nro_resoluc = $nro_resoluc+1;
      $pdf->AddPage();
      $pdf->Setfont('Arial','B',12);
      $pdf->MultiCell(190,5,'_______________________________________________________________________________',0,'J',0);
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES EXTRANJERAS DE PATENTE '.$titulo.' DECLARADAS CON PRIORIDAD EXTINGUIDA POR EXAMEN DE FONDO'),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Prioridades Extinguidas Extemporaneas de Patentes '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PRIORIDADES EXTINGUIDAS EXTRANJERAS PUBLICADAS EN PRENSA EXTEMPORANEA '.$titulo),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Prioridades Extinguidas Defectuosas de Patentes '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PRIORIDADES EXTINGUIDAS EXTRANJERAS PUBLICADAS EN PRENSA DEFECTUOSA '.$titulo),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Perimidas por no Publicación en Prensa '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PERIMIDAS EXTRANJERAS POR NO PUBLICAR EN PRENSA '.$titulo),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Denegadas '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE PATENTES EXTRANJERAS DENEGADAS '.$titulo),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Negadas '.$titulo;} 
    ...
    $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES EXTRANJERAS DE PATENTE DE '.$subpate),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Desistidas '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES EXTRANJERAS DE PATENTE '.$titulo.' DESISTIDAS '),0,'C',0);
...
//Eliminacion de todo el Estatus 6 de stztmpbo1 
$delbol1    = pg_exec("DELETE FROM stztmpbo1 WHERE estatus= '2090' AND boletin= '$boletin'");
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Abandonadas '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('ABANDONADAS EXTRANJERAS POR NO SOLICITAR EXAMEN TECNICO '.$titulo),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Solicitudes Sin Efecto x No Pago de Derechos ';} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('SOLICITUDES DE PATENTE EXTRANJERAS SIN EFECTO POR FALTA DE PAGO DE DERECHOS'),0,'C',0);
      //$pdf->MultiCell(190,5,utf8_decode(trim($titp_aban)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
...
//Eliminacion de todo el Estatus 6 de stztmpbo1 
$delbol1    = pg_exec("DELETE FROM stztmpbo1 WHERE estatus= '2750' AND boletin= '$boletin'");
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Abandonadas x No Pago '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('ABANDONADAS DE NACIONALIDAD EXTRANJERAS POR NO PAGO '.$titulo),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($titp_aban)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      //$pdf->MultiCell(190,5,utf8_decode('XXXXXXX.'),0,'J',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron OPOSICIÓNes ' .$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('OPOSICIÓNES DE PATENTES EXTRANJERAS '.$titulo),0,'C',0);
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Patentes en Rehabilitacion '.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('REHABILITACION DE PATENTES EXTRANJERAS '.$titulo),0,'C',0);
...
//Eliminacion de todo el Estatus 6 de stztmpbo1 
$delbol1    = pg_exec("DELETE FROM stztmpbo1 WHERE estatus= '2917' AND boletin= '$boletin'");
...
// Armando el query segun las opciones
$resultado=pg_exec("SELECT b.solicitud,b.registro, b.nombre, b.nro_derecho, b.agente, b.tramitante, b.poder, b.tipo_derecho 	
	FROM  stzderec b, stztmpbo1 c
	WHERE c.estatus='2917'
    	AND c.boletin = '$boletin'
   	AND c.tipo = 'P'
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Patentes sin Efecto por Falta de Pago de Anualidad'.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PATENTES EXTRANJERAS SIN EFECTO POR FALTA DE PAGO DE ANUALIDAD '.$titulo),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($titp_desi)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      //$pdf->MultiCell(190,5,utf8_decode(  
...
if ($filas_resultado_prio==0) {$mensaje= $mensaje.' - No se generaron Patentes por Vencimiento del Termino'.$titulo;} 
      ...
      $pdf->Setfont('Arial','B',12);
      $pdf->ln(4); 
      $pdf->MultiCell(190,5,utf8_decode('PATENTES EXTRANJERAS SIN EFECTO POR VENCIMIENTO DEL TERMINO '.$titulo),0,'C',0);
      $pdf->MultiCell(190,5,utf8_decode(trim($titp_desi)),0,'C',0);
      $pdf->Setfont('Arial','',8);
      $pdf->ln(4); 
      //$pdf->MultiCell(190,5,utf8_decode(   
...
$vnompat= "boletin_pat_ext"."_".$fechagen."_".$horagen.".pdf";
