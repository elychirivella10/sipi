...
// Realizado por el Analista de Sistema Karina Perez / Ing. Romulo Mendoza
// Coordinación de Informática / Dirección de Soporte Administrativo / SAPI / MPPCN
// Desarrollado Año: 2010
// Modificado Año 2018, 2020 II Semestre
// *************************************************************************************
...
//Colocado por Romulo Mendoza 17/10/2020 Patentes Devueltas por Fondo
$titp_devfon    =$_POST['titp_devfon'];  
$fecp_devfon    =$_POST['fecp_devfon'];
//Colocado por Romulo Mendoza 17/10/2020 Patentes Prioridades Extinguidas por Fondo
$titp_priofon   =$_POST['titp_priofon'];
$fecp_priofon   =$_POST['fecp_priofon'];
...
//Colocado por Romulo Mendoza 17/10/2020 Patentes Devueltas por Fondo   
$texto=$texto.'titp_devfon,';
$texto1=$texto1." '$titp_devfon',";
if (!empty($fecp_devfon)) {$texto = $texto.'fecp_devfon,'; $texto1 = $texto1."'$fecp_devfon',";}

//Colocado por Romulo Mendoza 17/10/2020 Patentes Prioridades Extinguidas por Fondo   
$texto=$texto.'titp_priofon';
$texto1=$texto1." '$titp_priofon'";
if (!empty($fecp_priofon)) {$texto = $texto.'fecp_priofon,'; $texto1 = $texto1."'$fecp_priofon',";}
...
if ($vopc==6) {
  ...
  if ($filas_found > 0) {
   ...
   //Colocado por Romulo Mendoza 17/10/2020 Patentes Devueltas x Fondo
   $titp_devfon    = trim($objs->titp_devfon);
   $fecp_devfon    = trim($objs->fecp_devfon); 

  //Colocado por Romulo Mendoza 17/10/2020 Patentes Prioridades Extinguidas por Fondo   
   $titp_priofon   = trim($objs->titp_priofon);
   $fecp_priofon   = trim($objs->fecp_priofon); 
...
//Colocado por Romulo Mendoza 17/10/2020 Patentes Devueltas por Fondo
$texto3=$texto3."titp_devfon = '$titp_devfon',";
if (!empty($fecp_devfon)) {$texto3 = $texto3."fecp_devfon         = '$fecp_devfon',";}
if (empty($fecp_devfon)) {pg_exec("update stzdetbol SET fecp_devfon=NULL WHERE nro_boletin= '$nbol'"); }

//Colocado por Romulo Mendoza 17/10/2020 Patentes Prioridades Extinguidas por Fondo
$texto3=$texto3."titp_priofon    = '$titp_priofon'";
if (!empty($fecp_priofon)) {$texto3 = $texto3.",fecp_priofon         = '$fecp_priofon'";}
if (empty($fecp_priofon)) {pg_exec("update stzdetbol SET fecp_priofon=NULL WHERE nro_boletin= '$nbol'"); }
...
//Colocado por Romulo Mendoza 17/10/2020 Patentes Devueltas por Fndo
$smarty->assign('titp_devfon',$titp_devfon);
$smarty->assign('fecp_devfon',$fecp_devfon);

//Colocado por Romulo Mendoza 17/10/2020 Patentes Prioridad Extinguida por Fndo
$smarty->assign('titp_priofon',$titp_priofon);
$smarty->assign('fecp_priofon',$fecp_priofon);
