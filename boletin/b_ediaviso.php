...
if (($_SERVER['HTTP_REFERER']=="")) {
   ...
   $tablas    = "stztmpav, stzavisos ";
   $condicion = " stztmpav.boletin = v3 and stztmpav.nro_aviso = stzavisos.nro_aviso";
   $orden     = "1";
  // $modo      = "Incluir";
  // $modoabr   = "Inc";
   $modo      = "Eliminar";
   ...
   $vurl      = "b_ediaviso.php";
   $tabladel  = "stztmpav";
   $condicion2= " stztmpav.boletin = v3 and stztmpav.nro_aviso = v6";
   $tablains  = "stztmpav";
   ...
   $smarty ->assign('subtitulo','Editar Avisos para Bolet&iacute;n'); 
