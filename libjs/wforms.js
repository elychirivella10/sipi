...
// ------------------------------------------------------------------------------------------
   ...
   if(wFORMS) {
		...
		wFORMS.behaviors['validation'] = {
			...
			errMsg_required 	: "* campo obligatorio.",
			errMsg_alpha 		: "Use solo caracteres alfabaeticos [a-z A-Z].",
			errMsg_email 		: "Esta no es una direccion de correo valida",
			errMsg_integer 		: "Use solo numeros enteros",
			errMsg_float 		: "Please enter a number (ex. 1.9).",
			errMsg_password 	: "No se pudo guardar la clave; esta debe tener entre 4 y 12 caracteres.",
			errMsg_alphanum 	: "Use solo caracteres alfa-numericos [a-z A-Z 0-9].",
			errMsg_date 		: "Esta no es una fecha valida.",
			errMsg_notification : "%% error(es) detectados.\n Por favor, chequee los datos suministrados.",
           ...
           run: function(e) {
			...
			// ------------------------------------------------------------------------------------------
			// validation functions //Aqui estan Maryury
			// ------------------------------------------------------------------------------------------
