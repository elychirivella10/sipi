...
<body onLoad="this.document.{$varfocus}.focus()">
  ...
  <div align="center">
  <br>
  <form name="fordatev" action="i_gbevind.php" method="POST" onsubmit='return pregunta();''>
  ...
  <input type ='hidden' name='nboletin' value='{$nboletin}'>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
        ...
        <input type='text' name='eve_nombre' value='{$eve_nombre}' readonly='readonly' size='70'>
      </td>
    </tr>
    <tr>
...
<!--    {if $evento eq 40 and $nboletin ge 600}
     <tr>
      <td class="izq-color" >{$campo10}</td>
      <td class="der-color">
        <input type='text' name='factura' value='{$factura}' size='10' maxlength="7" align="right" onKeyPress="return acceptChar(event,2,this)">
      </td>
     </tr>
    {/if}  -->
    ...
    {if $inf_adicional eq "C" }
     ...
     <tr>
      ...
      <td class="der-color">
        <textarea onkeyUp="max(this,400)" onkeyPress="max(this,400)" onChange="Vacio(document.fordatev.comentario)" cols='72' rows='4' name='comentario' value='{$comentario}'>{$comentario}</textarea>
      </td>
     </tr>
     <tr>
