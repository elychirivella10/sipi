<html>
 ...
 <!--cuando es en ventana nueva debe incluirse en la siguiente linea despues del "post": target="_blank" -->
        <form name="formarcas2" action="z_browbol.php?vopc=0" method="post"> 
 	  <input type='hidden' name='nconex' value='{$n_conex}'>
	
	
	<tr><td class="izq-color">{$lpalabra}</td>
	<td class="der-color"><input type="text" name="v3" size="8" maxlength="5" 
     ...
     <table width="210">
        <tr>
      <td class="cnt"><input type="image" src="../imagenes/edit_f2.png" value="Generar">  Generar  </td>
      <td class="cnt"><a href="b_seleaviso.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
