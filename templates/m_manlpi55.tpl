...
<form name="formarcas1" action="m_manlpi55.php?vopc=1" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="m_manlpi55.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value={$usuario}>
  <input type='hidden' name='depto' value={$depto_id}>
  ...
  <!--<tr>-->
    ...
    <tr>
      ...
      <td class="der-color" rowspan="9" valign="top">
        <input name="ubicacion" type="file"  value='{$ubicacion}' size="20" onChange="javascript:document.formarcas2.picture.src = 'file:///'+ document.formarcas2.ubicacion.value;">
    ...
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="6" name="distingue" {$modo} cols="57">{$distingue}</textarea>
      </td>
    ...
    <tr><td class="der-color">
        ...
        <input type="button" value="Corregir" name="vtituc" {$modo2} onclick="browsetitularp(document.formarcas2.vsol1,document.formarcas2.vsol2,document.formarcas2.vtitut,document.formarcas2.vtituc)"> 
        <br>
    </td></tr> 
    </table>
    &nbsp;
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
          <a href="m_manlpi55.php?vopc=4&nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar   
      {/if}    
      {if $vopc eq 4}
          <a href="m_manlpi55.php?vopc=4&nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  
      {/if}    
