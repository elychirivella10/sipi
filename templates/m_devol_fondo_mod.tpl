<html>
  ...
  <div align="center">
    <form name="formarcas1" action="m_devol_fondo_mod.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas2" action="m_devol_fondo_mod.php?vopc=3" method="post" onsubmit='return pregunta();'>
    	    <td>{$espacios}</td>
...
{if $descausa[23] neq ''}
	...
	<table>
	<tr>
	   <td class="izq-color">{$lotro}</td>
	   <td class="der-color">
	     <!-- <input size="90" type="text" name="otro" value='{$otro}'> -->
	     <textarea rows="3" name="otro" cols="96">{$otro}</textarea>
	   <td>
	</tr>
	</table>
     </table>
    ...
    <tr>
      ...
      <td class="cnt"><a href="m_devol_fondo_mod.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
