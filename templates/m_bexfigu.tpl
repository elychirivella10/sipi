...
onKeyPress="return acceptChar(event,3, this)" onchange="Rellena(document.formarcas2.nced,9)" onkeyup="checkLength(event,this,9,document.formarcas2.telefono)">
    ...
    <tr>
      ...
      <td class="der-color">
         <input tabindex="10" type="text" name="planilla" {$modo5} value='{$planilla}' size="7" maxlength="8" onKeyPress="return acceptChar(event,2,this)">
      </td>
    </tr>
    <tr>
      <td class="izq-color" >{$campo12}</td>
      <td class="der-color">
        <input tabindex="2" type="text" name="clase" {$modo5} value='{$clase}' size="1" maxlength="2" onKeyPress="return acceptChar(event,2,this)">
      </td>
    </tr>
    <tr>
      <td class="izq-color" >{$campo18}</td>
      <td class="der-color">
        <select size='1' name='vplus' onchange="valenvio(this.form);" {$modo6}>
    ...
    <tr>
      ...
      <td class="der-color">
        <input type='text' name='email' value='{$email}' {$modo5} size="70" maxlength="80" onkeyup="checkLength(event,this,80,document.formarcas2.vsede)" onchange="isEmail2(document.formarcas2.email.value,this.form);">
    ...
    <tr>
      ...
      <td class="der-color">
         <select size="1" name="vsede" {$modo6} >
  ...
  <table width="255" >
  <tr>
    <td class="cnt"><input tabindex="8" type="image" {$modo6} src="../imagenes/boton_guardar_azul.png" value="Guardar"></td> 
    <td class="cnt">
