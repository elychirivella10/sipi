<html>
  ...
  <br><br><br>  
   <table>
   	<form name="formarcas2" action="m_actbolext_1.php?vopc=1" method="post">
 ...
 <td class="cnt"><a href="m_actbolext_1.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
