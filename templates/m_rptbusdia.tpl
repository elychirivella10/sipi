 ...
 <br>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <input tabindex="3" type="text" name="fecharec" {$modo} value='{$fecharec}' size="10" align="right" onkeyup="checkLength(event,this,10,document.formarcas2.recibo)" onchange="valFecha(this,document.formarcas2.recibo)" >
         &nbsp;&nbsp;
    ...
    <tr>
      ...
      <td class="der-color" ><select size='1' name='tipobus'>
                             {html_options values=$arraybusq selected=$tipobus output=$arraydesbusq}
                             </select>
      </td>
    </tr>
    <tr>
