...
<!-- <form name="forlotes" enctype="multipart/form-data" action="m_controlcert.php?vopc=2"  method="POST" > -->
   ...
   <table width="85%" cellspacing="1" border="1">
    ...
    <tr><td>
    <iframe id='top' style='width:100%;height:90px;background-color: WHITE;' src="p_verautoriza.php?pcod={$nctrlcer}"></iframe> 
    </td></tr>  
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top22' style='width:99%;height:180px;background-color: WHITE;' src="p_vercer.php?vcod={$nctrlcer}"></iframe> 
    </td></tr>
