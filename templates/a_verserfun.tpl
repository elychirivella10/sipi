...
<form name="forsolpre" action="a_browserfun.php?vopc=1&vtp=0" method="POST">
...
<table cellspacing="3" border="0">
 ...
 <table align="center">
    <tr>
      ...
      <td class="cnt"><a href="a_verserfun.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
