...
<form name="frmconsunid" action="z_consrole.php?vtip=2" method="POST" >
  <input type="hidden" name="vrol" value='{$vrol}'>
...
<tr>
     ...
     <table>
      <tr>
       ...
       <td>
         {if $vmodal eq 2}
            {if $vopm eq 'RO'}
              <a href="../comun/z_roles.php?conx=1&na_conex={$na_conex}&nconex=0&salir=0"><img src="../imagenes/salir_f2.png" border="0"></a>  Salir
            {/if}
            {if $vopm eq 'ER'}
              <a href="../comun/z_evenrol.php?conx=1&na_conex={$na_conex}&nconex=0&salir=0"><img src="../imagenes/salir_f2.png" border="0"></a>  Salir
            {/if}
            {if $vopm eq 'AR'}
              <a href="../comun/z_asigrol.php?conx=1&na_conex={$na_conex}&nconex=0&salir=0"><img src="../imagenes/salir_f2.png" border="0"></a>  Salir
            {/if}
         {/if}
         {if $vmodal eq 1}
 ...
 <div class="tab-page" id="modules-cpanel">
  ...
  <tr>
   <tr>
     ...
     <td class="der-color" width="65%">
       <input type="text" name="vrol" {$modo} value='{$vrol}' size="9" maxlength="8">
       <b>&nbsp;&nbsp;{$campo2}&nbsp;&nbsp;</b>
       <input type="text" name='vrole' value='{$vrole}' {$modo} size="38" maxlength="80">
       <b>&nbsp;&nbsp;{$campo3}&nbsp;&nbsp;</b>
       <input type="text" name='vcreacion' value='{$vcreacion}' {$modo} size="22">
     </td>
     <td class="der-color" align="top">
       <b>{$campo4}&nbsp;</b>
       {$vdescripcion|wordwrap:25:"\n":true}
     </td>
   </tr>
  </tr> 
  </table>
  ...
  <iframe name='frmevmar' id='frmevmar' style='width:100%;height:150px' src="../comun/z_coneve.php?vrol={$vrol}&vtipo=M"></iframe>
  <iframe name='frmevpat' id='frmevpat' style='width:100%;height:150px' src="../comun/z_coneve.php?vrol={$vrol}&vtipo=P"></iframe>
  <iframe name='frmevpat' id='frmevpat' style='width:100%;height:150px' src="../comun/z_coneve.php?vrol={$vrol}&vtipo=A"></iframe>
