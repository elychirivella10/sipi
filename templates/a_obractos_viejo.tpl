 ...
 <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <textarea rows="5" name="partes" {$modo1} cols="110">{$partes}</textarea>
      </td>
    </tr>
    <tr>
      <td class="izq-color" >{$campo5}</td>
      <td class="der-color">
	     <textarea rows="5" name="naturaleza" {$modo1} cols="110" onKeyup="this.value=this.value.toUpperCase()">{$naturaleza}</textarea>
      </td>
    </tr>
  </tr>
  </table>
  ...
  <tr>
    <tr>
      <td class="der-color" >
	 <textarea rows="11" name="objeto" {$modo1} cols="130">{$objeto}</textarea>
      </td>
    </tr> 
  </tr> 
  </table>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="5" name="derechos" {$modo1} cols="110">{$derechos}</textarea>
      </td>
    </tr> 
    <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="3" name="espec_cuantia" {$modo1} cols="110" onKeyPress="if(this.value.length>300) this.value=this.value.substring(0,300);">{$espec_cuantia}</textarea>
      </td>
    </tr> 
  </tr> 
  </table>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
	     <textarea rows="2" name="duracion" {$modo1} cols="110" maxlength="200">{$duracion}</textarea>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
         <textarea rows="2" name="datosregistro" {$modo1} cols="110" maxlength="300" align="left">{$datosregistro}</textarea>
      </td>
    </tr>
  </tr> 
  </table>
  ...
  <tr>
    ...
    <tr>
     ...
     <td class="der-color">
       <input type="text" name="otro_caracter" {$modo1} value='{$otro_caracter}' size="85" maxlength="50" onKeyup="this.value=this.value.toUpperCase()">
     </td>
    </tr>
    <tr>
     <td class="izq-color">{$campo18}</td>
     <td class="der-color">
       <textarea rows="2" name="prueba_repres" {$modo1} cols="98" maxlength="150" onKeyup="this.value=this.value.toUpperCase()">{$prueba_repres}</textarea>
     </td>
    </tr>
  </tr> 
  </table>
  ...
  <tr>
   <tr>
     ...
     <td class="der-color">
       <textarea rows="4" name="observacion" {$modo1} cols="90" maxlength="300" >{$observacion}</textarea>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td class="der-color">
       <textarea rows="4" name="datos_ampli" {$modo1} cols="90" maxlength="300" >{$datos_ampli}</textarea>
     </td>
   </tr>
  </tr> 
  </table>
  ...
  <tr>
    <tr>
      <td class="der-color" >
	     <textarea rows="11" name="datos_adicio" {$modo1} cols="130" >{$datos_adicio}</textarea>
      </td>
    </tr> 
  </tr> 
  </table>
