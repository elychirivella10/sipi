<html>
  ...
  <br> 
  <div align="center">
    <form name="formarcas1" action="m_marginalfm05.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas2" action="m_marginalfm05.php?vopc=2" method="post">
	    <td>{$espacios}</td>
	...
	<tr><td class="izq-color">{$ltrage}</td>
     ...
     <form name="formarcas3" action="m_marginalfm05.php?vopc=3" method="post" onsubmit='return pregunta();'>
    ...
    <table align="center" width="60%" cellspacing="1" border="0">	
     <tr>
      <td>
      <fieldset>
      <legend align='center' class='Estilo3'><strong><span>DATOS DE LA CESION</span></strong></legend>
    ...
    &nbsp;
    <table width="100%" cellspacing="1" border="1">
    <tr><td class="izq4-color">{$lcedente}</td></tr>
    <tr><td>
    <iframe id='top' style='width:100%;height:100px;background-color: WHITE;' src="../comun/z_vercedente.php?psol={$vsol1}-{$vsol2}&pder=M"></iframe> 
    </td></tr>  
    <tr><td class="der-color">
        <input type="text" name="vceden" {$modo} size="35" onChange="javascript:this.value=this.value.toUpperCase();">
        <input type="button" class="boton_blue" value="Buscar/Incluir"  name="vcedei" {$modo2} onclick="browsetitularp(document.formarcas1.vsol1,document.formarcas1.vsol2,document.formarcas3.vceden,document.formarcas3.vcedei)">
        <input type="button" class="boton_blue" value="Buscar/Eliminar" name="vcedee" {$modo2} onclick="browsetitularp(document.formarcas1.vsol1,document.formarcas1.vsol2,document.formarcas3.vceden,document.formarcas3.vcedee)"> 
        <br>
    </td></tr> 
    </table>
	...
	<tr><td class="izq-color">{$lagenew}</td>
     ...
     <table width="255">
        ...
        <td class="cnt"><a href="m_marginalfm05.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
