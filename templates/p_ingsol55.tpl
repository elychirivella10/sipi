  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color" rowspan="3" valign="top">
        ...
        <br><img src='{$nameimage}' id="picture" width="270" height="300" alt="vista previa"/></br>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
         <textarea rows="14" name="resumen" {$modo} cols="57" maxlength="8000" onchange="this.value=this.value.toUpperCase()">{$resumen}</textarea>
      </td>
    </tr> 
<!--    <tr>
...
<!--        -<select size="1" name="pais" {$modo2} onchange="this.form.input2.value=this.options[this.selectedIndex].value">
    ...
    <table width="85%" cellspacing="1" border="1">
    <tr><td class="izq4-color">{$campo6}</td></tr>
    <tr><td>
  ...
  <table cellspacing="1" border="1">
    ...
    <tr>
      <td class="izq4-color">{$campo16}</td>
      <td class="der1-color">
