...
-->
<form name="wingresol" id="w_grabar" action="w_ingrepat.php?vopc=6" method="post">
  ...
  <tr><td WIDTH=30% class='izq-color'><b>Titulo Técnico de la Invención o Creación:</b>
      </td><td></br><font face='Arial' size='4'>
      {$vnom_pat}</br>

  {if (file($nameimage))}
      <td width='20%' rowspan='9' align='center' style='background-color: #FFFFFF; border: 1 solid #C6DEF2'>
         <a href='{$nameimage}' target='_blank'><img border='0' src={$nameimage} width='185' height='185'>
      </td></a> 
  {/if}

  </font></br></td></tr>
  <tr><td WIDTH=30% class='izq-color'><b>Tipo de Patente:</b>
      </td><td></br><font face='Arial' size='4'>
      {$vtip_pat}</br>
  </font></br></td></tr>
...
onkeyup="checkLength(event,this,4,document.wingresol.vsol2);" onchange='for(var x=this.value.length;x<4;x++) this.value=0+this.value;'>-<input type='text' size='3' name='vsol2' maxlength='6' value='{$vsol2}' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.wingresol.vpod1);" onchange='for(var x=this.value.length;x<6;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000-000000 (año-n&uacute;mero)</font>
  </td></tr>
<!--{if $vpedirpoder=='S'}
  <tr><td class='izq-color'><b>N&uacute;mero de Poder:</b>
     </td><td><input type='text' size='2' name='vpod1' maxlength='4' value='{$vpod1}' onkeyup="checkLength(event,this,4,document.wingresol.vpod2);" onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<4;x++) this.value=0+this.value;'>-<input type='text' size='2' name='vpod2' maxlength='4' value='{$vpod2}' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,4,document.wingresol.vfact);" onchange='for(var x=this.value.length;x<4;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000-0000 (año-n&uacute;mero)</font>
  </td></tr>
{/if}-->
  ...
  <tr><td class='izq-color'><b>Fecha de Presentaci&oacute;n:</b>
        ...
        <!--
        <input type='text' name='fecha_pres' value='{$fecha_pres}' size='10' onChange="valFecha(document.wingresol.fecha_pres)" onkeyup="checkLength(event,this,10,document.wingresol.vcarp)">
         &nbsp;&nbsp;
        ...
        -->
         <input type='text' name='fecha_pres' value='{$fecha_pres}' size='10' readonly>
  </td></tr>
  ...
  <tr><td class='izq-color'><b>N&uacute;mero de Factura Pago de Anualidad:</b>
     </td><td>F<input type='text' size='5' name='vanu' maxlength='7' value='{$vanu}' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000000 (n&uacute;mero)</font>
  </td></tr>
  <tr><td class='izq-color'><b>N&uacute;mero Planilla Pago Anualidad:</b>
     </td><td><input type='text' size='5' name='vplan' maxlength='7' value='{$vplan}' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 00000 (n&uacute;mero)</font>
  </td></tr>
  <!--<tr><td class='izq-color'><b>Monto:</b>
     </td><td><input type='text' size='5' name='vmonto' maxlength='7' value='{$vmonto}' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 00.00 (bolivares)</font>
  </td></tr>-->
  </table>
