...
<form name="formarcas2" enctype="multipart/form-data" action="m_modetiqueta.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <table cellspacing="1" border="1">
    ...
    <tr>
      ...
      <td class="der-color" colspan="2">
	     <textarea rows="13" name="descripcion" {$modo} cols="95" onkeyup="Textarea_Sin_Enter(event.keyCode, this.id);" onkeypress="Textarea_Sin_Enter(event.keyCode, this.id);">{$descripcion}</textarea>
      </td>
    </tr> 
    <tr>
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
          <a href="m_modetiqueta.php?vopc=4&nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>   
      {/if}    
      {if $vopc eq 3}
          <a href="m_modetiqueta.php?vopc=3&nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      {/if}    
    </td>      
