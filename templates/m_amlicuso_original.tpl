<html>
  ...
  <div align="center">
    <form name="formarcas1" action="m_amlicuso_original.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas2" action="m_amlicuso_original.php?vopc=2" method="post">
	    <td>{$espacios}</td>
	...
	<tr><td class="izq-color">{$ltrage}</td>
     ...
     <form name="formarcas3" action="m_amlicuso_original.php?vopc=3" method="post" onsubmit='return pregunta();'>
    ...
    <br>
     ...
     <table width="235">
      <tr>
       ...
       <td class="cnt"><a href="m_amlicuso_original.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
