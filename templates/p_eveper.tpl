...
&nbsp;
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top22' style='width:99%;height:90px;background-color: WHITE;' src="p_vexpedt.php?vcod={$nprensa}&evto=22"></iframe> 
    </td></tr>
   ...
   &nbsp;
    ...
    <tr><td class="izq4-color" colspan="2">{$campo4}</td></tr>
    <tr><td>    
    <iframe id='top32' style='width:99%;height:90px;background-color: WHITE;' src="p_vexpedt.php?vcod={$nprensa}&evto=32"></iframe> 
    </td></tr>
    <tr><td class="der-color">
   ...
   &nbsp;
    ...
    <tr><td class="izq4-color" colspan="2">{$campo4}</td></tr>
    <tr><td>    
    <iframe id='top33' style='width:99%;height:90px;background-color: WHITE;' src="p_vexpedt.php?vcod={$nprensa}&evto=33""></iframe> 
    </td></tr>
    <tr><td class="der-color">
