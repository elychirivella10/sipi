...
<form name="formarcas3" action="m_solviena.php?vopc=5&vsol={$vsol}" method="post" onsubmit='return pregunta();'>
  ...
  <table width="85%" cellspacing="0" border="1">
    ...
    <tr><td class="der-color">
        ...
        <input type="button" class="boton_blue" value="Buscar/Incluir"  name="vvienai" {$modo3} onclick="gestionvienap(document.formarcas3.vsol1,document.formarcas3.vsol2,document.formarcas3.vviena,document.formarcas3.vvienai)">
        <input type="button" class="boton_blue" value="Buscar/Eliminar" name="vvienae" {$modo3} onclick="gestionvienap(document.formarcas3.vsol1,document.formarcas3.vsol2,document.formarcas3.vviena,document.formarcas3.vvienae)">
    </td></tr>
  </table>
  &nbsp;
  ...
  <table width="225">
    <tr>
      {if $vopc eq 1}
      <td class="cnt"><a href="m_solviena.php?vopc=5&vsol={$vsol}"><img src="../imagenes/boton_editar_rojo.png" border="0"></a></td>
      {/if} 
      {if $vopc eq 4}
