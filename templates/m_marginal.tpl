<html>
  ...
  <div align="center">
	...
	<tr><td class="izq-color">{$ldomicilio}</td>
	    <td class="der-color"><input size="72" type="text" name="vdomtit" value='{$vdomtit}' {$vmodo}></td></tr>
	<tr><td class="izq-color">{$ltrage}</td>
     ...
     <table cellspacing="1" border="1">
       <tr><td class="izq-color">{$ltipo}</td>
	    ...
	    <td class="der-color">
          {html_radios name="vseldoc" values=$vdoc_id selected=$vseldoc output=$vdoc_de separator=""}&nbsp;&nbsp;	    
	       <input size="10" type="text" name="vdoc" value='{$vdoc}' maxlength="10" onKeyPress="return acceptChar(event,2,this)" onkeyup="checkLength(event,this,10,document.formarcas3.vfecv)">
	    </td></tr>
       ...
       <a href="javascript:showCal('Calendar60');"><img src="../imagenes/calendar2.gif" title="Haga Clic para Seleccionar la Fecha" align="middle" width="26" height="24" border="0"></a>
	    ...
	    &nbsp;&nbsp;&nbsp;
	    {$lclaseint}&nbsp;&nbsp;<input size="1" type="text" name="vclasint" value='{$vclasint}' onkeyup="checkLength(event,this,2,document.formarcas3.vcomenta)">
    ...
    <!-- <table width="85%">
    <tr><td class="izq2-color">{$lpropietario}</td></tr>
    <tr><td>
