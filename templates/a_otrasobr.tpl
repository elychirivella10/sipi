...
{if $vopc eq 3}
<form name="foroobras" action="a_otrasobr.php?vopc=4&vpla={$vpla}" method="post">
{/if}
{if $vopc eq 7}
<form name="foroobras" action="a_otrasobr.php?vopc=8&vpla={$vpla}" method="post">
{/if}
  <table>
    <tr>
      <input type="hidden" name="nveces" value="{$nveces}">
      <input type="hidden" name="nconexion" value="{$nconexion}"> 
      <td class="izq5-color">Expediente No.</td>
      <td class="der-color">
        <input type="text" name="vsol" size="6" maxlength="6" value='{$vsol}' {$modo} 
               onkeyup="checkLength (event,this,6,document.foroobras.vfechas)"
               onchange="Rellena(document.foroobras.vsol,6)">
      </td>	
      {if $vopc eq 3}
      <td class="cnt">
...
<form name="forautor" id="forautor" enctype="multipart/form-data" 
      action="a_otrasobr.php?vopc={$accion}&vpla={$vpla}" 
...
<tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <a href="a_otrasobr.php?vopc=7&vpla={$vpla}&nveces={$nveces}&nconexion={$nconexion}" onmouseout="MM_swapImgRestore();"  
      {else}
      <a href="a_otrasobr.php?vopc=3&vpla={$vpla}&nveces={$nveces}&nconexion={$nconexion}" onmouseout="MM_swapImgRestore();"  
      {/if}
         onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);"><img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
      </td>
      <td>&nbsp;</td>
      <td>
      {if $vopc eq 4 || $vopc eq 1 || $vopc eq 8}
      <input type="image" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('save','','../imagenes/save_f2.png',1);" 
             src="../imagenes/boton_guardar_rojo.png" alt="Save" align="middle" name="save" border="0" onclick="validate();return returnVal;"/>
      {else}
      <a><img src="../imagenes/boton_guardar_rojo.png" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('save','','../imagenes/boton_guardar_rojo.png',1);" alt="Save" 
  ...
  <div class="tab-page" id="Obra"><h2 class="tab">Obra</h2>
       ...
       <div align="left">
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="1">
         <tr>
           <td width="17%" class="izq-color">Fecha Solicitud:</td>
           <td width="33%">
         ...
         <tr>
           <td width="20%" class="izq-color">N&uacute;mero de Planilla:</td>
           <td width="30%"> 
           <input type="text" name="vnumpla" {$modo1} value='{$vnumpla}' size="6" maxlength="6" 
                  onkeyup="checkLength(event,this,6,document.forautor.vtitulo)" 
                  onKeyPress="return acceptChar(event,2, this)"></td>
         </tr> 
         <tr>
           <td class="izq-color">T&iacute;tulo:</td>
           <td colspan="3">
           <input type"text" name="vtitulo" {$modo1} value='{$vtitulo}' size="175" maxlength="300" onKeyup="this.value=this.value.toUpperCase()">
           </td>
         </tr>
         <tr>
           <td class="izq-color" >Pa&iacute;s de Origen:</td>
           <td>
         ...
         <tr>
         <td class="izq-color">Idioma Original:</td>
         <td>  
         ...
         <tr>
           ...
           <td colspan="3">
           <input type="text" name="vgener2" {$modo1} value='{$vgener2}' size="106" 
                     maxlength="300" onKeyup="this.value=this.value.toUpperCase();"></td> 
         </tr>
         {/if} 
         <tr>
           <td class="izq-color">Traducci&oacute;n:</td>
           <td colspan="3">
           <input type="text" name="vtraduc" {$modo1} value='{$vtraduc}' size="175" maxlength="300" onKeyup="this.value=this.value.toUpperCase();">
           </td> 
         </tr>
         <tr>
           <td class="izq-color" >A&ntilde;o Realizaci&oacute;n:</td>
           <td>
         ...
         <tr>
           <td class="izq-color">A&ntilde;o 1era Publicaci&oacute;n:</td> 
           <td> 
         ...
         {if $vpla neq 'OE'}
         <tr>
           <td class="izq-color" >Descripci&oacute;n:</td>
           <td > <!-- colspan="3" -->
              <textarea row="4" name="vdescri" {$modo1} value='{$vdescri}' cols="136" maxlength="2000">{$vdescri}</textarea>
           </td> 
         </tr>
         {/if} 
        {if $vpla eq 'OM'}
        ...
        <table bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td width="23%">
           <input type="text" name="vritmo" {$modo1} value='{$vritmo}' size="25" maxlength="30"
        ...
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         <tr>
           <td width="18%" class="izq-color" >&nbsp;&nbsp;&nbsp;Clasificaci&oacute;n:</td>
           <td width="23%">
        ...
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <tr>
           ...
           <td width="70%">
           <input type="text" name="vtit_oo" {$modo1} value='{$vtit_oo}' size="110" maxlength="300" 
                  onKeyup="this.value=this.value.toUpperCase();"></td> 
         </tr>
         <tr> 
           <td class="izq-color" >Autor Obra Originaria:</td>
           <td>
           <input type="text" name="vaut_oo" {$modo1} value='{$vaut_oo}' size="110" maxlength="300" 
                  onKeyup="this.value=this.value.toUpperCase();"></td> 
         </tr>
         <tr> 
           <td class="izq-color" >Tipo Obra Derivada:</td>
           <td>
         ...
         <tr> 
           <td class="izq-color" >A&ntilde;o publicaci&oacute;n Obra Originaria:</td>
           <td>
        ...
        &nbsp;
        {if $vpla eq 'OE'}
        <table bgcolor=#7AC0EF border="1" cellspacing="0" cellpadding="0">
         <tr>
           <td width="30%" class="izq-color" >Tipo Obra Escenica:</td>
           <td width="70%">
           {html_radios name="vcla_oe" values=$vcla_oe_id selected=$vcla_oe 
                        output=$vcla_oe_de separator=""}
           <input type="text" name="votroto" {$modo1} value='{$votroto}' size="30" maxlength="60"
                  onKeyup="this.value=this.value.toUpperCase();">
           </td>
         </tr>
         <tr> 
           <td class="izq-color" >Breve descripci&oacute;n Argumento:</td>
           <td>
           <textarea row="2" name="vdesarg" {$modo1} value='{$vdesarg}' cols="89" 
                     maxlength="600">{$vdesarg}</textarea></td> 
         </tr>
         <tr> 
           <td class="izq-color" >Breve descripci&oacute;n Musica:</td>
           <td>  
           <textarea row="2" name="vdesmus" {$modo1} value='{$vdesmus}' cols="89" 
                     maxlength="600">{$vdesmus}</textarea></td>  
         </tr>
         <tr> 
           <td class="izq-color" >Breve descripci&oacute;n Movimientos:</td>
           <td>
           <textarea row="2" name="vdesmov" {$modo1} value='{$vdesmov}' cols="89" 
                     maxlength="600">{$vdesmov}</textarea></td>  
         </tr>
        </table>
        &nbsp;
        {/if}
        ...
        <table bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <tr>
           ...
           <td width="70%">
           <input type="text" name="vdat_pf" {$modo1} value='{$vdat_pf}' size="89" maxlength="300" onKeyup="this.value=this.value.toUpperCase();"></td> 
         </tr>
         <tr> 
           <td class="izq-color" >A&ntilde;o de la Fijaci&oacute;n Sonora:</td>
           <td>
        ...
        <table bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td width="50%">
           <input type="text" name="vubi_ex" {$modo1} value='{$vubi_ex}' size="62" maxlength="120"></td> 
         </tr>
         <tr>
           <td width="30%" class="izq-color" >La Obra ha sido Publicada?:</td>
           <td width="10">
           {html_radios name="vpublic" values=$vpublic_id 
                        selected=$vpublic output=$vpublic_de separator=""}
           </td> 
           <td width="10%" class="izq-color" >Publicaci&oacute;n:</td>
           <td width="50%">
           <input type="text" name="vdat_pu" {$modo1} value='{$vdat_pu}' size="62" maxlength="120"></td> 
         </tr>
         <tr>
           ...
           <td width="10%" class="izq-color" >Ubicaci&oacute;n:</td>
           <td width="50%">
           <input type="text" name="vubi_ed" {$modo1} value='{$vubi_ed}' size="62" maxlength="120"></td> 
         </tr>
        </table>
        &nbsp;
        {/if} 
        ...
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <td class="der-color">
          <div id="resultado">
           ...
           <!-- <iframe name='frameauto' id='frameauto' style='width:100%;height:120px' src="d_consoli.php?psol={$vsol}&vtipo=Autor"></iframe> -->
          </div>
         </td>
         </tr>
         </td>
  ...
  <div class="tab-page" id="Coautor"><h2 class="tab">Co-autor(es)</h2>
       ...
       <div align="left">
        <table bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <td class="der-color">
         <div id="resultado">
          <input type="text" name="coautor" {$modo1} value='{$coautor}' size="60" maxlength="150" onChange="javascript:this.value=this.value.toUpperCase();">
          <input type="button" name="Nperson_c" value="Natural" {$bmodo} onclick="browsecoautor(document.forautor.vsol,document.forautor.coautor,document.forautor.Nperson_c)">
          <input type="button" name="Jperson_c" value="Juridica" {$bmodo} onclick="browsecoautor(document.forautor.vsol,document.forautor.coautor,document.forautor.Jperson_c)">
          </td></tr>
          <tr>
          <td class="izq-color">Director o Realizador: </td>
          <td class="der-color">
          <iframe name='framecoauto1' id='framecoauto1' style='width:100%;height:70px' src="d_consoli.php?psol={$vsol}&vtipo=Coautor1"></iframe></td></tr>
         </div>
         </td>
         </tr>
         <tr>
         ...
         <td class="der-color">
         <div id="resultado">
          <iframe name='framecoauto2' id='framecoauto2' style='width:100%;height:70px' src="d_consoli.php?psol={$vsol}&vtipo=Coautor2"></iframe></td></tr>
         </div>
         </td>
         </tr>
         <tr>
         ...
         <td class="der-color">
         <div id="resultado">
          <iframe name='framecoauto3' id='framecoauto3' style='width:100%;height:70px' src="d_consoli.php?psol={$vsol}&vtipo=Coautor3"></iframe></td></tr>
         </div>
         </td>
         </tr>
         <tr>
         ...
         <td class="der-color">
         <div id="resultado">
          <iframe name='framecoauto4' id='framecoauto4' style='width:100%;height:70px' src="d_consoli.php?psol={$vsol}&vtipo=Coautor4"></iframe></td></tr>
         </div>
         </td>
         </tr>
        </table>
       ...
       <div align="left">
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <div id="resultado">
          ...
          <!-- <iframe name='frameproductor' id='frameproductor' style='width:100%;height:120px' src="d_consoli.php?psol={$vsol}&vtipo=Productor"></iframe> -->
         </div>
          </td></tr>
        </table>
       </div>
       ...
       <div align="left">
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <tr>
           ...
           <td>
             <textarea rows="4" name="vobs_fi" {$modo1} value='{$vobs_fi}' cols="135" maxlength="300">{$vobs_fi}</textarea>
           </td> 
         </tr>
        </table>   
       </div>
  ...
  <div class="tab-page" id="Artistas"><h2 class="tab">Artista(s)</h2>
       ...
       <div align="left">
        <table bgcolor=#7AC0EF border="1" cellspacing="0" cellpadding="0">
         ...
         <td class="der-color">
         <div id="resultado">
          <input type="text" name="atista" {$modo1} value='{$atista}' size="60" maxlength="300" onChange="javascript:this.value=this.value.toUpperCase();">
<!--          <input type="button" name="Nperson_a" value="Incluir Artista" {$bmodo} onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.Nperson_a)"> -->
          <input type="button" name="Nperson_a" value="Natural" {$bmodo} onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.Nperson_a)"> 
          <input type="button" name="CorregirA" value="Corregir" {$bmodo} onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.CorregirA)">
          <input type="button" name="EliminarA" value="Eliminar" {$bmodo} onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.EliminarA)">
          <iframe name='framesoli' id='framesoli' style='width:100%;height:100px' src="d_vernatjur.php?psol={$vsol}&vtipo=Artista"></iframe>
          </td></tr>
          <!-- <tr>
          <td colspan="2"> 
            <iframe name='frameatista' id='frameatista' style='width:100%;height:160px' src="d_consoli.php?psol={$vsol}&vtipo=Atista"></iframe>
          </td></tr> -->
         </div>
         </td>
         </tr>
  ...
  <div class="tab-page" id="Transferencia"><h2 class="tab">Transferencia</h2>
       ...
       <div align="left">
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         <tr>
           <td width="17%" class="izq-color" >Transferencia:</td>
           <td width="83%">
             <textarea rows="4" name="vtransf" {$modo1} value='{$vtransf}' cols="138" maxlength="300">{$vtransf}</textarea>
           </td> 
         </tr>
        </table>
       </div>
       ...
       <div align="left">
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <div id="resultado">
          ...
          <!-- <iframe name='frameeditor' id='frameeditor' style='width:100%;height:90px' src="d_consoli.php?psol={$vsol}&vtipo=Editor"></iframe> -->
          </td></tr>
         </div>
         </td>
         </tr>
         <tr>
           ...
           <td>
           {html_radios name="vtipoed" values=$vtipoed_id 
                        selected=$vtipoed output=$vtipoed_de separator=""}
           </td> 
         </tr>
         <tr>
  ...
  <div class="tab-page" id="solicitante"><h2 class="tab">Solicitante</h2>
       ...
       <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
         ...
         <td class="der-color">
         <input type="text" name="otro_caracter" {$modo1} value='{$otro_caracter}' size="120" maxlength="100" onKeyup="this.value=this.value.toUpperCase()">
         </td>
        </tr>
        <tr>
         <td class="izq-color">{$campo18}</td>
         <td class="der-color">
         <textarea rows="2" name="prueba_repres" {$modo1} cols="130" maxlength="1024" onKeyup="this.value=this.value.toUpperCase()">{$prueba_repres}</textarea>
         </td>
        </tr>
       </table>
       </div>
  ...
  <div class="tab-page" id="Deposito"><h2 class="tab">Dep&oacute;sito</h2>
       ...
       <div align="left">
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         ...
         <tr>
           ...
           <td>
           <input type="text" name="vsop_de" {$modo1} value='{$vsop_de}' size="100" 
         ...
         <tr>
           ...
           <td>
           <textarea rows="4" name="vobs_de" {$modo1} value='{$vobs_de}' cols="118" 
                     maxlength="300">{$vobs_de}</textarea></td> 
         </tr>
        </table>        
       </div>
   </div>
   ...
   <div class="tab-page" id="hoja_ad"><h2 class="tab">Hoja Adicional</h2>
       ...
       <div align="left"> <!-- #7AC0EF -->
        <table width="100%" bgcolor=#FFFFFF border="1" cellspacing="0" cellpadding="0">
         <tr>
           <td width="30%" class="izq-color" >Incluye Hojas Adicionales?:</td>
           <td width="70%">
           {html_radios name="vhoj_ad" values=$vhoj_ad_id 
                        selected=$vhoj_ad output=$vhoj_ad_de separator=""}
           </td> 
         </tr>
         <tr>
           <td class="izq-color" >N&uacute;mero Hojas Adicionales Anexas:</td>
           <td>
         ...
         <tr>
           <td class="izq-color" >Datos que han sido ampliados en Hojas adicionales:</td>
           <td>
           <textarea rows="2" name="vamplia" {$modo1} value='{$vamplia}' cols="118" 
                     maxlength="300">{$vamplia}</textarea></td> 
         </tr>
         <tr>
           <td class="izq-color" >Datos Adicionales:</td>
           <td>
           <textarea rows="8" name="vadicio" {$modo1} value='{$vadicio}' cols="118" 
                     maxlength="30000">{$vadicio}</textarea></td> 
         </tr>
        </table>        
       </div>
  </div>
