<html>
  ...
  <div align="center">
	...
	<td class="der-color">
        <input size="73" type="text" name="vnom" value='{$nombre}' {$vmodo1}>   </td></tr>
    <tr><td class="izq-color">{$lclase}</td>
	<td class="der-color"><input size="2" type="text" name="vest" value='{$vest}' {$vmodo1}> 
        <input size="67" type="text" name="vdesest" value='{$vdesest}' {$vmodo1}></td></tr>
    </table>
    <!-- Titulares Actuales--> 
    <table width="90%" cellspacing="1" border="1">
...
<td class="der-color"><input size="9" type="text" name="vfevh"   onkeyup="checkLength(event,this,10,document.formarcas3.vdoc)"
	   onchange="valFecha(this,document.formarcas3.vdoc)" {$modo2}></td>
       </tr>
       <tr><td class="izq-color">{$ldocumento}</td>
	  <td class="der-color"><input size="9" type="text" name="vdoc" value='{$vdoc}' maxlength="9" onKeyPress="return acceptChar(event,2,this)" onkeyup="checkLength(event,this,9,document.formarcas3.vtitut)" {$modo2}></td></tr>
      </table>
      <!-- Titulares Finales--> 
      <table width="90%" cellspacing="1" border="1">
      ...
      <tr><td class="izq2-color">
      <iframe id='center' style='width:100%;height:111px;background-color: WHITE;' 
              src='exampletit.php?psol={$vsol}&ptip=M&pder={$vderh}'></iframe> 
      </td></tr>  
      </table>
      <!-- -->
      <table width="90%" cellspacing="1" border="1">	
      <tr><td class="der-color">
      <input type="text" name="vtitut" {$modo2} size="35" 
             onChange="javascript:this.value=this.value.toUpperCase();">
      <input type="button" class="boton_blue" value="Buscar/Incluir" {$modo3} name="vtitui" 
      ...
      <input type="button" class="boton_blue" value="Buscar/Eliminar" {$modo3} name="vtitue"          
