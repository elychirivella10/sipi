...
<td>
{if $vopc eq 1}
  <form name="forboletin1" id="forboletin1" action="p_pdf.php?vopc=2" method="post">
{/if}
 ...
 <br />
  ...
  <br />
     ...
     <table width="210">
        <tr>
        <td class="cnt"><a href="p_pdf.php?vopc=1&nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
