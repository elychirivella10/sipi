...
<!-- <h3> {$H3}</h3> -->
<br>
<form name="forcertif" action="m_rptcertifd.php" method="POST">
  <div align="center">
 ...
 <table>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpcertifd.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
