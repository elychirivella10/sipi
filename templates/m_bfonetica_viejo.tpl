...
{/if} 		  
  ...
  <table>
     <tr>
      ...
      {if $vopc eq 3}
      <td class="cnt">
        <input type="image" src="../imagenes/new_f2.png" width="32" height="24" value="Nueva Solicitud">Nuevo Pedido
        </form>
      </td>
      {/if} 		  
      {if $vopc eq 4}
        &nbsp;
        <td class="cnt">
          <input tabindex="2" type='image' src="../imagenes/buscar_f2.png" width="28" height="24" value="Buscar">  Buscar  
        </td>
      {/if}    
  </tr>
  </table>
...
<form name="formarcas2" enctype="multipart/form-data" action="m_bfonetica.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <input tabindex="5" type="text" name="recibo" {$modo} value='{$recibo}' size="6" maxlength="6" onkeyup="checkLength(event,this,6,document.formarcas2.denominacion)">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="der-color">
      	<input tabindex="6" type="text" name="denominacion" {$modo} value='{$denominacion}' size="60" maxlength="120" onkeyup="this.value=this.value.toUpperCase();checkLength(event,this,120,document.formarcas2.options)">
      </td>
    </tr> 
    <tr>
...
onKeyPress="return acceptChar(event,3, this)" onchange="Rellena(document.formarcas2.nced,9)" onkeyup="checkLength(event,this,9,document.formarcas2.telefono)">
  ...
  <table width="255" >
  <tr>
    <td class="cnt"><input tabindex="10" name="Guardar" type="image" {$modo2} src="../imagenes/save_f2.png" value="Guardar">	Guardar 	</td> 
    <td class="cnt">
      {if $vopc eq 1 || $vopc eq 4}
         <a href="m_bfonetica.php?vopc=4"><img tabindex="11" src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar   
      {/if}    
      {if $vopc eq 3}
