...
<form name="forcronol" action="m_rptcronol.php" method="POST">
  ...
  <tr>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpcronol.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
