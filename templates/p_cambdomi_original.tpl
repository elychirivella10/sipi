<html>
  ...
  <div align="center">
    <form name="formarcas1" action="p_cambdomi_original.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas3" action="p_cambdomi_original.php?vopc=3" method="post" 
...
<!--        <td class="cnt"><a href="m_rptcronol.php?vsol1={$solicitud1}&vsol2={$solicitud2}&vreg1={$registro1}&vreg2={$registro2}"><input type="image" src="../imagenes/folder_f2.png"></a>Cronologia</td> -->
        ...
        <td class="cnt"><a href="p_cambdomi_original.php"><img src="../imagenes/cancel_f2.png" border="0"></a>	Cancelar </td>
