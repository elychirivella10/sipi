...
<form name="forgenbol" action="m_rptgenbol.php" method="POST">
  <div align="center">
 ...
 <table>
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
        <input type="text" name='fechab' size="15" maxlength="15"  >
      </td>
    </tr> 
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpgenbol.php"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
