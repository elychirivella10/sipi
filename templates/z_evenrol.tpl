   ...
   <td class="menudottedline" width="40%" ></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	 <tr valign="left" align="left">
		<td>
			<a class="toolbar" href="../comun/z_ingevrol.php?conx=1&na_conex={$n_conex}" >
		...
		<td>&nbsp;</td>
	   <td>
			<a class="toolbar" href="../comun/z_evenrol.php?nconex={$n_conex}&salir=1&conx=0">
   ...
   {section name=cont loop=$vnumrows}
      <tr class="row0">
	   <td width="2%">
		...
		<td width="10%">
		<a href="../comun/z_consrole.php?vrol={$arr_role1[cont]}&vmodal=2&vtip=0&nconex={$n_conex}&conx=0&vopm=ER">
		{$arr_role1[cont]}
		</a>
		</td>
		...
		<td width="5%">
		<a href="../comun/z_elmevrol.php?vopc=1&valor={$arr_role1[cont]}&n_conex={$n_conex}&conx=1">
