...
<form name="forcaduca" action="m_delpriextbol.php?vopc=2" method="POST">
  <div align="center">
  <br><br>
  <table>
  <tr>
  ...
  <br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_reversarpriext.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
