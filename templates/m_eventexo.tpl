...
<body onLoad="document.forevento.input2.focus()">
  ...
  <form name="forevento" action="m_eventexo1.php" method="POST">
  ...
  <tr>
    ...
    <tr>
      <td class="izq-color" >{$campo7}</td>
      <td class="der-color">
        <input type="text" name="input2" value='{$eventos_id}' readonly='readonly' size="3" maxlength="3" onKeyup="checkLength(event,this,4,document.forevento.eventos_id)" onchange="valagente(document.forevento.input2,document.forevento.eventos_id)">-
