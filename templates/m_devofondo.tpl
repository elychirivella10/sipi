<html>
  ...
  <div align="center">
    <form name="formarcas1" action="m_devofondo.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas2" action="m_devofondo.php?vopc=3" method="post" onsubmit='return pregunta();'>
    	    <td>{$espacios}</td>
   ...
   {if ($vmod eq "G" || $vmod eq "M") }
    ...
    <tr>
      ...
      <td class="cnt"><a href="m_devofondo.php"><img src="../imagenes/cancel_f2.png" border="0"></a>			Cancelar 			</td>
