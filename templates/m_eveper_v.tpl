...
&nbsp;
   ...
   <tr>
     <tr>
       ...
       <td class="cnt"><a href="m_eveper.php?vopc=4"><img src="../imagenes/cancel_f2.png" border="0"></a>			Cancelar 			</td>
       <td class="cnt"><a href="../index1.php"><img src="../imagenes/salir_f2.png" border="0"></a>			Salir 			</td>
      
      <td class="cnt"> <a href="documentos/ayuda_prensa.pdf" target="_blank"><img src="../imagenes/icono_ayuda.png" width="32" height="32" border="0"> </a>  Ayuda</td>
