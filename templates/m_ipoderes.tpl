<html>
  ...
  <div align="center">
    ...
    <form name="formarcas3" action="m_ipoderes.php?vopc=5&vsol={$vsol}" method="post">
      ...
      <table width="225">
        ...
        {/if}
        {if $vopc neq 1}   
        <td class="cnt"><a href="m_ipoderes.php?vopc={$vopc}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
        {/if}
