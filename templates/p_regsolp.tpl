...
<form name="formarcas2" action="p_regsolp.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
        <input type="text" name="vest1" value='{$vest1}' size="2" readonly="readonly" > - 
        <input type="text" name="vest2" value='{$vest2}' size="80" readonly="readonly" >
      </td>
    </tr>
    <tr>
      <td class="izq-color" >{$campo7}</td>
      <td class="der-color">
        <input type="text" name="vnomtit" value='{$vnomtit}' readonly="readonly" size="90" maxlength="100">
      </td>
    </tr> 
    <tr>
      ...
      <td class="der-color">
        ...
        <input type="text" name="vnadtit" value='{$vnadtit}' size="81" readonly="readonly">
      </td>
    </tr> 
    <tr>
      <td class="izq-color" >{$campo9}</td>
      <td class="der-color">
        <input type="text" name="vtra" value='{$vtra}' size="90" maxlength="100" readonly="readonly">
      </td>
    </tr>
  </tr>
  </table>
  ...
  <tr>
    <td class="izq-color">{$campo11}</td>
	 <td class="der-color">
	   <input type="text" name="vfecvi" size="10" maxlength="10" value='{$vfecvi}' readonly="readonly" onchange="valFecha(this,this,document.formarcas2.vfechaven)">
	 </td>  
    <td>&nbsp;&nbsp;&nbsp;</td>
    <td class="izq-color">{$campo12}</td>
	 <td class="der-color">
	   <input type="text" name="vfechaven" size="10" maxlength="10" value='{$vfechaven}' onchange="valFecha(this,this,document.formarcas2.pago)">
	 </td>
  </table>
  &nbsp;
  <table width="300">
