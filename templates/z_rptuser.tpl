...
<form name="forcronol" action="z_rptuser.php?vopc=2" method="POST">
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
	<input type="text" name="vuser" align="right" size="12" maxlength="12" value='{$vuser}' onKeyPress="return acceptChar(event,0, this)" onkeyup="checkLength(event,this,12,document.forusing1.vcedula)" {$modo2} >
      </td>
    </tr>
    <tr>
      <td></td> 
    ...
    <tr>
      ...
      <td class="der-color">
       <input type="text" name="cedula" size="9" maxlength="9" value='{$cedula}' {$modo2} onKeyPress="return acceptChar(event,2, this)">
      </td>
      <td class="cnt">
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
        <input type='text' name='email' value='{$email}' {$modo2} size='80' maxlength="80"></td>
    </tr>
    <td class="izq-color" >{$campo5}</td>
      <td class="der-color" >
        <input type='text' name='depto_id' value='{$depto_id}' {$modo2} size='2' maxlength="2" {$modo2}>-
        <input type='text' name='unidad' value='{$unidad}' {$modo2} size='74' maxlength="77" {$modo2}>
    </td>
    <tr>
      <td class="izq-color" >{$campo10}</td>
      <td class="der-color">
        <input type='text' name='ingreso' value='{$ingreso}' {$modo2} size='25' maxlength="25">
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="der-color">
        <input type='text' name='rol' value='{$rol}' {$modo2} size='10' maxlength="10">
    </tr>
    <tr>
      <td class="izq-color" >{$campo7}</td>
      <td class="der-color">
        <input type='text' name='namrol' value='{$namrol}' {$modo2} size='70' maxlength="80">
    </tr>
    <tr>
  ...
  <iframe name='frmevmar' id='frmevmar' style='width:75%;height:150px' src="../comun/z_coneve.php?vrol={$rol}&vtipo=M"></iframe>
<p>&nbsp;</p>

  <iframe name='frmevpat' id='frmevpat' style='width:75%;height:150px' src="../comun/z_coneve.php?vrol={$rol}&vtipo=P"></iframe>
<p>&nbsp;</p>

  <iframe name='frmevpat' id='frmevpat' style='width:75%;height:150px' src="../comun/z_coneve.php?vrol={$rol}&vtipo=A"></iframe>
   ...
   <td class="menudottedline" width="9%"></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	  <tr valign="left" align="left">
	    ...
	    <td>&nbsp;</td>
	    <td>
	      <a class="toolbar" href="../comun/z_rptusuar.php?vus={$vuser}&vcd={$cedula}">
