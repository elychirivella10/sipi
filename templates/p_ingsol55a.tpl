...
<form name="formarcas2" enctype="multipart/form-data" action="p_ingsol55.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
         <textarea rows="13" name="resumen" {$modo} cols="57" maxlength="8000">{$resumen}</textarea>
      </td>
    </tr> 
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" class="der-color">
        <input type="text" name="tramitante" {$modo} value='{$tramitante}' size="56" maxlength="100" onKeyUp="this.value=this.value.toUpperCase()" onchange="habil(document.formarcas2.tramitante,document.formarcas2.vpod1,document.formarcas2.vpod2,document.formarcas2.input1,document.formarcas2.vnomage)">
        &nbsp;&nbsp;&nbsp;{$campo11}&nbsp;
    ...
    <tr>
      ...
      <td class="der-color" colspan="2">
        <input type="text" name="anualidad" '{$modo1}' value='{$anualidad}' size="1" maxlength="2" onKeyup="checkLength(event,this,2,document.formarcas2.planilla)">
        &nbsp;&nbsp;{$campo19}&nbsp;
    ...
    <tr><td>
    <iframe id='top' style='width:100%;height:100px;background-color: WHITE;' src="../comun/z_veragente.php?psol={$vsol1}-{$vsol2}&pder=P"></iframe> 
    </td></tr>  
    ...
    <table width="85%">
    <tr><td class="izq2-color">{$campo6}</td></tr>
    <tr><td>
    ...
    <tr><td class="der-color">
        ...
        <input type="button" value="Buscar/Incluir"  name="vinvi" {$modo2} onclick="browseinventorp(document.formarcas2.vsol1,document.formarcas2.vsol2,document.formarcas2.vinv,document.formarcas2.vinvi)">
        <input type="button" value="Buscar/Eliminar" name="vinve" {$modo2} onclick="browseinventorp(document.formarcas2.vsol1,document.formarcas2.vsol2,document.formarcas2.vinv,document.formarcas2.vinve)"> 
        <br>
    </td></tr> 
    </table>
    &nbsp;
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
         <a href="p_ingsol55.php?vopc=3"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar   
      {/if}    
