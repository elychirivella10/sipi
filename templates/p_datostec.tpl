...
<form name="formarcas3" action="p_datostec.php?vopc=3" method="post" onsubmit='return pregunta();'>
    ...
    <tr>
      ...
      <td class="der-color">
        <select size="1" name="vtipo">
          {html_options values=$arraytipom selected=$vtipo output=$arraynotip}
        </select>
      </td>
    </tr>
  ...
  <table width="85%" cellspacing="1" border="1">
    ...
    <tr><td class="der-color">
        ...
        <input type="button" class="boton_blue" value="Buscar/Eliminar" name="vcipe" {$modo2} onclick="browsecip(document.formarcas1.vsol1,document.formarcas1.vsol2,document.formarcas3.vcip,document.formarcas3.vcipe)"> 
        <br>
    </td></tr> 
  </table>
  ...
  <table width="40%" cellspacing="1" border="1">
    ...
    <tr><td class="der-color">
        <input type="text" name="vequiv" {$modo4} size="40" maxlength="35" onChange="javascript:this.value=this.value.toUpperCase();"> 
  ...
  <table width="250">
    <tr>
      <!-- <td class="cnt"><a href="p_rptcronol.php?vsol={$vsol1}-{$vsol2}"><input type="image" src="../imagenes/folder_f2.png"></a>		Cronologia 		</td> --> 
