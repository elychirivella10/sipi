...
<div align="center">
 <div class="main">
    ...
    <form name="foruser" action="m_panelfon.php" method="POST" >
  ...
  <table class="adminlist">
   <tr>
	...
	<tr>
		<td>
			Total Archivos B&uacute;squedas por Impresora:
		</td>
		<td>
			<input type="text" name="tcorreo" {$modo} value='{$timpresora}' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		<td>
			Total Archivos B&uacute;squedas por Correo:
		</td>
		<td>
			<input type="text" name="tcorreo" {$modo} value='{$tcorreo}' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<input type="text" name="temail" {$modo} value='{$temail}' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		<td>
			Total Archivos B&uacute;squedas por Correo sin Enviar:
		</td>
		<td>
			<input type="text" name="tcorreo" {$modo} value='{$tsinenviar}' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		<td>
			Total Pedidos B&uacute;squedas por Correo de Hoy hasta ahora cargadas:
		</td>
		<td>
			<input type="text" name="tcorreo" {$modo} value='{$tcorreohoy}' size="7" STYLE="text-align:right">		
		</td>
	</tr>
  </table>
  </div>
