...
{if $descausa[10] neq ''}
	 <td class="izq-color">{$codcausa[10]}</td><td class="der-color"><input type="checkbox" name="causa11" {$ccausa11}><td><td class="der-color">{$descausa[10]}</td>{/if}
{if $descausa[11] neq ''}
	 <td class="izq-color">{$codcausa[11]}</td><td class="der-color"><input type="checkbox" name="causa12" {$ccausa12}><td><td class="der-color">{$descausa[11]}</td></tr><tr>{/if}
{if $descausa[12] neq ''}
	 <td class="izq-color">{$codcausa[12]}</td><td class="der-color"><input type="checkbox" name="causa13" {$ccausa13}><td><td class="der-color">{$descausa[12]}</td>{/if}
{if $descausa[13] neq ''}
	 <td class="izq-color">{$codcausa[13]}</td><td class="der-color"><input type="checkbox" name="causa14" {$ccausa14}><td><td class="der-color">{$descausa[13]}</td></tr><tr>{/if}
{if $descausa[14] neq ''}
	 <td class="izq-color">{$codcausa[14]}</td><td class="der-color"><input type="checkbox" name="causa15" {$ccausa15}><td><td class="der-color">{$descausa[14]}</td>{/if}
{if $descausa[15] neq ''}
	 <td class="izq-color">{$codcausa[15]}</td><td class="der-color"><input type="checkbox" name="causa16" {$ccausa16}><td><td class="der-color">{$descausa[15]}</td></tr><tr>{/if}
{if $descausa[16] neq ''}
	 <td class="izq-color">{$codcausa[16]}</td><td class="der-color"><input type="checkbox" name="causa17" {$ccausa17}><td><td class="der-color">{$descausa[16]}</td>{/if}
{if $descausa[17] neq ''}
...
{if $descausa[23] neq ''}
	...
	<table cellspacing="1" border="1">
	<tr>
	   <td class="izq-color">{$lboletin}</td><td class="der-color"><input size="4" type="text" name="vbol" value='{$vbol}'><td>
	</tr>
	</table>
