<html>
  ...
  <br>
   <table>
   	<form name="formarcas2" action="m_actdispadm.php?vopc=2" method="post">
    ...
    <br><br>
     <table width="225">
        ...
        <td class="cnt"><a href="m_actdispadm.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
