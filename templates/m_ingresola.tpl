...
<form name="formarcas2" enctype="multipart/form-data" action="m_ingresol.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
         <textarea rows="3" name="distingue" {$modo} cols="57">{$distingue}</textarea>
      </td>
    </tr> 
    <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <textarea rows="3" name="etiqueta" {$modo} cols="57" maxlength="6000">{$etiqueta}</textarea>
      </td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
         <a href="m_ingresol.php?vopc=3&nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar   
      {/if}    
