...
<form name="formarcas1" action="p_modifica.php?vopc=1" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="p_modifica.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value={$usuario}>
  ...
  <table width="85%">
    <tr><td class="izq2-color">{$campo16}</td></tr>
    <tr><td>
    ...
    <tr><td class="der-color">
        ...
        <input type="button" value="Buscar/Eliminar" name="vcipe" {$modo2} onclick="browsecip(document.formarcas2.vsol1,document.formarcas2.vsol2,document.formarcas2.vcip,document.formarcas2.vcipe)"> 
        <br>
    </td></tr> 
  </table>
  &nbsp;
  ...
  <tr>
    ...
    <td class="cnt">
      <a href="p_modifica.php?vopc=4"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  
    </td>      
