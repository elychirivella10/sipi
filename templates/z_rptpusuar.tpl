...
<form name="forcronol" action="z_rptpusuar.php?vopc=2" method="POST">
  <div align="center">
...
<table class="menubar2" cellpadding="0" cellspacing="0" border="1">
  <tr>
   <td class="menudottedline">
     ...
     <p>
     <font size="-2">M&oacute;dulo:&nbsp;&nbsp;z_rptpusuar.php<p><p></b>Descripci&oacute;n: especificados.</font>
     </div>	
   </td>
   ...
   <td class="menudottedline" width="9%"></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	  <tr valign="left" align="left">
	    <td>&nbsp;</td>
	    <td>
	      <a class="toolbar" href="../comun/z_rptpusuar.php?vopc=1">
