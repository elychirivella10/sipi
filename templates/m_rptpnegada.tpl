...
<form name="foravzcri" action="m_rptnegada.php" method="POST">
  <div align="center">
  <br>
<table width="960px">
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
        {$campod}
        <input type="text" name="fecsold" value='{$fecsold|date_format:"%d/%m/%G"}' size='9' onChange="valFecha(document.foravzcri.fecsold)" onBlur="valagente(document.foravzcri.fecsold,document.foravzcri.fecsolh)">
    ...
    <tr>
      ...
      <td class="der-color">
        {$campod}
        <input type="text" name="fecpubd" value='{$fecpubd|date_format:"%d/%m/%G"}' size='9' onChange="valFecha(document.foravzcri.fecpubd)" onBlur="valagente(document.foravzcri.fecpubd,document.foravzcri.fecpubh)"> 
        ...
        {$campoh}
        <input type="text" name="fecpubh" value='{$fecpubh|date_format:"%d/%m/%G"}' size='9' onChange="valFecha(document.foravzcri.fecpubh)">
    ...
    <tr>
      ...
      <td class="der-color">
        {$campod}
        <input type="text" name="fecvend" value='{$fecvend|date_format:"%d/%m/%G"}' size='9' onChange="valFecha(document.foravzcri.fecvend)" onBlur="valagente(document.foravzcri.fecvend,document.foravzcri.fecvenh)"> 
        ...
        {$campoh}
        <input type="text" name="fecvenh" value='{$fecvenh|date_format:"%d/%m/%G"}' size='9' onChange="valFecha(document.foravzcri.fecvenh)">
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpnegada.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
