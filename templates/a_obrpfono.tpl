...
{/if} 
  ...
  <tr> 
    <tr>
      ...
      <td class="der-color">
        <input type="text" name="vsol1" size="6" maxlength="6" value='{$vsol1}' {$modo} onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,7,document.forfonog.fecha_solpf)" onchange="Rellena(document.foractos.vsol1,6)">&nbsp;&nbsp;
      </td>	
      {if $vopc eq 3}
        <td class="cnt">
     ...
     <tr>
	   <td>
	     {if $accion eq 'I' || $vopc eq 4}
	       <a href="a_obrpfono.php?vopc=3&nconex={$n_conex}&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	       <img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
	     {/if}
	     {if $accion eq 'M' || $vopc eq 6}
	       <a href="a_obrpfono.php?vopc=5&nconex={$n_conex}&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	       <img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
	     {/if}  
	   </td>
 	   <td>&nbsp;</td>
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
     ...
     <td class="der-color">
       <textarea rows="3" name="observacion" {$modo1} cols="130" maxlength="300">{$observacion}</textarea>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td class="der-color">
       <textarea rows="4" name="datos_ampli" {$modo1} cols="130" maxlength="300">{$datos_ampli}</textarea>
     </td>
   </tr>
  </tr> 
  </table>
