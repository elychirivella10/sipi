...
{if $vopc eq 3}
  <form name="formarcas1" action="m_bexlogo.php?vopc=5" method="post">
{/if} 		  
{if $vopc eq 4}
  <form name="formarcas1" action="m_bexlogo.php?vopc=1" method="post">
{/if} 		  
...
<form name="formarcas2" enctype="multipart/form-data" action="m_bexlogo.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type ='hidden' name='usuario' value={$usuario}>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <input tabindex="6" type="text" name="recibo" {$modo} value='{$recibo}' size="6" maxlength="6" onKeyPress="return acceptChar(event,2,this)" onkeyup="checkLength(event,this,6,document.formarcas2.solicitant)">
      </td>
    </tr>
    <tr>
...
onKeyPress="return acceptChar(event,3, this)" onchange="Rellena(document.formarcas2.nced,9)" onkeyup="checkLength(event,this,9,document.formarcas2.telefono)">
    ...
    <tr>
      ...
      <td class="der-color" colspan="2"><font class="textoayuda"><small>V= Venezolano,&nbsp;&nbsp;&nbsp;E= Extranjero,&nbsp;&nbsp;&nbsp;P= Pasaporte,&nbsp;&nbsp;&nbsp;J= Juridico,&nbsp;&nbsp;&nbsp;G= Gobierno</small></font></td>
    </tr> 
    <tr>
      <td class="izq-color" >{$campo9}</td>
      <td class="der-color">
        <input tabindex="9" type="text" name='telefono' value='{$telefono}' {$modo} size="14" maxlength="14" onKeyPress="return acceptChar(event,9,this)" onkeyup="checkLength(event,this,14,document.formarcas2.planilla)">
    ...
    <tr>
      ...
      <td class="der-color">
         <input tabindex="6" type="text" name="planilla" {$modo} value='{$planilla}' size="8" maxlength="8" onKeyPress="return acceptChar(event,2,this)" onkeyup="checkLength(event,this,8,document.formarcas2.clase)">
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         ...
         <small>* Obligatorio (SAPI=Principal)</small>
      </td>
    </tr>          
  ...
  <table width="255" >
  <tr>
    <td class="cnt"><input tabindex="10" name="Guardar" type="image" {$modo2} src="../imagenes/database_save.png" value="Guardar">	Guardar 	</td> 
    <td class="cnt">
