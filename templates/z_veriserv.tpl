...
<table cellspacing="3" border="0">
  <tr>
    ...
    <tr>
      ...
      <td class="der7-color">
        {$campod}<input type="text" name="fecdep1" value='{$fecdep1}' size='9' onChange="valFecha(document.forsolpre.fecdep1);" onBlur="valagente(document.forsolpre.fecdep1,document.forsolpre.fecdep2)">
        &nbsp;&nbsp;
        <a href="javascript:showCal('Calendar91');"><img src="../imagenes/calendar2.gif" title="Haga Clic para Seleccionar la Fecha" align="middle" width="26" height="24" border="0"></a>&nbsp;
	     {$campoh}<input type="text" name="fecdep2" value='{$fecdep2}' size='9' onChange="valFecha(document.forsolpre.fecdep2)">
        &nbsp;&nbsp;
