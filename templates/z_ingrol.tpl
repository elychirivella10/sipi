...
<form name="forrole" action="z_gbrole.php" method="POST" onsubmit="return pregunta();">
  ...
  <tr>
    ...
    <tr>
     ...
     <td class="der-color">
       <textarea onkeyUp="max(this,300)" onkeyPress="max(this,300)" onChange="Vacio(document.forrole.descripcion)" cols="72" rows="4" name="descripcion" value="{$descripcion}">{$descripcion}</textarea>
     </td>
    </tr>
  </tr>
  </table></center>
  ...
  <tr>
    ...
    <td class="cnt">
      <a href="../comun/z_ingrol.php?conx=0&na_conex={$na_conex}&nconex={$n_conex}&salir=1"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  
    </td>      
    <td class="cnt">
