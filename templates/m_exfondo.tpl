...
<form name="formarcas1" action="m_exfondo.php?vopc=1" method="post">
  ...
  <table>
     <tr>
      ...
      <td class="cnt"><input tabindex="2" type='image' src="../imagenes/buscar_f2.png" width="28" height="24" value="Buscar">  Buscar  </td>
  </tr>
  </table>
</form>				  
</div>				  

<form name="formarcas2" enctype="multipart/form-data" action="m_exfondo.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value={$usuario}>
...
<tr>
  ...
  <tr>
    ...
    <td align="rigth">
      <table>
         <tr>
	 <td>
	   <a href="m_exfondo.php?nconex={$n_conex}&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/cancel_f2.png',1);">
 ...
 <tr>
  ...
  <tr>
	<tr>
	 <td class="izq-color">{$uno}</td><td class="der-color"><input type="checkbox" name="causa1" {$modo} ><td>
	 <td class="der-color">{$luno}</td>
	 <td class="izq-color">{$dos}</td><td class="der-color"><input type="checkbox" name="causa2" {$modo} ><td>
	 <td class="der-color">{$ldos}</td></tr><tr>
	 <td class="izq-color">{$tres}</td><td class="der-color"><input type="checkbox" name="causa3" {$modo} ><td>
	 <td class="der-color">{$ltres}</td>
	 <td class="izq-color">{$cuatro}</td><td class="der-color"><input type="checkbox" name="causa4" {$modo} ><td>
	 <td class="der-color">{$lcuatro}</td></tr><tr>
	 <td class="izq-color">{$cinco}</td><td class="der-color"><input type="checkbox" name="causa5" {$modo} ><td>
	 <td class="der-color">{$lcinco}</td>
	 <td class="izq-color">{$seis}</td><td class="der-color"><input type="checkbox" name="causa6" {$modo} ><td>
	 <td class="der-color">{$lseis}</td></tr><tr>
	 <td class="izq-color">{$siete}</td><td class="der-color"><input type="checkbox" name="causa7" {$modo} ><td>
	 <td class="der-color">{$lsiete}</td>
	 <td class="izq-color">{$ocho}</td><td class="der-color"><input type="checkbox" name="causa8" {$modo} ><td>
	 <td class="der-color">{$locho}</td></tr><tr>
	 <td class="izq-color">{$nueve}</td><td class="der-color"><input type="checkbox" name="causa9" {$modo} ><td>
	 <td class="der-color">{$lnueve}</td>
	 <td class="izq-color">{$diez}</td><td class="der-color"><input type="checkbox" name="causa10" {$modo} ><td>
	 <td class="der-color">{$ldiez}</td></tr><tr>
	 <td class="izq-color">{$once}</td><td class="der-color"><input type="checkbox" name="causa11" {$modo} ><td>
	 <td class="der-color">{$lonce}</td>
	 <td class="izq-color">{$doce}</td><td class="der-color"><input type="checkbox" name="causa12" {$modo} ><td>
	 <td class="der-color">{$ldoce}</td></tr><tr>
	 <td class="izq-color">{$trece}</td><td class="der-color"><input type="checkbox" name="causa13" {$modo} ><td>
	 <td class="der-color">{$ltrece}</td>
	 <td class="izq-color">{$catorce}</td><td class="der-color"><input type="checkbox" name="causa14" {$modo} ><td>
	 <td class="der-color">{$lcatorce}</td></tr><tr>
	 <td class="izq-color">{$quince}</td><td class="der-color"><input type="checkbox" name="causa15" {$modo} ><td>
  ...
  <table>
  <tr>
    <td class="izq-color">{$lotro}</td><td class="der-color"><input type="text" name="otro" {$modo} size="111" ><td>
  </tr>
  </table>
  <table border="3" cellspacing="1">
  <tr>
    <tr>
      ...
      <td class="der-color" colspan="3">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        {if $vopc eq 3 || $vopc eq 1}
	   <input type="image" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('save','','../imagenes/save_f2.png',1);" src="../imagenes/save_f2.png" alt="Save" align="middle" name="save" border="0" onclick="document.formarcas2.opcion.value='Devolver'" />&nbsp;Grabar&nbsp;&nbsp;
        {else}
           <img src="../imagenes/save.png" alt="Save" align="middle" name="save" border="0" />&nbsp;Grabar&nbsp;&nbsp;
        {/if}
      </td>
  ...
  <table>	    
	<tr>
	 <td class="izq-color">{$lart}</td>
         <td class="der-color">
           <input size="2" type="text" name="art" {$modo} maxlength="3"  onKeyPress="return acceptChar(event,2, this)" onchange="validart(this,document.formarcas2.lit1,document.formarcas2.vlit1reg11)" onkeyup="checkLength(event,this,3,document.formarcas2.lit1)">
         <td>
	 <!-- Primer Literal - 1er. Registro -->	
	 <td class="izq-color">{$llit}</td>
         <td class="der-color">
           <input size="1" type="text" name="lit1" {$modo} maxlength="1" onKeyPress="return acceptChar(event,5, this)"  
	 onkeyup="this.value=this.value.toLowerCase();validaliteral(this,document.formarcas2.art,document.formarcas2.vlit1reg11);">
         <td>
	 <td class="der-color">{$lreg}</td>
         <td class="der-color">
	    <input type="text" name="vlit1reg11" size="1" {$modo} maxlength="1" 
	    ...
	    <input type="text" name="vlit1reg12" size="6" {$modo} maxlength="6" 
	...
	<!-- <td rowspan="3">{$espacios}</td>	-->
	 ...
	 <td class="izq-color">{$llit}</td>
         <td class="der-color">
           <input size="1" type="text" name="lit2" {$modo} maxlength="1" onKeyPress="return acceptChar(event,5, this)"  onkeyup="this.value=this.value.toLowerCase();validaliteral(this,document.formarcas2.art,document.formarcas2.vlit2reg11);">
         <td>
	 <td class="der-color">{$lreg}</td>
         <td class="der-color">
	   <input type="text" name="vlit2reg11" {$modo} size="1" maxlength="1" 
		...
		onChange="this.value=this.value.toUpperCase()">-
	   <input type="text" name="vlit2reg12" {$modo} size="6" maxlength="6" 
		value='{$lit2reg12}' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.formarcas2.vlit2reg21)" onchange="Rellena(document.formarcas2.vlit2reg12,6)">
         </td></tr><tr>
 	 </tr><tr>
	 ...
	 <td class="der-color">{$lreg}</td>
         <td class="der-color">
	    <input type="text" name="vlit1reg21" {$modo} size="1" maxlength="1" 
		...
		onChange="this.value=this.value.toUpperCase()">-
	    <input type="text" name="vlit1reg22" {$modo} size="6" maxlength="6" 
		value='{$lit1reg22}' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.formarcas2.vlit1reg31)" onchange="Rellena(document.formarcas2.vlit1reg22,6)">
         </td>
	 <td></td><td><td>	
	 ...
	 <td class="der-color">{$lreg}</td>
         <td class="der-color">
	    <input type="text" name="vlit2reg21" {$modo} size="1" maxlength="1" 
		...
		onChange="this.value=this.value.toUpperCase()">-
	    <input type="text" name="vlit2reg22" {$modo} size="6" maxlength="6" 
		value='{$lit2reg22}' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.formarcas2.vlit2reg31)" onchange="Rellena(document.formarcas2.vlit2reg22,6)">
         </td>
	 </tr><tr>
    ...
    <!-- Primer Lireral - 3er. Registro -->	
	 ...
	 <td class="der-color">{$lreg}</td>
         <td class="der-color">
	    <input type="text" name="vlit1reg31" {$modo} size="1" maxlength="1" 
		...
		onChange="this.value=this.value.toUpperCase()">-
	    <input type="text" name="vlit1reg32" {$modo} size="6" maxlength="6" 
    ...
    <!-- Segundo Lireral - 3er. Registro -->	
	 <td class="der-color">{$lreg}</td>
         <td class="der-color">
	    <input type="text" name="vlit2reg31" {$modo} size="1" maxlength="1" 
		...
		onChange="this.value=this.value.toUpperCase()">-
	    <input type="text" name="vlit2reg32" {$modo} size="6" maxlength="6" 
		value='{$lit2reg32}' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.formarcas2.comenta)" onchange="Rellena(document.formarcas2.vlit2reg32,6)">
         </td>
  </tr>
  </table>
  <table border="3" cellspacing="1">
