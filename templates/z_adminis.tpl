	  ...
	  <td  valign="top">
	    <div id="cpanel">
		  ...
		  <div style="float:left;">
			<div class="icon">
			  <a href="../comun/z_unidad.php?conx=2&nconex={$n_conex}">
		  ...
		  <div style="float:left;">
			<div class="icon">
			  <a href="../comun/z_roles.php?conx=2&nconex={$n_conex}">
		  ...
		  <div style="float:left;">
			<div class="icon">
			  <a href="../comun/z_objmenu.php?conx=2&nconex={$n_conex}">
		  ...
		  <div style="float:left;">
			<div class="icon">
			  <a href="../comun/z_usuarios.php?conx=2&nconex={$n_conex}">
		  ...
		  <div style="float:left;">
			<div class="icon">
			 <a href="../comun/z_asigmenu.php?conx=2&nconex={$n_conex}">
		  ...
		  <div style="float:left;">
			<div class="icon">
  			 <a href="../comun/z_evenrol.php?conx=2&nconex={$n_conex}">
		  ...
		  <div style="float:left;">
			<div class="icon">
			  <a href="../comun/z_asigrol.php?conx=2&nconex={$n_conex}">
