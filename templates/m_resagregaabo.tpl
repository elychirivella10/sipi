...
<div align="center">
<form name='form' action='m_resagregaabo2.php' method='POST'>
  <table width="600" >
  <tr><td colspan='4'>
  			Recuerde que solo se desplegaran los usuarios que laboran en los departamentos de: 
  			<br><ul>
  				<li> DIRECCION DE REGISTRO DE LA PROPIEDAD INTELECTUAL.</li>
  				<li> DIRECCION DE ASESORIA JURIDICA.</li>
  				<li> COORDINACION DE MARCAS Y OTROS SIGNOS DISTINTIVOS.</li>
  			</ul></td></tr>
  <tr>
