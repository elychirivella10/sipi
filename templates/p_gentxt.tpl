<html>
  ...
  <input type='hidden' name='nconex' value='{$n_conex}'>
	...
	<form name="formarcas2" action="p_gentxt.php?vopc=3" method="post">
	...
	<tr><td class="izq-color">{$ltipo}</td>
     ...
     <table width="225">
       <tr>
        ...
        <td class="cnt"><a href="p_gentxt.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
