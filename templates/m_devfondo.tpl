<html>
  ...
  <div align="center">
    <form name="formarcas1" action="m_devfondo.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas2" action="m_devfondo.php?vopc=3" method="post" onsubmit='return pregunta();'>
    	    <td>{$espacios}</td>
   ...
   {if ($vmod eq "G" || $vmod eq "M") }
	...
	<tr>
	 ...
	 <td class="izq-color">{$codcausa[12]}</td><td class="der-color"><input type="checkbox" name="causa13"><td><td class="der-color">{$descausa[12]}</td>
...
{if $descausa[23] neq ''}
	...
	<table>
	<tr>
	   <td class="izq-color">{$lotro}</td><td class="der-color"><input size="90" type="text" name="otro" maxlength="1024"><td>
	</tr>
	</table>
     </table>
     {/if}
    ...
    <tr>
      ...
      <td class="cnt"><a href="m_devfondo.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
