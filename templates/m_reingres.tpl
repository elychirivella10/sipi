...
<form name="formarcas1" action="m_reingres.php?vopc=6" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="m_reingres.php?vopc=7" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value={$usuario}>
  <input type='hidden' name='depto' value={$depto_id}>
  ...
  <!--<tr>-->
    ...
    <tr>
      ...
      <td class="der-color" rowspan="8" valign="top">
        <!-- <input name="ubicacion" type="file" value='{$ubicacion}' size="25" onChange="javascript:document.formarcas2.picture.src = 'file:///'+ document.formarcas2.ubicacion.value;">
        <br><img src='{$nameimage}' id="picture" width="270" height="260" alt="vista previa"/></br> -->
        <br><a href='{$nameimage}' target="_blank"><img border="-1" src={$nameimage} width="270" height="260"></a></br>
    ...
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="6" name="distingue" {$modo} cols="57" onchange="this.value=this.value.toUpperCase()">{$distingue}</textarea>
      </td>
    ...
    <tr>
      ...
      <td class="der-color" colspan="2">
	     <textarea rows="3" name="etiqueta" {$modo} cols="96" onchange="this.value=this.value.toUpperCase()">{$etiqueta}</textarea>
	   </td>
...
<!--        -<select size="1" name="pais" {$modo2} onchange="this.form.input2.value=this.options[this.selectedIndex].value">
    ...
    <tr><td>
    <iframe id='top' style='width:100%;height:100px;background-color: WHITE;' src="../comun/z_veragente.php?psol={$vsol1}-{$vsol2}&pder=M&tper=1"></iframe> 
    </td></tr>  
    ...
    <tr><td class="der-color">
        ...
        <input type="button" class="boton_blue" value="Corregir" name="vtituc" {$modo2} onclick="browsetitularp(document.formarcas2.vsol1,document.formarcas2.vsol2,document.formarcas2.vtitut,document.formarcas2.vtituc)"> 
        <br>
    </td></tr> 
    </table>
    &nbsp;
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
          <a href="m_reingres.php?vopc=4"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>   
      {/if}    
      {if $vopc eq 3}
          <a href="m_reingres.php?vopc=3"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      {/if}   
      {if $vopc eq 5}
          <a href="m_reingres.php?vopc=5"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      {/if}   
      {if $vopc eq 6}
          <a href="m_reingres.php?vopc=5"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      {/if}   
