...
<form name="formarcas1" action="m_vvienasol.php?vopc=1" method="post">
...
&nbsp;     
<form name="formarcas3" action="m_vvienasol.php?vopc=5&vsol={$vsol}" method="post" onsubmit='return pregunta();'>
  ...
  <table width="85%">
    ...
    <tr><td class="der-color">
        <input type="text" name="vviena" {$modo3} size="20" onkeyup="this.value=this.value.toUpperCase()">
        <input type="button" value="Buscar/Incluir"  name="vvienai" {$modo3} onclick="gestionvienap(document.formarcas3.vsol1,document.formarcas3.vsol2,document.formarcas3.vviena,document.formarcas3.vvienai)">
        <input type="button" value="Buscar/Eliminar" name="vvienae" {$modo3} onclick="gestionvienap(document.formarcas3.vsol1,document.formarcas3.vsol2,document.formarcas3.vviena,document.formarcas3.vvienae)">
    </td></tr>
  </table>
  &nbsp;
  ...
  <table width="180">
    <tr>
      <td class="cnt"><a href="m_vvienasol.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
