<html>
 ...
 <title>{$titulo}</title>
  ...
  <!-- <H3>{$subtitulo}</H3> -->
	...
	<form name="formarcas2" action="p_genrehab.php?vopc=3" method="post">
	...
	<tr><td class="izq-color">{$lboletin}</td>
	    <td class="der-color"><input type="text" name="vbol" size="3" maxlength="4" 
     ...
     <table width="225">
       <tr>
        ...
        <td class="cnt"><a href="p_genrehab.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
