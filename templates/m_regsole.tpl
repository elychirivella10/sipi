...
<form name="formarcas2" action="m_regsole.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <tr>
    ...
    <td class="izq5-color">{$campo12}</td>
	 ...
	 <td>&nbsp;&nbsp;&nbsp;</td> 
    <td class="izq5-color">{$campo13}</td>
	 <td class="der-color">
	   <input type="text" name="letra" size="1" maxlength="1" value='{$letra}' {$vmodo} align="right" onKeyUp="this.value=this.value.toUpperCase();checkLength(event,this,1,document.formarcas2.numereg)">-
  ...
  <tr>
    ...
    <td class="cnt"><a href="m_regsole.php?nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
