...
<form name="forevind1" action="a_ingreven.php?vopc=1&salir=1&conx=0" method="post">
  ...
  <table>
       <tr><td class="izq5-color">{$campo1}</td>
	    <td class="der-color"><input type="text" name="vsol1" size="6" maxlength="6" value='{$vsol1}' {$vmodo} 
...
<form name="forevind2" action="a_ingreven.php?vopc=2&salir=1&conx=0" method="post">
  ...
  <input type='hidden' name='nconex' value='{$n_conex}'>
	    ...
	    <td class="der-color"><input type="text" name="vreg1" size="6" maxlength="6"
	        value='{$vreg1}' {$vmodo} onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.forevind2.vreg1)"
