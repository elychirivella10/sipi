...
<form name="forobscon" action="m_gendevoant.php?vopc=2" method="POST">
 <div align="center">
<br>
  ...
  <br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_gendevoant.php?vopc=1"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
