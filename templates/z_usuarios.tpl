 ...
 <div class="main">
   ...
   <td class="menudottedline" width="40%" ></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	 <tr valign="left" align="left">
		<td>
			<a class="toolbar" href="../comun/z_ingusua.php?conx=1&na_conex={$n_conex}" >
		...
		<td>&nbsp;</td>
	   <td>
			<a class="toolbar" href="../comun/z_usuarios.php?nconex={$n_conex}&salir=1&conx=0">
  ...
  <table class="adminlist">
   ...
   {section name=cont loop=$vnumrows}
      <tr class="row0">
	   <td width="2%">
      <a href="../comun/z_consuser.php?vuser={$arr_user1[cont]}&vmod=id&vmodal=2&vtip=0&nconex={$n_conex}&conx=0">
		{$arr_user1[cont]}
		</a>		 
		</td>
		<td width="3%">
		<!-- <input type='checkbox' id='chk' name='chk' value='{$arr_user1[cont]}' /> -->
      <a href="../comun/z_consuser.php?vuser={$arr_user2[cont]}&vmod=cedula&vmodal=2&vtip=0&nconex={$n_conex}&conx=0">
		{$arr_user2[cont]}
		</a>		 
		</td>
		<td width="5%">
		...
		<a href="../comun/z_consuser.php?vuser={$arr_user5[cont]}&vmod=usuario&vmodal=2&vtip=0&nconex={$n_conex}&conx=0">
		{$arr_user5[cont]}
		</a>		 
		</td>
		<td width="10%" nowrap='nowrap'>
      ...
      {/if} 
		...
		<td width="4%">
		<a href='../comun/z_modusua1.php?vopc=1&valor={$arr_user1[cont]}&n_conex={$n_conex}&conx=1'>
		<img src='../imagenes/edit.png'  name='editar' title='Editar' align='left' border='0'></a>
		</td>
		<td width="4%">
		<input type='image' name='elimina' src='../imagenes/erase.png' title='Eliminar' value='{$arr_user1[cont]}'>
	   <input type='hidden' name='valor' value='{$arr_user1[cont]}'>
		</td>
	   </tr>
   {/section} 
