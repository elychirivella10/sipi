...
<form name="forcertif" action="a_rptcertif_ac.php" method="POST">
  ...
  <input type='hidden' name='egc' value='{$egc}'>
 <table>
   <tr>
    <tr>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="a_rptpcertif_ac.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
