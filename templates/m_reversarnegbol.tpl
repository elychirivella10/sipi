...
<form name="forcaduca" action="m_delnegbol.php?vopc=2" method="POST">
  <div align="center">
  <br><br>
  <table>
  <tr>
  ...
  <br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_reversarnegbol.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
