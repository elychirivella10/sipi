...
<form name="formarcas1" action="m_conviena1.php?vopc=1" method="post">
  ...
  <table width="85%" cellpadding="0" cellspacing="1" border="1">
    ...
    <tr><td class="der-color">
        ...
        <input type="button" class="boton_blue" value="Buscar/Incluir"  name="vvienai" {$modo2} onclick="gestionvienap(document.formarcas1.v1,document.formarcas1.vviena,document.formarcas1.vvienai)">
        <input type="button" class="boton_blue" value="Buscar/Eliminar" name="vvienae" {$modo2} onclick="gestionvienap(document.formarcas1.v1,document.formarcas1.vviena,document.formarcas1.vvienae)">
    </td></tr>
  </table>
   ...
   <td class="menudottedline" width="73%" ></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	  <tr valign="left" align="left">
	    ...
	    <td>
	      <a class="toolbar" >
              <input type="image" {$modo2} src="../imagenes/search_f2.png" value="Buscar" border="0">Buscar</a>
	    </td>
	    <td>&nbsp;</td>
	    <td>
