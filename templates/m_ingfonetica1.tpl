...
<form name="formarcas2" enctype="multipart/form-data" action="m_grabarbus1.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  ...
  <input type='hidden' name='vplus1' value='{$vplus}'>
 ...
 <fieldset>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
         <input type="text" name="factura" {$modo} value='{$factura}' size="8" maxlength="8" onkeyup="checkLength(event,this,8,document.formarcas2.fechadep)" >
...
onKeyPress="return acceptChar(event,3, this)" onchange="Rellena(document.formarcas2.nced,9)" onkeyup="checkLength(event,this,9,document.formarcas2.telefono)" class="required">
    ...
    <tr>
      ...
      <td class="der-color">
        <select size='1' name='vplus' {$modo2}>
    ...
    <tr>
      ...
      <td class="der-color">
        <input type='text' name='email' {$modo} value='{$email}' size="70" maxlength="80" onkeyup="checkLength(event,this,80,document.formarcas2.passwd)">
...
<td>
 <fieldset>
  ...
  <table width="752px">
    ...
    <tr><td class="izq7-color" ></td></tr>
    <tr><td>    
    <iframe id='top' style='width:100%;height:250px;background-color: WHITE;' src="m_verbus1.php?vfac={$factura}"></iframe> 
