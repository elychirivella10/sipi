...
<form name="forcaduca" action="p_elibolact.php?vopc=2" method="POST">
  <div align="center">
  <br>
  <table>
  <tr>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_eliactbol.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
