...
{if $vopc eq 3}
  <form name="foractos" id="foractos" action="a_obractosnw.php?vopc=4" method="post">
{/if}
{if $vopc eq 5}
  <form name="foractos" id="foractos" action="a_obractosnw.php?vopc=6" method="post">
{/if}
  <input type='hidden' name='nconex' value='{$n_conex}'>
  <input type="hidden" name="nhora" value="{$vhora}"> 
  <input type="hidden" name="npla" value="AC"> 
  <table>
  <tr> 
    <tr>
      ...
      <td class="der-color">
        <input type="text" name="vsol1" size="4" maxlength="16" value='{$vsol1}' {$modo} 
               onkeyup="checkLength (event,this,6,document.forautor.fecha_solic)"
...
<form name="forautor" id="forautor" enctype="multipart/form-data" action="a_obractosnw.php?vopc=2" method="POST" onsubmit='return pregunta();'> 
     ...
     <tr>
	   <td>
	     {if $accion eq 'I' || $vopc eq 4}
	       <a href="a_obractosnw.php?vopc=3&nconex={$n_conex}&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	       <img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
	     {/if}
	     {if $accion eq 'M' || $vopc eq 6}
	       <a href="a_obractosnw.php?vopc=5&nconex={$n_conex}&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	       <img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
	     {/if}  
	   </td>
 	   <td>&nbsp;</td>
 ...
 <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <textarea rows="5" name="partes" {$modo1} cols="150">{$partes}</textarea>
      </td>
    </tr>
    <tr>
      <td class="izq-color" >{$campo5}</td>
      <td class="der-color">
	     <textarea rows="5" name="naturaleza" {$modo1} cols="150" onKeyup="this.value=this.value.toUpperCase()">{$naturaleza}</textarea>
      </td>
    </tr>
  </tr>
  </table>
  ...
  <tr>
    <tr>
      <td class="der-color" >
	     <textarea rows="11" name="objeto" {$modo1} cols="163">{$objeto}</textarea>
      </td>
    </tr> 
  </tr> 
  </table>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="5" name="derechos" {$modo1} cols="150">{$derechos}</textarea>
      </td>
    </tr> 
    <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="3" name="espec_cuantia" {$modo1} cols="150" onKeyPress="if(this.value.length>300) this.value=this.value.substring(0,300);">{$espec_cuantia}</textarea>
      </td>
    </tr> 
  </tr> 
  </table>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
	     <textarea rows="2" name="duracion" {$modo1} cols="160" maxlength="200">{$duracion}</textarea>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="der-color" >
         <textarea rows="2" name="datosregistro" {$modo1} cols="160" maxlength="300" align="left">{$datosregistro}</textarea>
      </td>
    </tr>
  </tr> 
  </table>
  ...
  <tr>
   <tr>
     ...
     <td class="der-color">
       <textarea rows="4" name="observacion" {$modo1} cols="150" maxlength="500" >{$observacion}</textarea>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td class="der-color">
       <textarea rows="4" name="datos_ampli" {$modo1} cols="150" maxlength="300" >{$datos_ampli}</textarea>
     </td>
   </tr>
  </tr> 
  </table>
