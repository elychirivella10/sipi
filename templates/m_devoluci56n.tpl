  ...
  <div align="center">
   ...
   {if ($vmod eq "G" || $vmod eq "M") }
	...
	<tr>
      ...
      <table cellspacing="1" border="1">	    
	<tr>
	 <td class="izq-color">{$codcausa[0]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[0]}</b> <br> <input type="checkbox" name="subcausa1">{$dessubcausa[0]} <br> <input type="checkbox" name="subcausa2">{$dessubcausa[1]} <br> <input type="checkbox" name="subcausa3">{$dessubcausa[2]}</td>
	 <td class="izq-color">{$codcausa[1]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[1]}</b> <br> <input type="checkbox" name="subcausa4">{$dessubcausa[3]} <br> <input type="checkbox" name="subcausa5">{$dessubcausa[4]} </td></tr><tr>
	 <td class="izq-color">{$codcausa[2]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[2]}</b> <br> <input type="checkbox" name="subcausa6">{$dessubcausa[5]} <br> <input type="checkbox" name="subcausa7">{$dessubcausa[6]} <br> <input type="checkbox" name="subcausa8">{$dessubcausa[7]} </td>
	 <td class="izq-color">{$codcausa[3]}</td><td class="der-color"><input type="checkbox" name="causa4"><td><td class="der-color">{$descausa[3]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[4]}</td><td class="der-color"><input type="checkbox" name="causa5"><td><td class="der-color">{$descausa[4]}</td>
	 <td class="izq-color">{$codcausa[5]}</td><td class="der-color"><input type="checkbox" name="causa6"><td><td class="der-color">{$descausa[5]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[6]}</td><td class="der-color"><input type="checkbox" name="causa7"><td><td class="der-color">{$descausa[6]}</td>
	 <td class="izq-color">{$codcausa[7]}</td><td class="der-color"><input type="checkbox" name="causa8"><td><td class="der-color">{$descausa[7]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[8]}</td><td class="der-color"><input type="checkbox" name="causa9"><td><td class="der-color">{$descausa[8]}</td>
	 <td class="izq-color">{$codcausa[9]}</td><td class="der-color"><input type="checkbox" name="causa10"><td><td class="der-color">{$descausa[9]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[10]}</td><td class="der-color"><input type="checkbox" name="causa11"><td><td class="der-color">{$descausa[10]}</td>
	 <td class="izq-color">{$codcausa[11]}</td><td class="der-color"><input type="checkbox" name="causa12"><td><td class="der-color">{$descausa[11]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[12]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[12]}</b> <br> <input type="checkbox" name="subcausa9">{$dessubcausa[8]} <br> <input type="checkbox" name="subcausa10">{$dessubcausa[9]} <br> <input type="checkbox" name="subcausa11">{$dessubcausa[10]} <br> <input type="checkbox" name="subcausa12">{$dessubcausa[11]} <br> <input type="checkbox" name="subcausa13">{$dessubcausa[12]} <br> <input type="checkbox" name="subcausa14">{$dessubcausa[13]} <br> <input type="checkbox" name="subcausa15">{$dessubcausa[14]} <br> <input type="checkbox" name="subcausa16">{$dessubcausa[15]} </td>
	 <td class="izq-color">{$codcausa[13]}</td><td class="der-color"><input type="checkbox" name="causa14"><td><td class="der-color">{$descausa[13]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[14]}</td><td class="der-color"><input type="checkbox" name="causa15"><td><td class="der-color">{$descausa[14]}</td>
	 <td class="izq-color">{$codcausa[15]}</td><td class="der-color"><input type="checkbox" name="causa16"><td><td class="der-color">{$descausa[15]}</td></tr><tr>
	 <td class="izq-color">{$codcausa[16]}</td><td class="der-color"><input type="checkbox" name="causa17"><td><td class="der-color">{$descausa[16]}</td>
{if $descausa[17] neq ''}
