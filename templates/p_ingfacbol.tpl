...
<form name="formarcas2" enctype="multipart/form-data" action="p_evepago.php?vopc=4" method="POST" onsubmit='return pregunta();'>
 ...
 <fieldset>
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
         <input type="text" name="factura" {$modo} value='{$factura}' size="6" maxlength="6" onkeyup="number_sindec(this);checkLength(event,this,6,document.formarcas2.continuar)" class="validate-integer required">
      </td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
         <a href="p_ingfacbol.php?vopc=1"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>   
      {/if}    
    </td>      
    <td class="cnt">
