...
<table width="960px">
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
        {$campod}<input type="text" name="clase" size="2" maxlength="2" onKeyPress="return acceptChar(event,2, this)">
        &nbsp;&nbsp;
        {$campoh}<input type="text" name="clase2" size="2" maxlength="2" onKeyPress="return acceptChar(event,2, this)">
        &nbsp;&nbsp;
    ...
    <tr>
      ...
      <td class="der-color" >
        <select size='1' name='opelog'>
          {html_options values=$arrayopelog selected=$opelog output=$arrayopelog}
        </select>
