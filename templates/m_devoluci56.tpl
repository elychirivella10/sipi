<html>
  ...
  <div align="center">
    <form name="formarcas1" action="m_devoluci56.php?vopc=1" method="post">
      <table>
    ...
    <form name="formarcas2" action="m_devoluci56.php?vopc=3" method="post" onsubmit='return pregunta();'>
    	    <td>{$espacios}</td>
...
{if $descausa[23] neq ''}
    ...
    <tr>
      ...
      <td class="cnt"><a href="m_devoluci56.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
