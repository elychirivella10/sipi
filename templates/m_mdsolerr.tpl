...
<form name="formarcas1" action="m_mdsolerr.php?vopc=1" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="m_mdsolerr.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value={$usuario}>
  <input type='hidden' name='depto' value={$depto_id}>
...
<td class="der-color" rowspan="6" valign="top">
    ...
    <tr>
      ...
      <td class="der-color" colspan="2">
	     <textarea rows="3" name="distingue" {$modo} cols="100">{$distingue}</textarea>
      </td>
    </tr> 
    <tr>
      <td class="izq-color" >{$campo9}</td>
      <td class="der-color" colspan="2">
	     <textarea rows="3" name="etiqueta" {$modo} cols="100" maxlength="8000">{$etiqueta}</textarea>
	   </td>
  ...
  <tr>
    ...
    <td class="cnt">
      {if $vopc eq 1}
          <a href="m_mdsolerr.php?vopc=4&nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>   
      {/if}    
      {if $vopc eq 3}
          <a href="m_mdsolerr.php?vopc=3&nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      {/if}    
    </td>      
