  ...
  <div align="center">
   ...
   {if ($vmod eq "G" || $vmod eq "M") }
	...
	<tr>
      ...
      <table cellspacing="1" border="1">	    
	<tr>
	 <td class="izq-color">{$codcausa[0]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[0]}</b> <br> <input type="checkbox" name="subcausa1" {$cscausa1}>{$dessubcausa[0]} <br> <input type="checkbox" name="subcausa2" {$cscausa2}>{$dessubcausa[1]} <br> <input type="checkbox" name="subcausa3" {$cscausa3}>{$dessubcausa[2]}</td>
	 <td class="izq-color">{$codcausa[1]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[1]}</b> <br> <input type="checkbox" name="subcausa4" {$cscausa4}>{$dessubcausa[3]} <br> <input type="checkbox" name="subcausa5" {$cscausa5}>{$dessubcausa[4]} </td></tr><tr>
	 <td class="izq-color">{$codcausa[2]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[2]}</b> <br> <input type="checkbox" name="subcausa6" {$cscausa6}>{$dessubcausa[5]} <br> <input type="checkbox" name="subcausa7" {$cscausa7}>{$dessubcausa[6]} <br> <input type="checkbox" name="subcausa8" {$cscausa8}>{$dessubcausa[7]} </td>
	 ...
	 <td class="izq-color">{$codcausa[12]}</td><td class="der-color"><td><td class="der-color"><b>{$descausa[12]}</b> <br> <input type="checkbox" name="subcausa9" {$cscausa9}>{$dessubcausa[8]} <br> <input type="checkbox" name="subcausa10" {$cscausa10}>{$dessubcausa[9]} <br> <input type="checkbox" name="subcausa11" {$cscausa11}>{$dessubcausa[10]} <br> <input type="checkbox" name="subcausa12" {$cscausa12}>{$dessubcausa[11]} <br> <input type="checkbox" name="subcausa13" {$cscausa13}>{$dessubcausa[12]} <br> <input type="checkbox" name="subcausa14" {$cscausa14}>{$dessubcausa[13]} <br> <input type="checkbox" name="subcausa15" {$cscausa15}>{$dessubcausa[14]} <br> <input type="checkbox" name="subcausa16" {$cscausa16}>{$dessubcausa[15]} </td>
