...
<form name="formarcas1" action="m_evcomat.php?vopc=1" method="post">
...
<form name="formarcas2" action="m_evcomat.php?vopc=2" method="post">
  <input type='hidden' name='nconexion' value='{$nconexion}'>
  <input type='hidden' name='nveces' value='{$nveces}'>    
...
&nbsp;     
<form name="formarcas3" action="m_evcomat.php?vopc=3" method="post" onsubmit='return pregunta();'>
  ...
  <table width="210">
    <tr>
      <td class="cnt"><a href="m_cronolo.php?vsol={$vsol1}-{$vsol2}"><input type="image" src="../imagenes/boton_cronologia_rojo.png"></a></td> 
      <td class="cnt"><input type="image" {$modo1} src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
      <td class="cnt"><a href="m_evcomat.php?nconexion={$nconexion}&nveces={$nveces}"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
