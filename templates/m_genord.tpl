<html>
 ...
 <title>{$titulo}</title>
  ...
  <body onLoad="this.document.{$varfocus}.focus()">
	...
	<form name="formarcas2" action="m_genord.php?vopc=3" method="post">
	...
	<tr><td class="izq-color">{$lboletin}</td>
     ...
     <table width="225">
       <tr>
        ...
        <td class="cnt"><input type="image" src="../imagenes/newspaper_add.png" height="33" value="Generar">  Generar  </td>
        <td class="cnt"><a href="m_genord.php?nconex={$n_conex}&salir=1&conx=0"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
