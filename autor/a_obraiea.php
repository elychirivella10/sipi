...
<?php
// *************************************************************************************
// Programa: a_obraiea.php 
// Coordinación de Informática / Dirección de Soporte Administrativo / SAPI / MICO
// Año: 2006
// Modificado Año: 2009 II Semestre BD - Relacional 
// *************************************************************************************
...
if ($vopc==2) {
  ...
  if ($accion=="I") { //Comienzo de INCLUIR   
    ...
    $insert_str = "'$vder','$vsol','$fecha_solie','$titulobr','IE','N','N','N','$cod_idioma',1,'$p_origen','$annopripubli','$n_ejemplares','$tipo_soporte','$vobservacion','$n_hojas_adic','$vdatos_ampli','$vdatos_adicio','$nplanilla'";
    ...
    if ($ins_obras) {
      ...
      mensajenew("Falla de Ingreso de Datos en la BD, Transacciones Abortadas, Error en datos asociados a: $error_obras ...!!!","javascript:history.back();","N");
      $smarty->display('pie_pag.tpl'); exit();    
    }
...
datos_adicio='$vdatos_adicio',nplanilla='$nplanilla'";
  ...
  if ($accion=="I") { 
    Mensajenew("DATOS GUARDADOS CORRECTAMENTE...!","a_obraiea.php?vopc=3&nconex=$n_conex&salir=1&conx=0","S");}
  else {
    Mensajenew("DATOS GUARDADOS CORRECTAMENTE...!","a_obraiea.php?vopc=5&nconex=$n_conex&salir=1&conx=0","S"); }
  $smarty->display('pie_pag.tpl'); exit(); 
