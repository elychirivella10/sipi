...
//  }
  ...
  if ($accion=="I") { //Comienzo de INCLUIR
    ...
    $insert_str = "'$vder','$vsol','$fecha_solic','$vnaturaleza','AC','N','N','N','$cod_idioma',1,'$p_origen',1,'$tipo_soporte','$vobservacion','$n_hojas_adic','$vdatos_ampli','$vdatos_adicio','$nplanilla'";
