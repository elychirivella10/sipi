...
if ($vopc==6) {
  ...
  $valores_fields = array($vsol,$fecha_solic,$titulobr,$p_origen,$idioma,$n_ejemplares,$tipo_soporte,$observacion,$n_hojas_adic,$datos_ampli,$nplanilla,$datos_adicio);
  $campos = "solicitud|fecha_solic|titulo_obra|pais_origen|cod_idioma|n_ejemplares|tipo_soporte|observacion|n_hojas_adic|datos_ampli|nplanilla|datos_adicio";
...
//  }
  ...
  if ($accion=="I") { //Comienzo de INCLUIR
    ...
    $tituactos = substr($vnaturaleza,0,295)."...";
    ...
    $insert_str = "'$vder','$vsol','$fecha_solic','$tituactos','AC','N','N','N','$cod_idioma',1,'$p_origen',1,'$tipo_soporte','$vobservacion','$n_hojas_adic','$vdatos_ampli','$vdatos_adicio','$nplanilla'";
    ...
    $update_str ="fecha_solic='$fecha_solic',titulo_obra='$tituactos',pais_origen='$p_origen',cod_idioma='$cod_idioma',observacion='$vobservacion',n_hojas_adic='$n_hojas_adic',datos_ampli='$vdatos_ampli',datos_adicio='$vdatos_adicio',nplanilla='$nplanilla'";
  ...
  //$sql->disconnect();
  if ($accion=="I") { 
    Mensajenew("DATOS GUARDADOS CORRECTAMENTE ...!!!","a_obractos.php?vopc=3&nconex=$n_conex&salir=1&conx=0","S"); }
  else {
    Mensajenew("DATOS GUARDADOS CORRECTAMENTE ...!!!","a_obractos.php?vopc=5&nconex=$n_conex&salir=1&conx=0","S"); }
    $smarty->display('pie_pag.tpl'); exit(); 
}
