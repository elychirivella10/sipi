...
// $valores = array($vfechas,$vidioma,$vpaisor);
 ...
 $vacios = check_empty_fields();
  ...
  $insert_str = "nextval('stzsystem_nro_derecho_seq'),
                 '$vsol','$vfechas','$vtitulo','$vpla','$vclasif','$vorigen','$vforma',
                 'CA',
  ...
  $gb=0;
//1-->>
  $gb=guardar_interesado('Solicitante',$vsol,$vder,'V',$tipo_caracter,$otro_caracter,
                               $prueba_repres);
...
//6-->>
  ...
  //if ($can_error==0) { 
     ...
     Mensaje("DATOS GUARDADOS CORRECTAMENTE...!",
             "a_otrasobr.php?vopc=7&vpla=$vpla");
//    }
//  else {
...
$smarty->assign('vtip_od_id',array(" ","AC","AD","AN","AR","CO","ME","RE","TR","TF","VE","CN","GC"));
...
"Traducci&oacute;n","Transformaci&oacute;n","Versi&oacute;n","Continuaci&oacute;n","Gui&oacute;n Cinematogr&aacute;fico"));
$smarty->assign('vtipoed_id' ,array('E','I')); 
$smarty->assign('vtipoed_de' ,array('Editor','Impresor'));
$smarty->display('a_otrasobr.tpl');
