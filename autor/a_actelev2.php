...
$smarty->assign('arraytipom',array('OL','AV','OE','OM','AR','PC','PF','IE','AC'));
$smarty->assign('arraynotip',array('OBRA LITERARIA','ARTE VISUAL','OBRA ESCENICA','OBRA MUSICAL','OBRA AUDIOVISUAL Y RADIOFONICA','PROGRAMAS DE COMPUTACION Y B.D.','PRODUCCION FONOGRAFICA','INTERPRETACIONES Y EJECUCIONES A.','ACTOS Y CONTRATOS'));
