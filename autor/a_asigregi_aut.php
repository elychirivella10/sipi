...
$smarty ->assign('fechahoy',$fecha); 
   ...
   if (($usuario=='rmendoza') || ($usuario=='ngonzalez')) { }	 
     ...
     Mensajenew("ERROR: Usuario NO tiene Permiso para este modulo Temporalmente, contactar al Administrador del Sistema ...!!!","../index1.php","N");
   ...
   */
   ...
   if ($vopc==1) {
      ...
      if (!$resultado) { 
        ...
        mensajenew('ERROR AL PROCESAR LA BUSQUEDA','a_asigregi_aut.php','N');
	     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }	 
      $filas_found=pg_numrows($resultado); 
      if ($filas_found==0) {
        $smarty->display('encabezado1.tpl');
        mensajenew('NO EXISTEN DATOS ASOCIADOS','a_asigregi_aut.php','N');
	     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }	 
      ...
      if ($vesta<>410) {
        $smarty->display('encabezado1.tpl');
        mensajenew('Solo aplica para Solicitudes en Estatus 410','a_asigregi_aut.php','N');
	     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }
   ...
   if ($vopc==3) {
      ...
      if ($filas_reg>0) {
        $smarty->display('encabezado1.tpl');
        mensajenew('Nro. de Registro YA EXISTE en la Base de Datos ...!!!','a_asigregi_aut.php','N');
	     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }	 
      ...
      if ($ins_obras and $ins_evento) { 
         ...
         $smarty->display('encabezado1.tpl');
         Mensajenew("DATOS GUARDADOS CORRECTAMENTE!!! Registro asignado Nro. ".$vregistro,"a_asigregi_aut.php","S");
         $smarty->display('pie_pag.tpl'); exit(); }   
      ...
      //$smarty->display('encabezado1.tpl');
      //mensajenew("DATOS GUARDADOS CORRECTAMENTE!!!","a_asigregi_aut.php","S");
      //$smarty->display('pie_pag.tpl'); $sql->disconnect(); exit();   
   ...
   $smarty->display('encabezado1.tpl');
   $smarty ->display('a_asigregi_aut.tpl'); 
