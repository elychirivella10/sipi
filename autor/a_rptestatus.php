...
//PDF Encabezados
$encab_principal= "Sistema de Dereccho de Autor";
$encabezado= "Listado de Estatus del Sistema";

//Conexion
$login = $_SESSION['usuario_login'];
$modulo= "a_rptestatus.php";
...
$resultado=pg_exec("select * from stdstobr  order by estatus");
