...
$resultado=pg_exec("select * from stdevobr order by evento");
...
$filas_resultado=pg_numrows($resultado); 
 ...
 for($cont=0;$cont<$filas_resultado;$cont++) { 
	...
	$data[1]['TEXT'] = utf8_decode($registro['descripcion']);
	$data[2]['TEXT'] = $registro['tipo_evento'];
	$data[3]['TEXT'] = $registro['inf_adicional'];
	$data[4]['TEXT'] = utf8_decode($registro['mensa_automatico']);
	$data[5]['TEXT'] = $registro['plazo_ley'];
	$data[6]['TEXT'] = $registro['tipo_plazo'];
	$data[7]['TEXT'] = utf8_decode($registro['tit_comenta']);
	$registro = pg_fetch_array($resultado);
