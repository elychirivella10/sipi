...
?>
<form name='formarca' action='busca_patentes_n1.php?vopc=1&vusuario=$vtipuser' method='POST'>
...
<br><br>
<?php echo "<form action='busca_patentes_n1.php?vopc=2&vusuario=$vtipuser&lastupdate=$lastupdate' method='POST'>"; ?>
<!--<form action='busca_patentes_n.php?vopc=2&vusuario=$vtipuser&lastupdate=$lastupdate' method='POST'>-->
