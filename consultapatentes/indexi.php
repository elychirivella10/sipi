...
<?php 
  $vtipuser=5; 
  echo "<form name='formarca' action='busca_patentes_n.php?vopc=1&vusuario=$vtipuser' method='POST'>"; 
?>
...
<br /><br />
<?php echo "<form action='busca_patentes_n.php?vopc=2&vusuario=$vtipuser' method='POST'>"; ?>
...
<td>&nbsp;</td>
  <td>
    <a href="../salir.php">
    <img src="../imagenes/salir.png" alt="Salir" align="middle" name="salir" border="0" />
    <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Salir</font></a>
  </td>
  <br /><br /><br /><br /><br />
