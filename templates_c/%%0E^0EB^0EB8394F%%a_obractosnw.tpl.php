<?php /* Smarty version 2.6.8, created on 2021-06-15 12:06:15
         compiled from a_obractosnw.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'a_obractosnw.tpl', 172, false),array('function', 'html_options', 'a_obractosnw.tpl', 205, false),)), $this); ?>
<html>
<head>
     ...
     <tr>
	   <td>
	     <?php if ($this->_tpl_vars['accion'] == 'I' || $this->_tpl_vars['vopc'] == 4): ?>
	       <a href="a_obractosnw.php?vopc=3&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	     ...
	     <?php if ($this->_tpl_vars['accion'] == 'M' || $this->_tpl_vars['vopc'] == 6): ?>
	       <a href="a_obractosnw.php?vopc=5&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	       <img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
	     <?php endif; ?>  
	   </td>
...
&nbsp;&nbsp;&nbsp;
         <input type="hidden" name="nplanilla" value='<?php echo $this->_tpl_vars['nplanilla']; ?>
'>
      </td>
    </tr>
    <tr>
 ...
 cols="150"><?php echo $this->_tpl_vars['partes']; ?>
</textarea>
      </td>
    </tr>
    <tr>
 ...
 cols="150" onKeyup="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['naturaleza']; ?>
</textarea>
      </td>
    </tr>
  </tr>
 ...
 cols="163"><?php echo $this->_tpl_vars['objeto']; ?>
</textarea>
      </td>
    </tr> 
  </tr> 
 ...
 cols="150"><?php echo $this->_tpl_vars['derechos']; ?>
</textarea>
      </td>
    </tr> 
    <tr>
 ...
 cols="150" onKeyPress="if(this.value.length>300) this.value=this.value.substring(0,300);"><?php echo $this->_tpl_vars['espec_cuantia']; ?>
</textarea>
      </td>
    </tr> 
  </tr> 
 ...
 cols="160" maxlength="200"><?php echo $this->_tpl_vars['duracion']; ?>
</textarea>
      </td>
    </tr>
    <tr>
...
' size="2" maxlength="2" align="left" onKeyup="this.value=this.value.toUpperCase();checkLength(event,this,2,document.forautor.datosregistro)" onchange="valagente(document.forautor.cod_idioma,document.forautor.idioma)">-
 ...
 cols="160" maxlength="300" align="left"><?php echo $this->_tpl_vars['datosregistro']; ?>
</textarea>
      </td>
    </tr>
  </tr> 
...
' size="100" maxlength="50" onKeyup="this.value=this.value.toUpperCase()">
 ...
 cols="150" maxlength="500" ><?php echo $this->_tpl_vars['observacion']; ?>
</textarea>
     </td>
   </tr>
   <tr>
...
' size="3" maxlength="4" onKeyPress="return acceptChar(event,2, this)">
 ...
 cols="150" maxlength="300" ><?php echo $this->_tpl_vars['datos_ampli']; ?>
</textarea>
     </td>
   </tr>
  </tr> 
