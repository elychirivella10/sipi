<?php /* Smarty version 2.6.8, created on 2020-10-20 08:27:40
         compiled from m_modregis.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_modregis.tpl', 127, false),array('modifier', 'truncate', 'm_modregis.tpl', 153, false),)), $this); ?>
<html>
<head>
...
' size="10" align="right" onkeyup="checkLength(event,this,10,document.formarcas2.tipo_marca)" onchange="valFecha(this,document.formarcas2.tipo_marca)" >
    ...
    <!-- <tr>
      ...
      <td class="der-color">
         <input type="text" name="fecha_venc" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['fecha_venc']; ?>
' size="10" align="right" onkeyup="checkLength(event,this,10,document.formarcas2.tipo_marca)" onchange="valFecha(this,document.formarcas2.tipo_marca)" ></td>
    </tr> -->
    <tr>
...
&nbsp;&nbsp;
 ...
 cols="100" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['distingue']; ?>
</textarea>
      </td>
    </tr> 
    <tr>
 ...
 cols="100" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['etiqueta']; ?>
</textarea>
	   </td>
...
' align="right" size="4" maxlength="5" onchange="Rellena(document.formarcas.vpod2,4)" onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,2,document.formarcas2.agen_id)">
    ...
    <!-- <tr>
      ...
      <td colspan="2" class="der-color">
        <input type="text" name="input1" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['vcodage']; ?>
' size="5" maxlength="6" onKeypress="return acceptChar(even,2, this)" onchange="valagente(document.formarcas2.input1,document.formarcas2.vnomage)">-
        <select size="1" name="vnomage" <?php echo $this->_tpl_vars['modo2']; ?>
 onchange="this.form.input1.value=this.options[this.selectedIndex].value">
          <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['vcodagenew'],'selected' => $this->_tpl_vars['vcodage'],'output' => $this->_tpl_vars['vnomagenew']), $this);?>
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <?php if ($this->_tpl_vars['vopc'] == 1): ?>
          <a href="m_modregis.php?vopc=4&nconexion=<?php echo $this->_tpl_vars['nconexion']; ?>
&nveces=<?php echo $this->_tpl_vars['nveces']; ?>
"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      <?php endif; ?>    
      <?php if ($this->_tpl_vars['vopc'] == 3): ?>
          <a href="m_modregis.php?vopc=3&nconexion=<?php echo $this->_tpl_vars['nconexion']; ?>
&nveces=<?php echo $this->_tpl_vars['nveces']; ?>
"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a> 
      <?php endif; ?>    
    </td>      
