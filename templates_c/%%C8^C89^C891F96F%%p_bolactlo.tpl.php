<?php /* Smarty version 2.6.8, created on 2020-10-22 13:52:15
         compiled from p_bolactlo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_bolactlo.tpl', 27, false),)), $this); ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
   <table>
      <br><br><br>   
   	<form name="forpatentes2" action="p_bolactlo.php?vopc=1" method="post">
...
'  onkeyup="checkLength(event,this,10,document.forpatentes2.vtip)"
 ...
 <td class="cnt"><a href="p_bolactlo.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
