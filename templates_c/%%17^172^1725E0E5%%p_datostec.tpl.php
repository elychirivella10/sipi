<?php /* Smarty version 2.6.8, created on 2020-12-10 11:00:20
         compiled from p_datostec.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_datostec.tpl', 74, false),array('modifier', 'date_format', 'p_datostec.tpl', 92, false),)), $this); ?>
<html>
<head>
    ...
    <tr>
      ...
      <td class="der-color">
        <select size="1" name="vtipo">
          <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['arraytipom'],'selected' => $this->_tpl_vars['vtipo'],'output' => $this->_tpl_vars['arraynotip']), $this);?>
...
'></iframe>  
    ...
    <tr><td class="der-color">
        <input type="text" name="vequiv" <?php echo $this->_tpl_vars['modo4']; ?>
