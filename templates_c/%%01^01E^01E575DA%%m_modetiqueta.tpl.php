<?php /* Smarty version 2.6.8, created on 2020-10-21 12:43:41
         compiled from m_modetiqueta.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_modetiqueta.tpl', 73, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas1" action="m_modetiqueta.php?vopc=1" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="m_modetiqueta.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value=<?php echo $this->_tpl_vars['usuario']; ?>
>
 ...
 cols="95" maxlength="120" onkeyup="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['nombre']; ?>
    ...
    <tr>
      ...
      <td class="der-color" colspan="2">
	     <textarea rows="13" name="descripcion" <?php echo $this->_tpl_vars['modo']; ?>
 cols="95" onkeyup="Textarea_Sin_Enter(event.keyCode, this.id);" onkeypress="Textarea_Sin_Enter(event.keyCode, this.id);"><?php echo $this->_tpl_vars['descripcion']; ?>
</textarea>
      </td>
    </tr> 
    <tr>
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <?php if ($this->_tpl_vars['vopc'] == 1): ?>
          <a href="m_modetiqueta.php?vopc=4&nconexion=<?php echo $this->_tpl_vars['nconexion']; ?>
&nveces=<?php echo $this->_tpl_vars['nveces']; ?>
"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>   
      <?php endif; ?>    
      <?php if ($this->_tpl_vars['vopc'] == 3): ?>
          <a href="m_modetiqueta.php?vopc=3&nconexion=<?php echo $this->_tpl_vars['nconexion']; ?>
&nveces=<?php echo $this->_tpl_vars['nveces']; ?>
"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
      <?php endif; ?>    
    </td>      
