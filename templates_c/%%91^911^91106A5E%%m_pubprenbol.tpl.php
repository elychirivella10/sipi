<?php /* Smarty version 2.6.8, created on 2021-03-02 14:18:36
         compiled from m_pubprenbol.tpl */ ?>
<html>
<head>
...
<form name="forcaduca" action="m_pubprenbol.php?vopc=2" method="POST">
  <div align="center">
  <br>
  <table>
  <tr>
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,3,document.forcaduca.actualizar)">
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_pubprenbol.php?vopc=1"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
