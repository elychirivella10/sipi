<?php /* Smarty version 2.6.8, created on 2021-07-22 13:24:29
         compiled from m_rptpavztra_ua.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_rptpavztra_ua.tpl', 43, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas2" action="m_rptavztra_ua.php" method="POST">
  ...
  <br>
   ...
   <table width="200">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpavztra_ua.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
