<?php /* Smarty version 2.6.8, created on 2020-11-16 21:29:54
         compiled from m_rptpcertem.tpl */ ?>
<html>
<head>
...
<form name="forcronol" action="m_certelecm.php" method="POST">
  ...
  <br><br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpcertem.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
