<?php /* Smarty version 2.6.8, created on 2021-06-02 09:39:29
         compiled from p_eveper.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_eveper.tpl', 39, false),)), $this); ?>
<html>
<head>
...
' size="25" onChange="javascript:document.forlotes.picture.src = 'file:///'+ document.forlotes.ubicacion.value;">
    ...
    <p></p>
   &nbsp; <p></p>
   <font class='nota6'><b>Expedientes para Actualizar a Estatus 5, 11 y 12 Aplicar Evento 22, 23 y 31 (Recepción de Publicación en Prensa 1era, 2da y 3era.):</b></font>
   &nbsp;
    <table width="85%" cellspacing="1" border="1">
    <tr><td class="izq4-color" colspan="2"><?php echo $this->_tpl_vars['campo4']; ?>
</td></tr>
    <tr><td>    
    <iframe id='top22' style='width:99%;height:90px;background-color: WHITE;' src="p_vexpedt.php?vcod=<?php echo $this->_tpl_vars['nprensa']; ?>
&evto=22"></iframe> 
    </td></tr>
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.forlotes.vsol3)" 
 ...
 onclick="buscarprensa(document.forlotes.vsol1,document.forlotes.vsol2,document.forlotes.vvienai1,document.forlotes.nprensa,document.forlotes.evto22)">
        <input type="button" class="boton_blue" value="Buscar/Eliminar" name="vvienae1" <?php echo $this->_tpl_vars['modo2']; ?>
 onclick="buscarprensa(document.forlotes.vsol1,document.forlotes.vsol2,document.forlotes.vvienae1,document.forlotes.nprensa,document.forlotes.evto22)">
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top32' style='width:99%;height:90px;background-color: WHITE;' src="p_vexpedt.php?vcod=<?php echo $this->_tpl_vars['nprensa']; ?>
&evto=32"></iframe> 
    </td></tr>
    <tr><td class="der-color">
        <input type="text" name="vsol3" size="3" maxlength="4" value='<?php echo $this->_tpl_vars['vsol3']; ?>
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,4,document.forlotes.vsol3)" 
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.forlotes.vsol4)" 
		    onchange="Rellena(document.forlotes.vsol4,6);document.forlotes.vsol4.value=this.value;">
      
        <input type="button" class="boton_blue" value="Buscar/Incluir_32"  name="vvienai2" <?php echo $this->_tpl_vars['modo2']; ?>
 onclick="buscarprensa(document.forlotes.vsol3,document.forlotes.vsol4,document.forlotes.vvienai2,document.forlotes.nprensa,document.forlotes.evto32)">
        <input type="button" class="boton_blue" value="Buscar/Eliminar_32" name="vvienae2" <?php echo $this->_tpl_vars['modo2']; ?>
 onclick="buscarprensa(document.forlotes.vsol3,document.forlotes.vsol4,document.forlotes.vvienae2,document.forlotes.nprensa,document.forlotes.evto32)">
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top33' style='width:99%;height:90px;background-color: WHITE;' src="p_vexpedt.php?vcod=<?php echo $this->_tpl_vars['nprensa']; ?>
&evto=33""></iframe> 
    </td></tr>
    <tr><td class="der-color">
        <input type="text" name="vsol5" size="3" maxlength="4" value='<?php echo $this->_tpl_vars['vsol5']; ?>
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,4,document.forlotes.vsol5)" 
		    onchange="Rellena(document.forlotes.vsol5,4);document.forlotes.vsol5.value=this.value;">-
	<input type="text" name="vsol6" size="6" maxlength="6" value='<?php echo $this->_tpl_vars['vsol6']; ?>
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.forlotes.vsol6)" 
		    onchange="Rellena(document.forlotes.vsol6,6);document.forlotes.vsol6.value=this.value;">
      
        <input type="button" class="boton_blue" value="Buscar/Incluir_33"  name="vvienai3" <?php echo $this->_tpl_vars['modo2']; ?>
 onclick="buscarprensa(document.forlotes.vsol5,document.forlotes.vsol6,document.forlotes.vvienai3,document.forlotes.nprensa,document.forlotes.evto33)">
        <input type="button" class="boton_blue" value="Buscar/Eliminar_33" name="vvienae3" <?php echo $this->_tpl_vars['modo2']; ?>
 onclick="buscarprensa(document.forlotes.vsol5,document.forlotes.vsol6,document.forlotes.vvienae3,document.forlotes.nprensa,document.forlotes.evto33)">
   ...
   <tr>
     <tr>
       ...
       <td class="cnt"><a href="p_eveper.php?vopc=4"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
