<?php /* Smarty version 2.6.8, created on 2020-10-20 11:43:14
         compiled from m_rptpavzcri_nom.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'm_rptpavzcri_nom.tpl', 63, false),array('function', 'html_options', 'm_rptpavzcri_nom.tpl', 74, false),)), $this); ?>
<html>
<head>
...
<form name="foravzcri" action="m_rptavzcri_nom.php" method="POST">
  <div align="center">
  <br>
...
' size='9' onChange="valFecha(document.foravzcri.fecsolh)">
    ...
    <tr>
      ...
      <td class="der-color">
        ...
        <input type="text" name="fecpubd" value='<?php echo $this->_tpl_vars['fecpubd']; ?>
' size='9' onChange="valFecha(document.foravzcri.fecpubd)" onBlur="valagente(document.foravzcri.fecpubd,document.foravzcri.fecpubh)"> 
        ...
        <input type="text" name="fecpubh" value='<?php echo $this->_tpl_vars['fecpubh']; ?>
...
' size='9' onChange="valFecha(document.foravzcri.fecvenh)">
    ...
    <tr>
      ...
      <td class="der-color" >
        <select size='1' name='opelog'>
          <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['arrayopelog'],'selected' => $this->_tpl_vars['opelog'],'output' => $this->_tpl_vars['arrayopelog']), $this);?>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpavzcri_nom.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
