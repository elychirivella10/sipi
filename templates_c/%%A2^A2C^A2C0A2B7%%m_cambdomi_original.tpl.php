<?php /* Smarty version 2.6.8, created on 2022-02-17 09:56:32
         compiled from m_cambdomi_original.tpl */ ?>
<html>
  <head>
...
.focus()">
  <div align="center">
    <form name="formarcas1" action="m_cambdomi_original.php?vopc=1" method="post">
      <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 onKeyPress="return acceptChar(event,2, this)" 
    ...
    <form name="formarcas3" action="m_cambdomi_original.php?vopc=3" method="post" 
...
"><input type="image" src="../imagenes/folder_f2.png"></a>Cronologia</td> -->
       ...
       <td class="cnt"><a href="m_cambdomi_original.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
