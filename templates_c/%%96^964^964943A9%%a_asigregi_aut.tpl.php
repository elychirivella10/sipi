<?php /* Smarty version 2.6.8, created on 2020-10-23 09:49:20
         compiled from a_asigregi_aut.tpl */ ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
    <form name="formarcas1" action="a_asigregi_aut.php?vopc=1" method="post">
      <table>
...
' <?php echo $this->_tpl_vars['modo']; ?>
    ...
    <form name="formarcas2" action="a_asigregi_aut.php?vopc=3" method="post" 
...
"><input type="image" src="../imagenes/boton_cronologia_rojo.png"></a></td>
        ...
        <td class="cnt"><a href="a_asigregi_aut.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
