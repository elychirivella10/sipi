<?php /* Smarty version 2.6.8, created on 2020-10-31 22:11:29
         compiled from m_bolgenareg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_bolgenareg.tpl', 40, false),)), $this); ?>
<html>
  <head>
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.formarcas2.vbol)" onchange="Rellena(document.formarcas1.vsol4,6);document.formarcas2.vsoli4.value=this.value;"><td><tr>
	...
	<form name="formarcas2" action="m_bolgenareg.php?vopc=3" method="post">
	...
	<tr><td class="izq-color"><?php echo $this->_tpl_vars['ltipo']; ?>
     ...
     <table width="225">
      <tr>
       ...
       <td class="cnt"><a href="m_bolgenareg.php?nveces=<?php echo $this->_tpl_vars['nveces']; ?>
