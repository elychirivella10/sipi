<?php /* Smarty version 2.6.8, created on 2020-10-28 09:37:48
         compiled from m_est_estatus.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_est_estatus.tpl', 16, false),)), $this); ?>
<html>
<head>
...
<form name="forestanu" action="m_est_estatus.php?vopc=1" method="POST">
  <div align="center">
 <br>
 <table>
    <tr>
 ...
 <br>
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_est_estatus.php?vopc=0"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
