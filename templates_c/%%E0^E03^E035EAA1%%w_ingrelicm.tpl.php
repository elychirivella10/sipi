<?php /* Smarty version 2.6.8, created on 2022-03-30 12:06:48
         compiled from w_ingrelicm.tpl */ ?>
<html>
<head>
...
<form name="wingresol" id="w_ingreren" action="w_ingrelicm.php?vopc=4" method="post">
    ...
    <tr>
      ...
      <td>
       ...
       <?php if ($this->_tpl_vars['vopc'] == 5): ?>
         ...
         <form name="wingresol" id="w_ingreren" action="w_ingrelicm.php?vopc=6" method="post">
               <input type ='hidden' name='vtramt' value=<?php echo $this->_tpl_vars['vtramt']; ?>
> 
               <input type ='hidden' name='vsol' value=<?php echo $this->_tpl_vars['vsol']; ?>
> 
