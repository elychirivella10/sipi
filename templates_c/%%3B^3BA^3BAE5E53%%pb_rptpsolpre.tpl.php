<?php /* Smarty version 2.6.8, created on 2021-03-16 11:16:29
         compiled from pb_rptpsolpre.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'pb_rptpsolpre.tpl', 20, false),array('function', 'html_options', 'pb_rptpsolpre.tpl', 59, false),)), $this); ?>
<html>
<head>
...
<div align="center">
<form name="forsolpre" action="pb_rptsolpre.php" method="POST">
 <br><br>
 <table width="69%">
  <tr>
    <!-- <tr>
...
<table width="210">
    <tr>
      ...
      <td class="cnt"><a href="pb_rptpsolpre.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
