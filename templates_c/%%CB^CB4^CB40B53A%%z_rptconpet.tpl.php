<?php /* Smarty version 2.6.8, created on 2020-11-24 12:23:22
         compiled from z_rptconpet.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'z_rptconpet.tpl', 40, false),array('modifier', 'truncate', 'z_rptconpet.tpl', 73, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas2" action="z_rptconpet1.php" method="POST">
  <div align="center">
 <br>
  <table>
  <tr>
...
' size='9' onChange="valFecha(document.formarcas2.hastac)">
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="z_rptconpet.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
