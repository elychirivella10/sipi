<?php /* Smarty version 2.6.8, created on 2022-08-05 11:09:26
         compiled from a_veriserv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'a_veriserv.tpl', 38, false),)), $this); ?>
<html>
<head>
...
' size='9' onChange="valFecha(document.forsolpre.fecdep1);" onBlur="valagente(document.forsolpre.fecdep1,document.forsolpre.fecdep2)">
	    ...
	    <font class="columna6"><?php echo $this->_tpl_vars['campoh']; ?>
&nbsp;</font><input type="text" name="fecdep2" value='<?php echo $this->_tpl_vars['fecdep2']; ?>
