<?php /* Smarty version 2.6.8, created on 2021-01-30 19:04:19
         compiled from p_gencertif.tpl */ ?>
<html>
<head>
...
<form name="forobscon" action="p_gencertif.php?vopc=2" method="POST">
 <div align="center">
<br>
  ...
  <br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_gencertif.php?vopc=1"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
