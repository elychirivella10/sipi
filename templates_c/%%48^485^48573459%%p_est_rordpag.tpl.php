<?php /* Smarty version 2.6.8, created on 2021-10-26 10:36:25
         compiled from p_est_rordpag.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_est_rordpag.tpl', 33, false),)), $this); ?>
<html>
<head>
...
<form name="forestanu" action="p_est_rordpag.php?vopc=1" method="POST">
  <div align="center">
 <br>
 <table>
  <tr>
  ...
  <table>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_est_rordpag.php?vopc=0"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
