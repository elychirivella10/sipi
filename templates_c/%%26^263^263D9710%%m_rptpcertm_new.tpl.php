<?php /* Smarty version 2.6.8, created on 2021-08-18 09:28:20
         compiled from m_rptpcertm_new.tpl */ ?>
<html>
<head>
...
<form name="forcronol" action="m_certdigt_new.php" method="POST">
  ...
  <br><br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpcertm_new.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
