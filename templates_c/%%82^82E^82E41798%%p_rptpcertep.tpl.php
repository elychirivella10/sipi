<?php /* Smarty version 2.6.8, created on 2022-01-19 13:45:29
         compiled from p_rptpcertep.tpl */ ?>
<html>
<head>
...
<form name="forcronol" action="p_certelecp.php" method="POST">
  ...
  <br><br>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_rptpcertep.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
