<?php /* Smarty version 2.6.8, created on 2020-10-20 11:33:38
         compiled from m_rptppeticio.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'm_rptppeticio.tpl', 24, false),)), $this); ?>
<html>
<head>
...
' size='9' onChange="valFecha(document.forpeticio.fecha)"> 
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptppeticio.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
