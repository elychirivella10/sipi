<?php /* Smarty version 2.6.8, created on 2020-11-07 20:36:42
         compiled from m_rptpdevreg.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'm_rptpdevreg.tpl', 18, false),)), $this); ?>
<html>
<head>
...
' size='9' onChange="valFecha(document.foravzcri.fecsolh)">
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpdevreg.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
