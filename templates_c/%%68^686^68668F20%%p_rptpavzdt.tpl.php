<?php /* Smarty version 2.6.8, created on 2022-06-27 16:04:21
         compiled from p_rptpavzdt.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_rptpavzdt.tpl', 43, false),)), $this); ?>
<html>
<head>
...
.focus()">
<form name="formarcas2" action="p_rptavzdt.php" method="POST">
...
' size='9' onChange="valFecha(document.formarcas2.hastat)">
   ...
   <table width="200">
    <tr>
      ...
      <td class="cnt"><a href="p_rptpavzdt.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
