<?php /* Smarty version 2.6.8, created on 2021-11-05 14:11:27
         compiled from m_bolactloe.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_bolactloe.tpl', 27, false),)), $this); ?>
<html>
  <head>
...
.focus()">
  ...
  <br><br><br>  
   <table>
   	<form name="formarcas2" action="m_bolactloe.php?vopc=1" method="post">
...
'  onkeyup="checkLength(event,this,10,document.formarcas2.vtip)"
 ...
 <td class="cnt"><a href="m_bolactloe.php?nveces=<?php echo $this->_tpl_vars['nveces']; ?>
