<?php /* Smarty version 2.6.8, created on 2020-10-19 15:55:44
         compiled from p_rptpavztra_r.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_rptpavztra_r.tpl', 42, false),)), $this); ?>
<html>
<head>
...
<form name="foravztra" action="p_rptavztra_r.php" method="POST">
  <div align="center">
...
' size='9' onChange="valFecha(document.foravztra.hastat)">
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_rptpavztra_r.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
