<?php /* Smarty version 2.6.8, created on 2022-07-28 10:26:39
         compiled from a_rptmpoficio.tpl */ ?>
<html>
<head>
...
<form name="forofcfor" action="a_rptemoficio.php" method="POST">
 <div align="center">
 <br>
 <table width='25%'>
...
'>
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="a_rptmpoficio.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
