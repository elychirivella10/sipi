<?php /* Smarty version 2.6.8, created on 2022-05-13 16:04:51
         compiled from a_obraiea.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'a_obraiea.tpl', 127, false),array('function', 'html_radios', 'a_obraiea.tpl', 162, false),)), $this); ?>
<html>
<head>
...
' <?php echo $this->_tpl_vars['modo']; ?>
 onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,7,document.forobfie.fecha_solpf)" onchange="Rellena(document.foractos.vsol1,6)">&nbsp;&nbsp;
      </td>	
      <?php if ($this->_tpl_vars['vopc'] == 3): ?>
      <td class="cnt">
     ...
     <tr>
	   <td>
	     <?php if ($this->_tpl_vars['accion'] == 'I' || $this->_tpl_vars['vopc'] == 4): ?>
	       <a href="a_obraiea.php?vopc=3&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	     ...
	     <?php if ($this->_tpl_vars['accion'] == 'M' || $this->_tpl_vars['vopc'] == 6): ?>
	       <a href="a_obraiea.php?vopc=5&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_rojo.png',1);">
	       <img src="../imagenes/boton_cancelar_rojo.png" alt="Cancel" align="middle" name="cancel" border="0" /></a>
	     <?php endif; ?>  
	   </td>
...
' size="8" maxlength="8" onKeyUp="javascript:this.value=this.value.toUpperCase();">
 ...
 onclick="browseartista(document.forobfie.vsol1,document.forobfie.artista,document.forobfie.CorregirA)">
         <input type="button" name="EliminarA" value="Eliminar" <?php echo $this->_tpl_vars['bmodo']; ?>
 onclick="browseartista(document.forobfie.vsol1,document.forobfie.artista,document.forobfie.EliminarA)">
...
' size="25" maxlength="25">
 ...
 cols="115" maxlength="300"><?php echo $this->_tpl_vars['observacion']; ?>
</textarea>
     </td>
   </tr>
   <tr>
...
' size="3" maxlength="4" onKeyPress="return acceptChar(event,2, this)">
 ...
 cols="115" maxlength="300"><?php echo $this->_tpl_vars['datos_ampli']; ?>
</textarea>
     </td>
   </tr>
  </tr> 
