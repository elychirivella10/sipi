<?php /* Smarty version 2.6.8, created on 2021-02-25 15:30:16
         compiled from m_eveper.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_eveper.tpl', 37, false),)), $this); ?>
<html>
<head>
...
' size="25" onChange="javascript:document.forlotes.picture.src = 'file:///'+ document.forlotes.ubicacion.value;">
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top22' style='width:99%;height:90px;background-color: WHITE;' src="m_vexpedt.php?vcod=<?php echo $this->_tpl_vars['nprensa']; ?>
&evto=22"></iframe> 
    </td></tr>
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.forlotes.vsol3)" 
 ...
 onclick="buscarprensa(document.forlotes.vsol1,document.forlotes.vsol2,document.forlotes.vvienae1,document.forlotes.nprensa,document.forlotes.evto22)">
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top32' style='width:99%;height:90px;background-color: WHITE;' src="m_vexpedt.php?vcod=<?php echo $this->_tpl_vars['nprensa']; ?>
&evto=32"></iframe> 
    </td></tr>
    <tr><td class="der-color">
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.forlotes.vsol4)" 
 ...
 onclick="buscarprensa(document.forlotes.vsol3,document.forlotes.vsol4,document.forlotes.vvienae2,document.forlotes.nprensa,document.forlotes.evto32)">
   ...
   &nbsp;
    ...
    <tr><td>    
    <iframe id='top33' style='width:99%;height:90px;background-color: WHITE;' src="m_vexpedt.php?vcod=<?php echo $this->_tpl_vars['nprensa']; ?>
&evto=33""></iframe> 
    </td></tr>
    <tr><td class="der-color">
