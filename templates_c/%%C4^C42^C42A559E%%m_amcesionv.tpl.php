<?php /* Smarty version 2.6.8, created on 2021-02-17 14:23:13
         compiled from m_amcesionv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'm_amcesionv.tpl', 56, false),array('function', 'html_radios', 'm_amcesionv.tpl', 84, false),array('function', 'html_options', 'm_amcesionv.tpl', 108, false),)), $this); ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
  <form name="formarcas1" action="m_amcesionv.php?vopc=1" method="post">
     <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 onKeyPress="return acceptChar(event,2, this)" 
  ...
  <form name="formarcas2" action="m_amcesionv.php?vopc=2" method="post">
...
'></iframe> 
     ...
     <form name="formarcas3" action="m_amcesionv.php?vopc=3" method="post" onsubmit='return pregunta();'>
...
"><input type="image" src="../imagenes/folder_f2.png"></a>Cronologia</td> -->
     <td class="cnt"><input type="image" src="../imagenes/boton_guardar_azul.png" name="guardar" value="Guardar"></td> 
     <td class="cnt"><a href="m_amcesionv.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
