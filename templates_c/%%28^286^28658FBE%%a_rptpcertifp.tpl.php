<?php /* Smarty version 2.6.8, created on 2022-04-06 05:35:20
         compiled from a_rptpcertifp.tpl */ ?>
<html>
<head>
...
<br>
 ...
 <form name="forcertif" action="a_rptcertifp.php" method="POST">
  <div align="center">
 ...
 <table>
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="a_rptpcertifp.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
