<?php /* Smarty version 2.6.8, created on 2020-10-20 10:14:46
         compiled from m_rptplisbol.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_rptplisbol.tpl', 36, false),)), $this); ?>
<html>
<head>
 ...
 <input type="text" name="vsol1" align="right" size="3" maxlength="4" onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,4,document.forlisbol.vsol2)" onchange="Rellena(document.forlisbol.vsol1,2)">-
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptplisbol.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
