<?php /* Smarty version 2.6.8, created on 2020-10-20 10:38:55
         compiled from a_otrasobr.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'a_otrasobr.tpl', 143, false),array('function', 'html_radios', 'a_otrasobr.tpl', 204, false),)), $this); ?>
<html>
<head>
...
<form name="foroobras" action="a_otrasobr.php?vopc=4&vpla=<?php echo $this->_tpl_vars['vpla']; ?>
" method="post">
<?php endif;  if ($this->_tpl_vars['vopc'] == 7): ?>
<form name="foroobras" action="a_otrasobr.php?vopc=8&vpla=<?php echo $this->_tpl_vars['vpla']; ?>
" method="post">
<?php endif; ?>
  <table>
    <tr>
...
<form name="forautor" id="forautor" enctype="multipart/form-data" 
      action="a_otrasobr.php?vopc=<?php echo $this->_tpl_vars['accion']; ?>
...
"> 
    ...
    <tr>
      ...
      <a href="a_otrasobr.php?vopc=7&vpla=<?php echo $this->_tpl_vars['vpla']; ?>
&nveces=<?php echo $this->_tpl_vars['nveces']; ?>
&nconexion=<?php echo $this->_tpl_vars['nconexion']; ?>
" onmouseout="MM_swapImgRestore();"  
      <?php else: ?>
      <a href="a_otrasobr.php?vopc=3&vpla=<?php echo $this->_tpl_vars['vpla']; ?>
&nveces=<?php echo $this->_tpl_vars['nveces']; ?>
&nconexion=<?php echo $this->_tpl_vars['nconexion']; ?>
" onmouseout="MM_swapImgRestore();"  
      <?php endif; ?>
...
' size="10" align="left" 
         ...
         <tr>
           ...
           <td width="30%"> 
           <input type="text" name="vnumpla" <?php echo $this->_tpl_vars['modo1']; ?>
 value='<?php echo $this->_tpl_vars['vnumpla']; ?>
' size="6" maxlength="6" 
...
' size="3" maxlength="4"
         ...
         <tr>
           ...
           <td > <!-- colspan="3" -->
              <textarea row="4" name="vdescri" <?php echo $this->_tpl_vars['modo1']; ?>
 value='<?php echo $this->_tpl_vars['vdescri']; ?>
' cols="136" maxlength="2000"><?php echo $this->_tpl_vars['vdescri']; ?>
</textarea>
           </td> 
         </tr>
         <?php endif; ?> 
...
' cols="89" 
                     maxlength="600"><?php echo $this->_tpl_vars['vdesarg']; ?>
</textarea></td> 
         </tr>
         <tr> 
...
' cols="89" 
                     maxlength="600"><?php echo $this->_tpl_vars['vdesmus']; ?>
</textarea></td>  
         </tr>
         <tr> 
...
' cols="89" 
                     maxlength="600"><?php echo $this->_tpl_vars['vdesmov']; ?>
</textarea></td>  
         </tr>
        </table>
        &nbsp;
...
' size="89" maxlength="300" onKeyup="this.value=this.value.toUpperCase();"></td> 
         </tr>
         <tr> 
...
&vtipo=Autor"></iframe>
           <!-- <iframe name='frameauto' id='frameauto' style='width:100%;height:120px' src="d_consoli.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
&vtipo=Autor"></iframe> -->
          </div>
         </td>
         </tr>
...
' size="60" maxlength="150" onChange="javascript:this.value=this.value.toUpperCase();">
 ...
 onclick="browsecoautor(document.forautor.vsol,document.forautor.coautor,document.forautor.Nperson_c)">
          <input type="button" name="Jperson_c" value="Juridica" <?php echo $this->_tpl_vars['bmodo']; ?>
 onclick="browsecoautor(document.forautor.vsol,document.forautor.coautor,document.forautor.Jperson_c)">
          </td></tr>
          <tr>
          <td class="izq-color">Director o Realizador: </td>
          <td class="der-color">
          <iframe name='framecoauto1' id='framecoauto1' style='width:100%;height:70px' src="d_consoli.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
&vtipo=Coautor1"></iframe></td></tr>
         ...
         <td class="der-color">
         <div id="resultado">
          <iframe name='framecoauto2' id='framecoauto2' style='width:100%;height:70px' src="d_consoli.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
&vtipo=Coautor2"></iframe></td></tr>
         ...
         <td class="der-color">
         <div id="resultado">
          <iframe name='framecoauto3' id='framecoauto3' style='width:100%;height:70px' src="d_consoli.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
&vtipo=Coautor3"></iframe></td></tr>
         ...
         <td class="der-color">
         <div id="resultado">
          <iframe name='framecoauto4' id='framecoauto4' style='width:100%;height:70px' src="d_consoli.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
...
&vtipo=Productor"></iframe>
          <!-- <iframe name='frameproductor' id='frameproductor' style='width:100%;height:120px' src="d_consoli.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
&vtipo=Productor"></iframe> -->
         </div>
          </td></tr>
        </table>
...
' cols="135" maxlength="300"><?php echo $this->_tpl_vars['vobs_fi']; ?>
</textarea>
           </td> 
         </tr>
        </table>   
...
' size="60" maxlength="300" onChange="javascript:this.value=this.value.toUpperCase();">
<!--          <input type="button" name="Nperson_a" value="Incluir Artista" <?php echo $this->_tpl_vars['bmodo']; ?>
 onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.Nperson_a)"> -->
          <input type="button" name="Nperson_a" value="Natural" <?php echo $this->_tpl_vars['bmodo']; ?>
 onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.Nperson_a)"> 
          <input type="button" name="CorregirA" value="Corregir" <?php echo $this->_tpl_vars['bmodo']; ?>
 onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.CorregirA)">
          <input type="button" name="EliminarA" value="Eliminar" <?php echo $this->_tpl_vars['bmodo']; ?>
 onclick="browseatista(document.forautor.vsol,document.forautor.atista,document.forautor.EliminarA)">
          <iframe name='framesoli' id='framesoli' style='width:100%;height:100px' src="d_vernatjur.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
...
' cols="138" maxlength="300"><?php echo $this->_tpl_vars['vtransf']; ?>
</textarea>
           </td> 
         </tr>
        </table>
...
' size="120" maxlength="100" onKeyup="this.value=this.value.toUpperCase()">
         </td>
        </tr>
        <tr>
 ...
 cols="130" maxlength="1024" onKeyup="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['prueba_repres']; ?>
</textarea>
         </td>
        </tr>
       </table>
...
' cols="118" 
                     maxlength="300"><?php echo $this->_tpl_vars['vobs_de']; ?>
</textarea></td> 
         </tr>
        </table>        
       </div>
...
' cols="118" 
                     maxlength="300"><?php echo $this->_tpl_vars['vamplia']; ?>
</textarea></td> 
         </tr>
         <tr>
...
' cols="118" 
                     maxlength="30000"><?php echo $this->_tpl_vars['vadicio']; ?>
</textarea></td> 
         </tr>
        </table>        
       </div>
