<?php /* Smarty version 2.6.8, created on 2020-11-09 10:52:49
         compiled from m_rptpexp.tpl */ ?>
<html>
<head>
...
.focus()">
 ...
 <form name="forcronol" action="m_rptpexp1.php" method="post">
 <div align="center">
 <br>
  ...
  <tr>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpexp.php?vsol1=<?php echo $this->_tpl_vars['vsol1']; ?>
