<?php /* Smarty version 2.6.8, created on 2022-03-21 09:45:47
         compiled from w_ingrepat1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'w_ingrepat1.tpl', 26, false),)), $this); ?>
<html>
<head>
...
<form name="wingresol" id="w_grabar" action="w_ingrepat.php?vopc=6" method="post">
  ...
  <tr><td WIDTH=30% class='izq-color'><b>Titulo Técnico de la Invención o Creación:</b>
      ...
      <?php echo $this->_tpl_vars['vnom_pat']; ?>
</br>
...
' target='_blank'><img border='0' src=<?php echo $this->_tpl_vars['nameimage']; ?>
 width='185' height='185'>
  ...
  <tr><td WIDTH=30% class='izq-color'><b>Tipo de Patente:</b>
      ...
      <?php echo $this->_tpl_vars['vtip_pat']; ?>
</br>
  </font></br></td></tr>
...
' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000000 (n&uacute;mero)</font>
  ...
  <tr><td class='izq-color'><b>N&uacute;mero de Factura Pago de Anualidad:</b>
     </td><td>F<input type='text' size='5' name='vanu' maxlength='7' value='<?php echo $this->_tpl_vars['vanu']; ?>
' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000000 (n&uacute;mero)</font>
  </td></tr>
  <tr><td class='izq-color'><b>N&uacute;mero Planilla Pago Anualidad:</b>
     </td><td><input type='text' size='5' name='vplan' maxlength='7' value='<?php echo $this->_tpl_vars['vplan']; ?>
' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 00000 (n&uacute;mero)</font>
  </td></tr>
  <!--<tr><td class='izq-color'><b>Monto:</b>
     </td><td><input type='text' size='5' name='vmonto' maxlength='7' value='<?php echo $this->_tpl_vars['vmonto']; ?>
' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 00.00 (bolivares)</font>
  </td></tr>-->
  </table>
