<?php /* Smarty version 2.6.8, created on 2022-01-24 11:07:08
         compiled from m_rptpavztra.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_rptpavztra.tpl', 43, false),)), $this); ?>
<html>
<head>
...
' size='9' onChange="valFecha(document.formarcas2.fecha_venc)" onBlur="valagente(document.formarcas2.fecha_venc,document.formarcas2.tipo_marca)"> 
    ...
    <tr>
      ...
      <td class="der-color" >
        <select size='1' name='busfone'>
          <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['arraybusfone'],'selected' => $this->_tpl_vars['busfone'],'output' => $this->_tpl_vars['arraydesbusfone']), $this);?>
    ...
    <tr>
      ...
      <td class="der-color" >
        <select size='1' name='busgraf'>
          <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['arraybusgraf'],'selected' => $this->_tpl_vars['busgraf'],'output' => $this->_tpl_vars['arraydesbusgraf']), $this);?>
  ...
  <br>
   ...
   <table width="200">
    <tr>
      ...
      <td class="cnt"><a href="m_rptpavztra.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
