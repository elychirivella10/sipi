<?php /* Smarty version 2.6.8, created on 2020-10-20 10:52:58
         compiled from m_devoluci56nf_mod.tpl */ ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
    <form name="formarcas1" action="m_devoluci56nf_mod.php?vopc=1" method="post">
      <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 ...
 name='submit' value='Buscar'></td> --> 
    ...
    <form name="formarcas2" action="m_devoluci56nf_mod.php?vopc=3" method="post" onsubmit='return pregunta();'>
...
</b> <br> <input type="checkbox" name="subcausa1" <?php echo $this->_tpl_vars['cscausa1']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][0]; ?>
 <br> <input type="checkbox" name="subcausa2" <?php echo $this->_tpl_vars['cscausa2']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][1]; ?>
 <br> <input type="checkbox" name="subcausa3" <?php echo $this->_tpl_vars['cscausa3']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][2]; ?>
</td>
...
</b> <br> <input type="checkbox" name="subcausa4" <?php echo $this->_tpl_vars['cscausa4']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][3]; ?>
 <br> <input type="checkbox" name="subcausa5" <?php echo $this->_tpl_vars['cscausa5']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][4]; ?>
 </td></tr><tr>
...
</b> <br> <input type="checkbox" name="subcausa6" <?php echo $this->_tpl_vars['cscausa6']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][5]; ?>
 <br> <input type="checkbox" name="subcausa7" <?php echo $this->_tpl_vars['cscausa7']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][6]; ?>
 <br> <input type="checkbox" name="subcausa8" <?php echo $this->_tpl_vars['cscausa8']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][7]; ?>
 </td>
...
</b> <br> <input type="checkbox" name="subcausa9" <?php echo $this->_tpl_vars['cscausa9']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][8]; ?>
 <br> <input type="checkbox" name="subcausa10" <?php echo $this->_tpl_vars['cscausa10']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][9]; ?>
 <br> <input type="checkbox" name="subcausa11" <?php echo $this->_tpl_vars['cscausa11']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][10]; ?>
 <br> <input type="checkbox" name="subcausa12" <?php echo $this->_tpl_vars['cscausa12']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][11]; ?>
 <br> <input type="checkbox" name="subcausa13" <?php echo $this->_tpl_vars['cscausa13']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][12]; ?>
 <br> <input type="checkbox" name="subcausa14" <?php echo $this->_tpl_vars['cscausa14']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][13]; ?>
 <br> <input type="checkbox" name="subcausa15" <?php echo $this->_tpl_vars['cscausa15']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][14]; ?>
 <br> <input type="checkbox" name="subcausa16" <?php echo $this->_tpl_vars['cscausa16']; ?>
><?php echo $this->_tpl_vars['dessubcausa'][15]; ?>
 </td>
...
'>
    ...
    <tr>
      ...
      <td class="cnt"><a href="m_devoluci56nf_mod.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
