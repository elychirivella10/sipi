<?php /* Smarty version 2.6.8, created on 2020-11-05 11:01:38
         compiled from m_cambdomi.tpl */ ?>
<html>
  <head>
...
.focus()">
  <div align="center">
    <form name="formarcas1" action="m_cambdomi.php?vopc=1" method="post">
      <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 onKeyPress="return acceptChar(event,2, this)" 
    ...
    <form name="formarcas3" action="m_cambdomi.php?vopc=3" method="post" 
...
"><input type="image" src="../imagenes/folder_f2.png"></a>Cronologia</td> -->
       ...
       <td class="cnt"><a href="m_cambdomi.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
