<?php /* Smarty version 2.6.8, created on 2020-10-31 22:11:10
         compiled from m_cadubol.tpl */ ?>
<html>
<head>
...
<form name="forcaduca" action="m_cadumbol.php?vopc=2" method="POST">
  <div align="center">
  <br>
  <table>
  <tr>
...
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,3,document.forcaduca.actualizar)">
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_cadubol.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
