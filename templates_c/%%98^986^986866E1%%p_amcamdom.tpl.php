<?php /* Smarty version 2.6.8, created on 2020-12-07 08:48:44
         compiled from p_amcamdom.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'p_amcamdom.tpl', 67, false),array('function', 'html_options', 'p_amcamdom.tpl', 121, false),)), $this); ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
  <form name="formarcas1" action="p_amcamdom.php?vopc=1" method="post">
     <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 onKeyPress="return acceptChar(event,2, this)" 
  ...
  <form name="formarcas2" action="p_amcamdom.php?vopc=2" method="post">
...
'></iframe> 
  ...
  &nbsp;
  <form name="formarcas3" action="p_amcamdom.php?vopc=3" method="post" 
...
&ptip=P'></iframe> 
     ...
     <input type="button" value="Cambiar Domicilio" class="boton_blue" <?php echo $this->_tpl_vars['modo2']; ?>
 name="vtitue"          
...
"><input type="image" src="../imagenes/folder_f2.png"></a>Cronologia</td> -->
     ...
     <td class="cnt"><a href="p_amcamdom.php"><img src="../imagenes/cancel_f2.png" border="0">
     </a>  Cancelar  </td>
