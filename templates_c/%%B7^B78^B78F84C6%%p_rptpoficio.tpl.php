<?php /* Smarty version 2.6.8, created on 2020-10-21 09:15:37
         compiled from p_rptpoficio.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_rptpoficio.tpl', 31, false),)), $this); ?>
<html>
<head>
...
<form name="forofcfor" action="p_rptoficio.php" method="POST">
 ...
 <table width='30%'>
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_rptpoficio.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
