<?php /* Smarty version 2.6.8, created on 2020-10-20 08:27:29
         compiled from m_ipoderes.tpl */ ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
    <form name="formarcas1" action="m_ipoderes.php?vopc=1" method="post">
...
></td>
    ...
    <form name="formarcas3" action="m_ipoderes.php?vopc=5&vsol=<?php echo $this->_tpl_vars['vsol']; ?>
" method="post">
...
></td>
      ...
      <table width="225">
        ...
        <td class="cnt"><a href="m_ipoderes.php?vopc=11"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td> 
        <?php endif; ?>
        ...
        <td class="cnt"><a href="m_ipoderes.php?vopc=<?php echo $this->_tpl_vars['vopc']; ?>
