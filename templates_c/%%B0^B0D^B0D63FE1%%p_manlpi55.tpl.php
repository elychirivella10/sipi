<?php /* Smarty version 2.6.8, created on 2022-02-01 11:48:36
         compiled from p_manlpi55.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_manlpi55.tpl', 63, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas1" action="p_manlpi55.php?vopc=1" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="p_manlpi55.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value=<?php echo $this->_tpl_vars['usuario']; ?>
>
...
' id="picture" width="270" height="272" alt="vista previa"/></br>
 ...
 cols="57" maxlength="400" onkeyup="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['nombre']; ?>
</textarea>
	   </td>
    </tr>
    <tr>
...
"></iframe> 
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <a href="p_manlpi55.php?vopc=4"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
    </td>      
