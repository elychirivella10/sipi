<?php /* Smarty version 2.6.8, created on 2022-04-30 20:46:44
         compiled from w_ingrecesp.tpl */ ?>
<html>
<head>
...
<form name="wingresol" id="w_ingreren" action="w_ingrecesp.php?vopc=4" method="post">
    ...
    <tr>
      ...
      <td>
       ...
       <?php if ($this->_tpl_vars['vopc'] == 5): ?>
         ...
         <form name="wingresol" id="w_ingreren" action="w_ingrecesp.php?vopc=6" method="post">
               <input type ='hidden' name='vtramt' value=<?php echo $this->_tpl_vars['vtramt']; ?>
> 
               <input type ='hidden' name='vsol' value=<?php echo $this->_tpl_vars['vsol']; ?>
> 
      ...
      <?php endif; ?>      
      <td>
	    <a href="w_ingrecesp.php?vopc=3" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','../imagenes/boton_cancelar_azul.png',1);">
