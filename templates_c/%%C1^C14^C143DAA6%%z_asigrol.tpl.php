<?php /* Smarty version 2.6.8, created on 2020-10-28 11:26:54
         compiled from z_asigrol.tpl */ ?>
<html>
<head>
   ...
   <td class="menudottedline" width="40%" ></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	 <tr valign="left" align="left">
		<td>
			<a class="toolbar" href="../comun/z_asgusrol.php?conx=1&na_conex=<?php echo $this->_tpl_vars['n_conex']; ?>
" >
		...
		<td>&nbsp;</td>
	   <td>
			<a class="toolbar" href="../comun/z_asigrol.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0">
...
&vmodal=2&vtip=0&vopm=AR&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&conx=0">
		...
		<td width="5%">
		<a href="../comun/z_elmrolus.php?vopc=1&valor=<?php echo $this->_tpl_vars['arr_role1'][$this->_sections['cont']['index']]; ?>
