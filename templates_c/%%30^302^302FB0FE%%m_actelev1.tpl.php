<?php /* Smarty version 2.6.8, created on 2020-10-21 07:20:16
         compiled from m_actelev1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'm_actelev1.tpl', 14, false),array('function', 'html_radios', 'm_actelev1.tpl', 105, false),)), $this); ?>
<html>
<head>
...
<body onLoad="document.forevento.input2.focus()">
  ...
  <form name="forevento" action="m_actelev2.php" method="POST">
...
' target="_blank">
 ...
 width="186" height="210">
    ...
    <tr>
      ...
      <td class="der-color">
        <input type='text' name='nroderecho' value='<?php echo $this->_tpl_vars['nroderecho']; ?>
...
' readonly='readonly' size='70'></td>
  ...
  <table width="900" cellspacing="1" border="1">
    <tr>
      <td class="izq4-color" >Evento &nbsp;F. Evento &nbsp;&nbsp;&nbsp;F. Transac Secuencial E/Ant &nbsp;&nbsp;Documento&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Comentario
      </td>
    </tr> 
    <tr>
      <td class="der1-color" >
