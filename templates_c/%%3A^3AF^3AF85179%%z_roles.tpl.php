<?php /* Smarty version 2.6.8, created on 2020-10-29 10:18:41
         compiled from z_roles.tpl */ ?>
<html>
<head>
...
<form name="forroles" action="z_roles.php" method="POST" >
   ...
   <td class="menudottedline" width="40%" ></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	 <tr valign="left" align="left">
		<td>
			<a class="toolbar" href="../comun/z_ingrol.php?conx=1&na_conex=<?php echo $this->_tpl_vars['n_conex']; ?>
" >
		...
		<td>&nbsp;</td>
	   <td>
			<a class="toolbar" href="../comun/z_roles.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0">
...
" /> 
		...
		<td width="10%">
		<a href="../comun/z_admgrol.php?vrol=<?php echo $this->_tpl_vars['arr_role1'][$this->_sections['cont']['index']]; ?>
...
&conx=0&vopm=RO">
		...
		<td width="5%">
		<a href="../comun/z_modrol.php?vopc=1&valor=<?php echo $this->_tpl_vars['arr_role1'][$this->_sections['cont']['index']]; ?>
&n_conex=<?php echo $this->_tpl_vars['n_conex']; ?>
&conx=1">
		<img src="../imagenes/edit.png"  name="editar" title="Editar" align="left" border="0"></a>
		</td>
		<td width="5%">
		<input type="image" name="elimina" src="../imagenes/erase.png" title="Eliminar" value="<?php echo $this->_tpl_vars['arr_role1'][$this->_sections['cont']['index']]; ?>
">
