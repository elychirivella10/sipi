<?php /* Smarty version 2.6.8, created on 2021-05-10 11:38:06
         compiled from z_unidad.tpl */ ?>
<html>
<head>
   ...
   <td class="menudottedline" width="40%" ></td>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="toolbar">
	 <tr valign="left" align="left">
		<td>
			<a class="toolbar" href="../comun/z_ingdep.php?conx=1&na_conex=<?php echo $this->_tpl_vars['n_conex']; ?>
" >
		...
		<td>&nbsp;</td>
	   <td>
			<a class="toolbar" href="../comun/z_unidad.php?nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&salir=1&conx=0">
...
?>
      <tr class="row0">
	   <td>
		...
		<td>
		<input type='checkbox' id='chk' name='chk' value='<?php echo $this->_tpl_vars['arr_unid1'][$this->_sections['cont']['index']]; ?>
' /> 
		</td>
		<td>
		<a href='../comun/z_consunid.php?vunid=<?php echo $this->_tpl_vars['arr_unid1'][$this->_sections['cont']['index']]; ?>
&vmodal=2&vtip=0&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
&conx=0'>
		<?php echo $this->_tpl_vars['arr_unid1'][$this->_sections['cont']['index']]; ?>

		</a>
		</td>
		<td nowrap='nowrap'>
		<?php echo $this->_tpl_vars['arr_unid2'][$this->_sections['cont']['index']]; ?>
		...
		<td>
		<a href='../comun/z_modepto.php?vopc=1&valor=<?php echo $this->_tpl_vars['arr_unid1'][$this->_sections['cont']['index']]; ?>
...
'>
	   <input type='hidden' name='valor' value='<?php echo $this->_tpl_vars['arr_unid1'][$this->_sections['cont']['index']]; ?>
'>
		</td>
	   </tr>
   <?php endfor; endif; ?> 
