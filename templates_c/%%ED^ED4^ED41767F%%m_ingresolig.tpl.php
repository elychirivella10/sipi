<?php /* Smarty version 2.6.8, created on 2021-05-08 19:57:26
         compiled from m_ingresolig.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_ingresolig.tpl', 74, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas1" action="m_ingresolig.php?vopc=4" method="POST">
<?php endif; ?>
...
&nbsp;	 	     
<form name="formarcas2" enctype="multipart/form-data" action="m_ingresolig.php?vopc=2" method="POST" onsubmit='return pregunta();'>
...
' size="50" maxlength="100" onKeyUp="this.value=this.value.toUpperCase()" onchange="habil(document.formarcas2.tramitante,document.formarcas2.vpod1,document.formarcas2.vpod2,document.formarcas2.input1,document.formarcas2.vnomage)">
 ...
 cols="90" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['productosig']; ?>
    ...
    <tr>
      ...
      <td class="der-color">
         <textarea rows="2" name="zonag" <?php echo $this->_tpl_vars['modo']; ?>
 cols="90" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['zonag']; ?>
</textarea>
      </td>
    </tr> 
    </table>
...
&pder=I"></iframe> 
 ...
 cols="80" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['tratado']; ?>
</textarea>
      </td>
    </tr> 
    </table>
 ...
 cols="115" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['distingue']; ?>
</textarea>
      </td>
    </tr> 
    </table>
    ...
    <tr>
      <td class="der-color">
         <textarea rows="3" name="deszonag" <?php echo $this->_tpl_vars['modo']; ?>
 cols="115" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['deszonag']; ?>
</textarea>
      </td>
    </tr> 
    </table>
    ...
    <tr>
      <td class="der-color">
         <textarea rows="3" name="vinculo" <?php echo $this->_tpl_vars['modo']; ?>
 cols="115" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['vinculo']; ?>
</textarea>
      </td>
    </tr> 
    </table>
    ...
    <tr>
      <td class="der-color">
         <textarea rows="3" name="observa" <?php echo $this->_tpl_vars['modo']; ?>
 cols="115" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['observa']; ?>
</textarea>
      </td>
    </tr> 
    </table>
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <?php if ($this->_tpl_vars['vopc'] == 1): ?>
         <a href="m_ingresolig.php?vopc=3&nconex=<?php echo $this->_tpl_vars['n_conex']; ?>
