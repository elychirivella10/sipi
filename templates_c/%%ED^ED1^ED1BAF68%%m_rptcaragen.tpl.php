<?php /* Smarty version 2.6.8, created on 2020-11-11 14:37:31
         compiled from m_rptcaragen.tpl */ ?>
<html>
<head>
...
<form name="formarcas2" action="m_rptcaragen1.php" method="POST">
  <div align="center">
 <br>
  <table>
  <tr>
...
' size='9' onChange="valFecha(document.formarcas2.fechfon2)" >
    ...
    <tr>
      ...
      <td class="der-color">
        <?php echo $this->_tpl_vars['campo2']; ?>
 <input type="text" name="vagen1" align="right" size="6" maxlength="9"> 
        &nbsp;
	<?php echo $this->_tpl_vars['campo3']; ?>
 <input type="text" name="vagen2" align="right" size="6" maxlength="9">
      </td>
    </tr>
   <tr>
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptcaragen.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
