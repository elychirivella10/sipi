<?php /* Smarty version 2.6.8, created on 2021-04-28 14:26:27
         compiled from a_tablidio.tpl */ ?>
<html>
<head>
...
<form name="frmstatus1" action="a_tablidio.php?vopc=1" method="POST">
  ...
  <tr>
    <tr>
      ...
      <td class="der-color">
        <input type="text" name='estatus' size="2" maxlength="2" value='<?php echo $this->_tpl_vars['estatus']; ?>
...
<form name="frmstatus2" action="a_tablidio.php?vopc=2" method="POST" onsubmit='return pregunta();'>
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <?php if (( $this->_tpl_vars['vopc'] == 1 && $this->_tpl_vars['accion'] == 2 ) || $this->_tpl_vars['vopc'] == 4): ?>
        <a href="a_tablidio.php?vopc=4"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>
      <?php endif; ?>    
      <?php if (( $this->_tpl_vars['vopc'] == 1 && $this->_tpl_vars['accion'] == 1 ) || $this->_tpl_vars['vopc'] == 3): ?>
        <a href="a_tablidio.php?vopc=3"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>
      <?php endif; ?>    
    </td>      
    <td class="cnt">
