<?php /* Smarty version 2.6.8, created on 2020-11-05 13:52:54
         compiled from m_panelfon.tpl */ ?>
<html>
<head>
  ...
  <table class="adminlist">
   <tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="tcorreo" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['timpresora']; ?>
' size="7" STYLE="text-align:right">		
	...
	<tr>
		...
		<td>
			<input type="text" name="tcorreo" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['tcorreo']; ?>
' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		...
		<td>
			<input type="text" name="temail" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['temail']; ?>
' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		...
		<td>
			<input type="text" name="tcorreo" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['tsinenviar']; ?>
' size="7" STYLE="text-align:right">		
		</td>
	</tr>
	<tr>
		...
		<td>
			<input type="text" name="tcorreo" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['tcorreohoy']; ?>
' size="7" STYLE="text-align:right">		
		</td>
	</tr>
  </table>
