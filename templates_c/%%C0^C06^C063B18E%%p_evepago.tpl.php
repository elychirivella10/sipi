<?php /* Smarty version 2.6.8, created on 2021-07-28 11:28:01
         compiled from p_evepago.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_evepago.tpl', 40, false),array('modifier', 'date_format', 'p_evepago.tpl', 86, false),)), $this); ?>
<html>
<head>
...
<form name="forlotes" enctype="multipart/form-data" action="p_evepago.php?vopc=2"  method="POST" >
...
' readonly="readonly">
    ...
    <tr><td>    
    <iframe id='top22' style='width:960px;height:90px;background-color: WHITE;' src="p_verpagos.php?vcod=<?php echo $this->_tpl_vars['factura']; ?>
 ...
 onclick="buscarprensa(document.forlotes.vsol1,document.forlotes.vsol2,document.forlotes.vvienae1,document.forlotes.factura,document.forlotes.boletin,document.forlotes.cantidad)">
   ...
   <tr>
     <tr>
       ...
       <td class="cnt"><a href="p_ingfacbol.php?vopc=1"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
