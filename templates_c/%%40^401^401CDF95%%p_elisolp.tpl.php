<?php /* Smarty version 2.6.8, created on 2021-01-19 17:30:10
         compiled from p_elisolp.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'p_elisolp.tpl', 57, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas1" action="p_elisolp.php?vopc=1" method="post">
  <table>
...
<form name="formarcas3" action="p_elisolp.php?vopc=3" method="post" onsubmit='return pregunta1();'>
...
'>
  ...
  <table width="225">
    <tr>
      ...
      <td class="cnt"><a href="p_elisolp.php"><img src="../imagenes/cancel_f2.png" border="0"></a>  Cancelar  </td>
