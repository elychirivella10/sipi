<?php /* Smarty version 2.6.8, created on 2020-11-18 22:44:49
         compiled from m_ipoderes_sol.tpl */ ?>
<html>
  <head>
...
' <?php echo $this->_tpl_vars['vmodo2']; ?>
 ...
 class="boton_blue" name='submit' value=<?php echo $this->_tpl_vars['vaccion']; ?>
></td>
      </table>
    </form>				  
<!--    <form name="formarcas3" action="m_ipoderes_sol.php?vopc=5&vsol=<?php echo $this->_tpl_vars['vsol']; ?>
" method="post"> -->
...
'>
      <!-- Fecha y Facultad --> 
      <table width="80%">	
          <tr><td width="25%" class="izq-color"><?php echo $this->_tpl_vars['lfechapoder']; ?>
</td>
...
></td>
	  <td width="14%" class="izq-color"><?php echo $this->_tpl_vars['lfacultad']; ?>
</td>
...
'></iframe> 
      ...
      <!-- -->
      <?php if ($this->_tpl_vars['vopc'] == 1 && $this->_tpl_vars['vaccion'] == 'Incluir'): ?>   
...
'></iframe> 
 ...
 name="vpodee" 
      ...
      <tr><td class="izq2-color">
      <iframe id='center' style='width:100%;height:111px;background-color: WHITE;' 
              src='examplesolm.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
'></iframe>  
      </td></tr>  
      <!-- --> 
      </table>
      ...
      <tr><td class="izq2-color">
      <iframe id='center' style='width:100%;height:111px;background-color: WHITE;' 
              src='examplesolp.php?psol=<?php echo $this->_tpl_vars['vsol']; ?>
'></iframe>  
      </td></tr>  
      <!-- --> 
      </table>
      &nbsp;
      <table width="80%" cellspacing="1" border="1">	
          <tr><td width="25%" class="izq-color">Observación:</td>
	         <td width="75%" class="der-color"><input size="100" type="text" maxlength='512' name="vobs" value='<?php echo $this->_tpl_vars['vobs']; ?>
...
></td>
      ...
      <table width="225">
        ...
        <?php endif; ?>
        <?php if ($this->_tpl_vars['vopc'] == 1 && $this->_tpl_vars['vaccion'] == 'Buscar'): ?>  
        ...
        <td class="cnt"><a href="m_ipoderes_sol.php?vopc=<?php echo $this->_tpl_vars['vopc']; ?>
