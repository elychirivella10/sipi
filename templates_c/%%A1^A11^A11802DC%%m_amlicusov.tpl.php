<?php /* Smarty version 2.6.8, created on 2021-08-04 14:13:22
         compiled from m_amlicusov.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'm_amlicusov.tpl', 47, false),array('function', 'html_options', 'm_amlicusov.tpl', 75, false),)), $this); ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
    <form name="formarcas1" action="m_amlicusov.php?vopc=1" method="post">
      <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,6,document.formarcas1.submit)" onchange="Rellena(document.formarcas1.vsol2,6)">
    ...
    <form name="formarcas2" action="m_amlicusov.php?vopc=2" method="post">
...
></td></tr>
     ...
     <form name="formarcas3" action="m_amlicusov.php?vopc=3" method="post" onsubmit='return pregunta();'>
...
"><input type="image" src="../imagenes/boton_cronologia_azul.png"></a></td>
       ...
       <td class="cnt"><a href="m_amlicusov.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
