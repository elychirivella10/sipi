<?php /* Smarty version 2.6.8, created on 2020-11-02 09:01:15
         compiled from m_reingres.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_reingres.tpl', 77, false),array('modifier', 'truncate', 'm_reingres.tpl', 120, false),)), $this); ?>
<html>
<head>
...
>
  <input type='hidden' name='clase_id' value='<?php echo $this->_tpl_vars['clase_id']; ?>
'>
...
' size="1" maxlength="2" >
    ...
    <tr>
      ...
      <td class="der-color" >
	     <textarea rows="6" name="distingue" <?php echo $this->_tpl_vars['modo']; ?>
 cols="57" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['distingue']; ?>
</textarea>
      </td>
 ...
 onchange="habilitar(document.formarcas2.modalidad,document.formarcas2.nombre,document.formarcas2.etiqueta,document.formarcas2.vviena,document.formarcas2.vvienai,document.formarcas2.vvienae,document.formarcas2.ubicacion)">
    ...
    <tr>
      ...
      <td class="der-color" colspan="2">
	     <textarea rows="3" name="etiqueta" <?php echo $this->_tpl_vars['modo']; ?>
 cols="96" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['etiqueta']; ?>
</textarea>
	   </td>
...
&pder=M"></iframe> 
 ...
 onclick="browsetitularp(document.formarcas2.vsol1,document.formarcas2.vsol2,document.formarcas2.vtitut,document.formarcas2.vtitue)">
        <input type="button" class="boton_blue" value="Corregir" name="vtituc" <?php echo $this->_tpl_vars['modo2']; ?>
