<?php /* Smarty version 2.6.8, created on 2020-10-22 09:07:07
         compiled from p_rptpubpat.tpl */ ?>
<html>
<head>
...
.focus()">
<br><br>
<form name="formarcas2" action="p_rptpubpat1.php" method="POST">
  <div align="center">
...
' size='9' onChange="valFecha(document.formarcas2.hastac)">
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_rptpubpat.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
