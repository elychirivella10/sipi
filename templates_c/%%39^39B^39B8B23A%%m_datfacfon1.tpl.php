<?php /* Smarty version 2.6.8, created on 2020-11-05 12:51:40
         compiled from m_datfacfon1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_datfacfon1.tpl', 56, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas2" enctype="multipart/form-data" action="m_ingfonetica1.php?vopc=5" method="POST" onsubmit='return pregunta();'>
...
' size="11" maxlength="11" align="right" onkeyup="checkLength(event,this,10,document.formarcas2.montodep)" onchange="valFecha(this,document.formarcas2.montodep);" class="required">
    ...
    <tr>
      ...
      <td class="der-color">
        <select tabindex="4" size="1" name="prioridad" class="required"> 
...
' size="70" maxlength="80" onkeyup="checkLength(event,this,80,document.formarcas2.passwd)" onchange="isEmail2(document.formarcas2.email.value,this.form);valenvio(this.form);">
  ...
  <table width="255" >
  <tr>
    <td class="cnt"><input tabindex="11" name="Continuar" type="image" src="../imagenes/boton_continuar_azul.png" value="Continuar"></td> 
    <td class="cnt">
      <?php if ($this->_tpl_vars['vopc'] == 1 || $this->_tpl_vars['vopc'] == 4): ?>
         <a href="m_ingfacfon1.php?vopc=1"><img tabindex="12" src="../imagenes/boton_cancelar_rojo.png" border="0"></a>   
      <?php endif; ?>    
