<?php /* Smarty version 2.6.8, created on 2021-02-17 11:47:23
         compiled from p_modregis.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_modregis.tpl', 90, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas1" action="p_modregis.php?vopc=1" method="post">
...
<form name="formarcas2" enctype="multipart/form-data" action="p_modregis.php?vopc=2" method="POST" onsubmit='return pregunta();'>
  <input type='hidden' name='usuario' value=<?php echo $this->_tpl_vars['usuario']; ?>
>
...
' id="picture" width="270" height="272" alt="vista previa"/></br>
 ...
 cols="57" onchange="this.value=this.value.toUpperCase()"><?php echo $this->_tpl_vars['resumen']; ?>
</textarea>
      </td>
    </tr> 
    <tr>
...
"></iframe> 
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <a href="p_modregis.php?vopc=4"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>  
    </td>      
