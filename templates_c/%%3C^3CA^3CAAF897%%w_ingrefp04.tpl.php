<?php /* Smarty version 2.6.8, created on 2022-05-02 09:13:34
         compiled from w_ingrefp04.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'w_ingrefp04.tpl', 26, false),)), $this); ?>
<html>
<head>
...
-->
<form name="wingresol" id="w_grabar" action="w_ingredomp.php?vopc=6" method="post">
  ...
  <tr><td WIDTH=30% class='izq-color'><b>Nro. REFERENCIA:</b>
      ...
      <?php echo $this->_tpl_vars['vnumref']; ?>
</br>
  </font></br></td></tr>
  <tr><td WIDTH=30% class='izq-color'><b>Nro. Registro:</b>
      </td><td><font face='Arial' size='4'>
      <?php echo $this->_tpl_vars['vnregsipi']; ?>

  </font></br></td></tr>

  <tr><td WIDTH=30% class='izq-color'><b>Titulo:</b>
      </td><td></br><font face='Arial' size='4'>
      <?php echo $this->_tpl_vars['vnmarsipi']; ?>
</br>
...
<!--  <tr><td WIDTH=30% class='izq-color'><b>Clase Internacional:</b>
      ...
      <?php echo $this->_tpl_vars['vnclasint']; ?>
 -->
      <!-- <input type='text' size='2' name='$vnclasint' maxlength='2' value='<?php echo $this->_tpl_vars['vnclasint']; ?>
' onkeyup="checkLength(event,this,2,document.wingresol.vnclasnac);" onKeyPress="return acceptChar(event,2, this)"></br> -->
  </font></br></td></tr>
  <tr><td WIDTH=30% class='izq-color'><b>Cambio a Domicilio:</b>
      </td><td><font face='Arial' size='3'>
      <?php echo $this->_tpl_vars['vnclasnac']; ?>

      <!-- <input type='text' size='2' name='$vnclasnac' maxlength='2' value='<?php echo $this->_tpl_vars['vnclasnac']; ?>
' onkeyup="checkLength(event,this,2,document.wingresol.vpod1);" onKeyPress="return acceptChar(event,2, this)"></br> -->
  </font></br></td></tr>
  <?php if ($this->_tpl_vars['vpedirpoder'] == 'S'): ?>
    <tr><td WIDTH=30% class='izq-color'><b>N&uacute;mero de Poder:</b>
       </td><td><input type='text' size='3' name='vpod1' maxlength='4' value='<?php echo $this->_tpl_vars['vpod1']; ?>
' onkeyup="checkLength(event,this,4,document.wingresol.vpod2);" onKeyPress="return acceptChar(event,2, this)">-<input type='text' size='3' name='vpod2' maxlength='4' value='<?php echo $this->_tpl_vars['vpod2']; ?>
' onKeyPress="return acceptChar(event,2, this)" onkeyup="checkLength(event,this,4,document.wingresol.vfact);"><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000-0000 (año-n&uacute;mero)</font>
    </td></tr>
  <?php endif; ?>
  <tr><td class='izq-color'><b>N&uacute;mero de DOCUMENTO:</b>
     </td><td><input type='text' size='10' name='vdoc' maxlength='10' value='<?php echo $this->_tpl_vars['vdoc']; ?>
' onKeyPress="return acceptChar(event,2, this)"><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000000000 (n&uacute;mero)</font>
  ...
  <tr><td class='izq-color'><b>Fecha de Presentaci&oacute;n:</b>
        ...
        <!-- 
        <input type='text' name='fecha_reno' value='<?php echo $this->_tpl_vars['fecha_reno']; ?>
' size='10' onChange="valFecha(document.wingresol.fecha_reno)" onkeyup="checkLength(event,this,10,document.wingresol.vcarp)">
         &nbsp;&nbsp;
...
' onKeyPress="return acceptChar(event,2, this)"><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000000000 (n&uacute;mero)</font>
  ...
  <tr><td class='izq-color'><b>N&uacute;mero de FACTURA Pago de Tasa:</b>
     </td><td>F<input type='text' size='6' name='vfact' maxlength='7' value='<?php echo $this->_tpl_vars['vfact']; ?>
' onKeyPress="return acceptChar(event,2, this)" onchange='for(var x=this.value.length;x<7;x++) this.value=0+this.value;'><font face='Arial' color='#800000' size='3' valign='up'>*</font><font face='Arial' color='#000000' size='1'>Formato: 0000000 (n&uacute;mero)</font>
  ...
  <tr><td class='izq-color'><b>Comentario Adicional de ser Necesario:</b>
     </td><td><input type='text' size='73' name='vcomadi' maxlength='100' value='<?php echo $this->_tpl_vars['vcomadi']; ?>
'>
  </td></tr>
...
" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('salir','','../imagenes/salir_f2.png',1);">
    ...
    <tr align="center"><td width="50%" align="center">Ingresar Cambio Domicilio p</td><td width="50%" align="center">Salir</td>
    </tr>
</table>
&nbsp;
&nbsp;&nbsp;
