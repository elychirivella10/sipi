<?php /* Smarty version 2.6.8, created on 2020-11-10 11:52:51
         compiled from m_rptbusdia.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_rptbusdia.tpl', 54, false),array('modifier', 'truncate', 'm_rptbusdia.tpl', 75, false),)), $this); ?>
<html>
<head>
...
<form name="formarcas2" action="m_rptbusdia1.php" method="POST">
  <div align="center">
 <br>
  <table>
  <tr>
...
' size="10" align="right" onkeyup="checkLength(event,this,10,document.formarcas2.recibo)" onchange="valFecha(this,document.formarcas2.recibo)" >
         &nbsp;&nbsp;
    ...
    <tr>
      ...
      <td class="der-color">
        <input type="text" name="recibo" size="7" maxlength="8" onkeyup="checkLength(event,this,8,document.formarcas2.tipobus)">
      </td>
    </tr>
    <tr>
      <td class="izq-color" ><?php echo $this->_tpl_vars['campo7']; ?>
</td>
      <td class="der-color" ><select size='1' name='tipobus'>
                             <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['arraybusq'],'selected' => $this->_tpl_vars['tipobus'],'output' => $this->_tpl_vars['arraydesbusq']), $this);?>
  ...
  <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_rptbusdia.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
