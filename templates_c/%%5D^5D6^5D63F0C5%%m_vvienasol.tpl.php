<?php /* Smarty version 2.6.8, created on 2020-10-21 11:51:09
         compiled from m_vvienasol.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'm_vvienasol.tpl', 31, false),array('function', 'html_options', 'm_vvienasol.tpl', 130, false),)), $this); ?>
<html>
<head>
...
&nbsp;     
<form name="formarcas3" action="m_vvienasol.php?vopc=5&vsol=<?php echo $this->_tpl_vars['vsol']; ?>
...
"></iframe> 
 ...
 size="20" onkeyup="this.value=this.value.toUpperCase()">
        <input type="button" value="Buscar/Incluir"  name="vvienai" <?php echo $this->_tpl_vars['modo3']; ?>
 onclick="gestionvienap(document.formarcas3.vsol1,document.formarcas3.vsol2,document.formarcas3.vviena,document.formarcas3.vvienai)">
        <input type="button" value="Buscar/Eliminar" name="vvienae" <?php echo $this->_tpl_vars['modo3']; ?>
