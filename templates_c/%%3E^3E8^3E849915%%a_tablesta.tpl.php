<?php /* Smarty version 2.6.8, created on 2022-08-25 14:03:55
         compiled from a_tablesta.tpl */ ?>
<html>
<head>
...
<form name="frmstatus1" action="a_tablesta.php?vopc=1" method="POST">
...
<form name="frmstatus2" action="a_tablesta.php?vopc=2" method="POST" onsubmit='return pregunta();'>
...
' <?php echo $this->_tpl_vars['modo']; ?>
 size="50" maxlength="50" 
               onKeyPress="return acceptChar(event,5, this)" 
 ...
 src="../imagenes/boton_guardar_rojo.png" value="Guardar"></td> 
    <td class="cnt">
      <?php if (( $this->_tpl_vars['vopc'] == 1 && $this->_tpl_vars['accion'] == 2 ) || $this->_tpl_vars['vopc'] == 4): ?>
        <a href="a_tablesta.php?vopc=4"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>
      <?php endif; ?>    
      <?php if (( $this->_tpl_vars['vopc'] == 1 && $this->_tpl_vars['accion'] == 1 ) || $this->_tpl_vars['vopc'] == 3): ?>
        <a href="a_tablesta.php?vopc=3"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a>
      <?php endif; ?>    
    </td>      
    <td class="cnt">
