<?php /* Smarty version 2.6.8, created on 2020-10-19 15:53:14
         compiled from p_rptpavzcri.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_rptpavzcri.tpl', 73, false),)), $this); ?>
<html>
<head>
...
' size='9' onChange="valFecha(document.foravzcri.fecpubh)">
    ...
    <tr>
      ...
      <td class="der-color">
        ...
        <input type="text" name="fecvend" value='<?php echo $this->_tpl_vars['fecvend']; ?>
' size='9' onChange="valFecha(document.foravzcri.fecvend)" onBlur="valagente(document.foravzcri.fecvend,document.foravzcri.fecvenh)"> 
        ...
        <input type="text" name="fecvenh" value='<?php echo $this->_tpl_vars['fecvenh']; ?>
