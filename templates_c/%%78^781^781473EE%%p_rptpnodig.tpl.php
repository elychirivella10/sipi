<?php /* Smarty version 2.6.8, created on 2021-01-06 10:18:52
         compiled from p_rptpnodig.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'p_rptpnodig.tpl', 36, false),)), $this); ?>
<html>
<head>
...
<form name="foravztra" action="p_rptnodig.php?vopc=2" method="POST">
  <div align="center">
  <br><br>
  <table>
  <tr>
 ...
 <input type="text" name="vreg1h" size="1" maxlength="1" onKeyPress="return acceptChar(event,6, this)" onkeyup="checkLength(event,this,1,document.foravztra.vreg2h)" onChange="this.value=this.value.toUpperCase()">-
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="p_rptpnodig.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
