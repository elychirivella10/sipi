<?php /* Smarty version 2.6.8, created on 2022-09-06 12:12:50
         compiled from m_actelev2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'm_actelev2.tpl', 37, false),)), $this); ?>
<html>
<head>
...
' size='1'>&nbsp;&nbsp;
        ...
        <select size="1" name="ind_claseni">
          <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['arrayvclase'],'selected' => $this->_tpl_vars['ind_claseni'],'output' => $this->_tpl_vars['arraytclase']), $this);?>
...
' size="10" maxlength="10" align="left" onKeyPress="return acceptChar(event,2,this)">
     ...
     <tr>
      ...
      <td class="der-color">
        <textarea onkeyUp="max(this,750)" onkeyPress="max(this,750)" onChange="Vacio(document.fordatev.comentario)" cols='72' rows='4' name='comentario' value='<?php echo $this->_tpl_vars['comentario']; ?>
