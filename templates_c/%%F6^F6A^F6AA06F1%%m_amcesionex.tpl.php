<?php /* Smarty version 2.6.8, created on 2020-11-12 14:14:18
         compiled from m_amcesionex.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'm_amcesionex.tpl', 56, false),array('function', 'html_radios', 'm_amcesionex.tpl', 84, false),array('function', 'html_options', 'm_amcesionex.tpl', 108, false),)), $this); ?>
<html>
  <head>
...
.focus()">
  ...
  <div align="center">
  <form name="formarcas1" action="m_amcesionex.php?vopc=1" method="post">
     <table>
...
' <?php echo $this->_tpl_vars['vmodo']; ?>
 onKeyPress="return acceptChar(event,2, this)" 
  ...
  <form name="formarcas2" action="m_amcesionex.php?vopc=2" method="post">
...
'></iframe> 
     ...
     <form name="formarcas3" action="m_amcesionex.php?vopc=3" method="post" onsubmit='return pregunta();'>
...
"><input type="image" src="../imagenes/folder_f2.png"></a>Cronologia</td> -->
     ...
     <td class="cnt"><a href="m_amcesionex.php"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
