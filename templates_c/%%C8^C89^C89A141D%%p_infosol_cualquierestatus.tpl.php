<?php /* Smarty version 2.6.8, created on 2020-10-28 21:44:20
         compiled from p_infosol_cualquierestatus.tpl */ ?>
<html>
<head>
...
<?php if ($this->_tpl_vars['vopc'] == 3): ?>
  <form name="forminfor" action="p_ingsol55.php?vopc=3" method="post">
<?php endif;  if ($this->_tpl_vars['vopc'] == 4): ?>
  <form name="forminfor" action="p_manlpi55_cualquierestatus.php?vopc=4" method="post">
<?php endif; ?>
