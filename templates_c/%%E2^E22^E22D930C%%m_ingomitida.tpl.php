<?php /* Smarty version 2.6.8, created on 2021-04-23 16:09:40
         compiled from m_ingomitida.tpl */ ?>
<html>
<head>
...
.focus()">
 ...
 <form name="formarcas2" action="m_ingomitida.php?vopc=2" method="post">
 <div align="center">
 <br>
...
' size="10" align="right" onkeyup="checkLength(event,this,10,document.formarcas2.buscar)" onchange="valFecha(this,document.formarcas2.buscar)" >
   ...
   <table width="210">
    <tr>
      ...
      <td class="cnt"><a href="m_ingomitida.php?vopc=1"><img src="../imagenes/boton_cancelar_rojo.png" border="0"></a></td>
