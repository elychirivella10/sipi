<?php /* Smarty version 2.6.8, created on 2020-11-05 12:51:35
         compiled from m_ingfacfon1.tpl */ ?>
<html>
<head>
...
' size="6" maxlength="6" onfocus="document.formarcas2.clave.value=''" onkeypress="document.formarcas2.clave.value='';" onkeyup="number_sindec(this);checkLength(event,this,8,document.formarcas2.continuar);">
      </td>
    </tr>
  <tr>
  </table>
 ...
 <legend align='center'><strong><span>&nbsp;EN CASO DE SER EXONERADO&nbsp;</span></strong></legend>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="der-color">
         <input type="password" name="clave" <?php echo $this->_tpl_vars['modo']; ?>
 value='<?php echo $this->_tpl_vars['clave']; ?>
' size="10" maxlength="8" onkeypress="document.formarcas2.factura.value='';" onkeyup="checkLength(event,this,8,document.formarcas2.continuar);">
      </td>
    </tr>
  <tr>
  </table>
...
<br>
  ...
  <table width="230">
  <tr>
    <td class="cnt"><input type="image" <?php echo $this->_tpl_vars['modo2']; ?>
 src="../imagenes/boton_continuar_azul.png" value="Continuar"></td> 
    <td class="cnt">
