...
<td valign="top" bgcolor="#fffff8">
   ...
   <p align="left"><font face="Tahoma" size="2"><b>B&uacute;squeda por Nombre de Inventor </b></font></p>
   <table border="1" width="95%" height="89">
    <tr>
      <td width="100%" height="19" class="celda1">
       Coloque el nombre del Inventor que desea buscar: 
      </td>
    </tr>
	 <tr>
    <td width="100%" height="16" class="celda2"><p>
	    <form method="POST" action="lis_inventor.php">
	 	 <p style="line-height: 100%"> 
	       ...
	       <input type="text" name="inventor" onKeyPress="javascript:this.value=this.value.toUpperCase();">
