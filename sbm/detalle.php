...
<td valign="top" bgcolor="#add8e6">
     ...
     <td width="100%"></td>
      ...
      <tr>
        <td width="90%"><b><font face="Tahoma" size="2">Tipo de Patente: </font></b>
          <font face="Tahoma" size="2"><?= $registro['tipo_paten']." - ".$vtip ?></font></td>
        <td width="100%"></td>
      </tr>
      <tr>
        <td width="90%"><b>
   ...
   <?
      ...
      echo "<p align='center'><a href='http://consulta.sapi.gob.ve/patente/venezuela/$solpdf.pdf' target='_blank' ><b>Ver Documento PDF</b></a>"; 
		echo " </td>";
      echo "  <td>";
 		echo "<p align='center'><a href='http://consulta.sapi.gob.ve/patente/venezuela/FICHAS/$solpdf.pdf' target='_blank' ><b>Ver Ficha</b></a>";
		echo " </td>";
      echo "  <td>";
   ...
   <table border="1" width="100%" height="39">
    ...
    <tr>
       <td width="100%" height="11">
         <b><font class="columna4"><?= utf8_decode($registro['resumen']) ?></b> 
       </td>
    </td>
    </tr>
   </table>
...
?>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="1" class="celda2">
  <tr> 
    <td width="100%" bgcolor="#FFFFFF"> 
     <div align="center">
      <font class="celda2" size="-2"><I>Desarrollado por: <b>Ing. R&oacute;mulo Mendoza, Ing. Karina P&eacute;rez y T.S.U. Nelson Gonz&aacute;lez - Coordinaci&oacute;n de Inform&aacute;tica - SAPI Rif: G-20008399-9<br/>
