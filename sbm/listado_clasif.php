...
//(listado_clasif.php por Numero de Clasificacion Internacional de las patentes)
...
$criterio="Criterio: Clasificaci&oacute;n= ".$valor1; 
...
//$resultado=pg_exec("SELECT stppatee.solicitud, stppatee.nombre, stpclsfd.clasificacion FROM stppatee, stpclsfd WHERE stpclsfd.clasificacion like '$valor1'AND 
//				stpclsfd.solicitud = stppatee.solicitud AND stppatee.registro!='' OFFSET $inicio LIMIT $cuanto ");
...
<form method="POST" action="listado_clasif.php">
