...
?>
    ...
    <td valign="top" bgcolor="#F9F9F9">
     <p style="line-height: 100%"><font face="Tahoma" size="2">
       <b><font face="Tahoma" size="2" color="#FFFFFF"><A href="inicio.php"><u>NUEVA CONSULTA </u></A></font></b></p>   <p         <b><font color="#CC0000"><?php echo " $criterio "; ?></b></font></p> 
       </font>
...
<table border="0" width="100%" class="celda1">
  ...
  <tr>
    <td width="10%" class='celda3' ><b>Documento</b></td>
    <td width="90%" class='celda3' ><b>T&iacute;tulo</b></td>
  </tr>

  <?php   
     for($cont=0;$cont<$filas_resultado;$cont++) { 
       $sol=$registro['solicitud'];
       echo "<td width='10%' class='celda2'><b>";
       echo "<a href='a_rptcronol.php?num_sol=$sol'>$sol</a>&nbsp;</td>";
       //echo "&nbsp;</td>";
       echo "<td width='90%' class='celda2'><b>";
