...
<td valign="top" bgcolor="#fffff8">
	...
	<p align="left"><font face="Tahoma" size="2"><b>B&uacute;squeda por Fecha de Publicaci&oacute;n </b></font></p>
   ...
   <table border="1" width="95%" height="89">
    ...
    <td width="100%" height="16" class="celda2"><p>
		<form method="POST" action="lis_fecha.php">
		     ...
		     <input type="reset" value="Restablecer" name="B2" class="boton_blue">
		</form>
     </td>
     </tr>
    </table>
