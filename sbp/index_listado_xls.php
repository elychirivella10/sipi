   ...
   switch($modoconsulta)
   {
     case 1: //BÚSQUEDA_NOMBRE_PALABRAS_EXACTAS:
         $resultado=pg_exec("SELECT DISTINCT ON (stzderec.solicitud) stzderec.solicitud,stzderec.registro,stzderec.fecha_solic,stzderec.nombre,stzderec.tipo_derecho,
                             stzderec.estatus,stzderec.tramitante,stzsolic.nombre as ntitular,stzottid.domicilio,stzottid.nacionalidad,stzderec.nro_derecho                        
...
echo "</tr>";
  ...
  for($cont=0;$cont<$filas_resultado;$cont++) {
    ...
    $v9 = $regbol['documento']; 
    $v10 = trim($registro['ntitular']).", Domicilio: ".trim($registro['domicilio']).", Nacionalidad: ".$registro['nacionalidad']; 
