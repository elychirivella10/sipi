  ...
  <tr> 
     <td width="100%" valign="top">
      <font color="#666666" size="2" face="Verdana, Arial, Helvetica, sans-serif">
        <img src="../imagenes/cintillosapi_mcn.png" width="100%" height="80">        
      </font>
    </td>
  </tr>
</table>
...
<!--      <tr>
      ...
      <tr>
        <td width="28%"><b>
          ...
          <font face="Tahoma" size="2"><? echo $registro['fecha_publi']; ?></font>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        <td width="28%"><b>
          <font face="Tahoma" size="2">Fecha de Registro: </font></b>
          <font face="Tahoma" size="2"><? echo $registro['fecha_regis']; ?></font>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
        <td width="72%"></td>
      </tr>
 ...
 //     echo "<p align='center'><a href='http://documentos.sapi.gob.ve/patente/venezuela/$solpdf.pdf' target='_blank' ><b>Ver Documento PDF</b></a>";
      echo "<p align='center'><a href='http://172.16.0.130/patentes/documentos/$solpdf.pdf' target='_blank' ><b>Ver Documento PDF</b></a>";  
           echo " </td>";
      echo "  <td>";
...
// 	echo "<p align='center'><a href='http://documentos.sapi.gob.ve/patente/venezuela/FICHAS/$solpdf.pdf' target='_blank' ><b>Ver Ficha</b></a>";
      echo "<p align='center'><a href='http://172.16.0.130/patentes/fichas/$solpdf.pdf' target='_blank' ><b>Ver Ficha</b></a>";
		echo " </td>";
      echo "  <td>";
...
<br/>
 <table border="0" cellpadding="0" cellspacing="0" width="960" height="135" align="center" bgcolor="#FFFFFF">
 <tr >
   <td class="pie1" width="315">
