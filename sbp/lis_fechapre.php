...
$criterio="Criterio: Fecha de Presentaci&oacute;n= ".$valor1; 
...
//$resultado=pg_exec("SELECT * FROM stppatee WHERE fecha_solic='$valor1' and registro!='' OFFSET $inicio LIMIT $cuanto ");

$resultado=pg_exec("SELECT solicitud, nombre
                        FROM stzderec 
                        WHERE tipo_mp='P' 
		        AND fecha_solic = '$valor1' OFFSET $inicio LIMIT $cuanto  ");
$cantidad=pg_exec("SELECT solicitud, nombre
                        FROM stzderec 
                        WHERE tipo_mp='P' 
		        AND fecha_solic = '$valor1'");       
