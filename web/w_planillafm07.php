...
$smarty->assign('subtitulo','Ingreso de Licencia de Uso de Marcas al SIPI');
...
where a.nro_tramite='$vtramt' and a.nro_referencia='$vsol' and a.nro_tramite=b.nro_tramite order by a.nro_tramite,a.nro_referencia");
   ...
   //}
   if ($vcansol<1) {
     mensajenew('AVISO: Nro. de Tramite No Registrado!, Verifique ...!!!','../web/w_ingrelicm.php?vopc=3','N');
     $smarty->display('pie_pag.tpl'); exit(); 
   }
...
$smarty->display('w_ingrefm07.tpl');
