...
if ($tper<>4 or ($tper==4 and $vrad<>'')) {
   ...
   if ($filas_found>0) {
      ...
      $obj_query = pg_exec("update stzsystem set nro_titular=nextval('stzsystem_nro_titular_seq')");
      $obj_query = pg_exec("select last_value from stzsystem_nro_titular_seq");
...
//   echo "<p align='center'><b>Tra:$vtra Sol:$vsol Per:$tper MP:$vtmp Tex:$vtex Rad:$vrad</b></p>";
   ...
   echo "</tr>";
   echo "<form name='formti' action='adm_titulares.php?vtra=$vtra&vsol=$vsol&tper=$tper&vnom=$vnom&vtmp=$vtmp' method='POST'>";
...
//      echo "<p align='center'><font color='#0000FF'>";
   ...
   echo "</form>";
   echo "<form method='POST' action='adm_titulares.php?vtra=$vtra&vsol=$vsol&tper=$tper&vnom=$vnom&vtmp=$vtmp'>"; 
?>
