...
FCKConfig.ToolbarSets["Basic_old"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','NewPage'] 
] ; 
...
['Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','Find','Replace','Rule','SpecialChar'],
...
FCKConfig.ToolbarSets["Basic_old_old"] = [

['NewPage','Cut','Copy','Paste','PasteText','PasteWord','SelectAll'],

['Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','Find','Replace','Rule','SpecialChar','TextColor'],
