...
$tablas   = "stmtmpre";
 ...
 if ($vopc==1) {
   ...
   $resultado=pg_exec("INSERT INTO $tablas SELECT stzderec.solicitud,stzderec.registro,stzderec.nombre,stmmarce.clase,stmmarce.ind_claseni,stzevtrd.evento, stzevtrd.fecha_event,stzevtrd.documento,stzevtrd.comentario,stzevtrd.usuario,stzevtrd.fecha_trans,'$fechahoy' FROM stzevtrd,stzderec,stmmarce,stztmpbor WHERE (stztmpbor.estatus=1564 AND stztmpbor.nro_derecho=stzderec.nro_derecho AND stztmpbor.documento=stzevtrd.documento AND stmmarce.nro_derecho = stzderec.nro_derecho AND stztmpbor.nro_derecho=stzevtrd.nro_derecho AND stzevtrd.evento=1502)");
 }

 //$resultado=pg_exec("INSERT INTO $tablas SELECT stzderec.solicitud,stzderec.registro,stzderec.nombre,stmmarce.clase,stmmarce.ind_claseni,stmmarce.evento, stmmarce.fecha_event,stzevtrd.documento,stzevtrd.comentario FROM stzderec, stmevtrd,stmmarce WHERE (stzevtrd.evento=1502 and stzevtrd.nro_derecho=stzderec.nro_derecho and stmmarce.nro_derecho = stzderec.nro_derecho  and stztmpbor.estatus=1564 and stztmpbor.nro_derecho=stzderec.nro_derecho)");
 //$condicion = " stmtmpre.usuario='rmendoza'";
...
if ($vopc==2) {
   ...
   echo "<tr>";
   echo "<form name='formab' method='POST' action='z_browreg.php?vopc=3&vtp=1'>";
