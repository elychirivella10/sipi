...
//Carga el tipo de clase de la marca para mostrarlo en el combo
...
//Carga el tipo de marca para mostrarlo en el combo
 ...
 $arraytipo[8]='MARCA DE CERTIFICACION';

//Orden 
 $arrayorden[0]='';
 $arrayorden[1]='solicitud';
 $arrayorden[2]='registro';
 $arrayorden[3]='fecha_regis,registro';
...
$smarty->assign('arrayopelog',$arrayopelog);
$smarty->assign('opelog','=');
...
$smarty->display('m_rptpavzcri.tpl');
