...
$smarty->display('encabezado1.tpl');
   ...
   if ($vopc==1 || $vopc==2) {
      ...
      if (!$resultado) {
         $sql->disconnect(); 
         mensajenew('ERROR: PROBLEMA AL PROCESAR LA BUSQUEDA ...!!!','m_amcesion_original.php','N');
	      $smarty->display('pie_pag.tpl'); exit(); 
      }	 
      $filas_found=pg_numrows($resultado); 
      if ($filas_found==0) {
         $sql->disconnect();
         mensajenew('ERROR: NO EXISTEN DATOS ASOCIADOS ...!!!','m_amcesion_original.php','N');
	      $smarty->display('pie_pag.tpl'); exit(); 
      }	 
      ...
      if ($vreg!='') { //Esta bien 
         ...
         $sql->disconnect(); 
         mensajenew('ERROR: Solo aplica a MARCAS con REGISTRO ASIGNADO ...!!!','m_amcesion_original.php','N');
	      $smarty->display('pie_pag.tpl'); exit(); 
      }
   ...
   if ($vopc==3) {
      ...
      if ($vsolh=='-' || $vregh=='' || $vcomenta=='' || $vdoc=='' || $vfevh=='' || $vtipo=='') {
         $sql->disconnect();
         mensajenew('ERROR: PROBLEMA AL INTENTAR GRABAR - DATOS INCORRECTOS O VACIOS...','m_amcesion_original.php','N');
	      $smarty->display('pie_pag.tpl'); exit(); 
	 }
      ...
      if ($numtmp==0) {
         $sql->disconnect();
         mensajenew('ERROR: No existe(n) Titular(es) Final(es). Transaccion Abortada...','m_amcesion_original.php','N');
	      $smarty->display('pie_pag.tpl'); exit(); 
      }
      ...
      if ($cantfil>0) {
         $sql->disconnect();
         $smarty->display('encabezado1.tpl');
         mensajenew('ERROR - El Evento ya fue Cargado','m_amcesion_original.php','N');
         $smarty->display('pie_pag.tpl'); exit(); 
      }
      ...
      {  $temptit=$regco[titular];
         ...
         if ($tempdom=='' or $tempnac=='') {
            $sql->disconnect();
            $smarty->display('encabezado1.tpl');
            mensajenew('ERROR - Falto ingresar Nacionalidad o Domicilio del Titular Final...','m_amcesion_original.php','N');
            $smarty->display('pie_pag.tpl'); exit(); 
         }
      ...
      if ($cant_error==0) {
           ...
           mensajenew('DATOS GUARDADOS CORRECTAMENTE!!!','m_amcesion_original.php','S');
           $smarty->display('pie_pag.tpl'); exit();   
      } else {
           pg_exec("ROLLBACK WORK"); $sql->disconnect();
           mensajenew("Falla de Ingreso en la B.D. Transacciones Abortadas...!!!","m_amcesion_original.php","N");
           $smarty->display('pie_pag.tpl'); exit();   } 
   }
   ...
   $smarty->display('m_amcesion_original.tpl'); 
