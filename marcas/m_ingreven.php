...
if ($vopc==1) {
   ...
   if (empty($vsol1) && empty($vsol2)) {
      mensajenew("ERROR: No introdujo ning&uacute;n valor de Expediente ...!!!","m_eveind.php","N");
...
if (!$resultado) { 
     mensajenew("ERROR: Nro. de Expediente ingresado NO existe en la Base de Datos ...!!!","m_eveind.php","N");
     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
   }
$filas_found=pg_numrows($resultado); 
if ($filas_found==0) {
     mensajenew("ERROR: No existen Datos asociados al Expediente en Maestra de Marcas ...!!!","m_eveind.php","N");
     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
   } 
