...
$pdf->AliasNbPages();
$pdf->SetFont('Arial','',9);
$pdf->Image('../imagenes/certmarcas4.jpg',3,0,205,330,'JPEG');
  ...
  for($cont=0;$cont<$filas_found;$cont++)   { 
    ...
    $pdf->Setxy(70,71); $pdf->Cell(20,4,$reg['registro'],0,1); 
    $pdf->Setxy(70,75); $pdf->Cell(20,4,$reg['fecha_regis'],0,1);
    $pdf->Setxy(70,79); $pdf->Cell(75,4,$reg['fecha_venc'],0,0);
    $pdf->Setxy(148,71); $pdf->Cell(64,4,$vtip,0,0);
    $pdf->Setxy(128,79); $pdf->Cell(40,4,$vclas,0,1);
    $pdf->Setxy(70,83); $pdf->Cell(20,4,$reg['solicitud'],0,1); 
...
//La Fecha de Registro es a partir del Nombramiento 
    if ($esmayor==1) {
      ...
      $pdf->SetXY(34,$fil+($inc*4));$pdf->Cell(0,0,utf8_decode('                               Resolución No. 067/2022, de fecha 16 de Agosto de 2022'));
      $pdf->SetXY(34,$fil+($inc*5));$pdf->Cell(0,0,utf8_decode('Gaceta Oficial de la República Bolivariana de Venezuela No. 42.447, de fecha 24/08/2022'));
      ...
      $pdf->SetXY(34,$fil+($inc*4));$pdf->Cell(0,0,utf8_decode('Registrador de la Propiedad Industrial. Resolución No. 067/2022, de fecha 16/08/2022'));
      $pdf->SetXY(34,$fil+($inc*5));$pdf->Cell(0,0,utf8_decode('Gaceta Oficial de la República Bolivariana de Venezuela No. 42.447, de fecha 24/08/2022'));
      if ($event902=='S') {
        $pdf->SetXY(34,$fil+($inc*6));$pdf->Cell(0,0,utf8_decode('En virtud de reimpresión por error material involuntario, aun cuando fue suscrito en su oportunidad.'));
      } else {
