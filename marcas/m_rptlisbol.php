...
// Modificado I Semestre 2010 08/06/2010 por Ing. Romulo Mendoza
// Separacion de Marcas y Registro 
// *************************************************************************************
...
if ($tipo=='PERIMIDAS X PUBLICACION PRENSA EXTEMPORANEA') { 
   $resultado=pg_exec("SELECT b.solicitud, b.nombre,b.nro_derecho,b.estatus,b.fecha_solic,a.clase,c.fecha_carga,c.hora_carga
			FROM  stmmarce a, stzderec b, stztmpbo c
			WHERE (c.solicitud between '$varsold' and '$varsolh')
			AND c.boletin = $boletin
	...
	$plazo='15';
	//$fecha_venc = calculo_fechas($fecpub,$plazo,$tipo_plazo);   
   $titulo = $titulo."SOLICITUDES A PERIMIR POR PUBLICACION EN PRENSA EXTEMPORANEA" ;
	$titul =$titul." Entre la solicitud:"." $varsold"." y la:"." $varsolh";
...
$encabezado= Utf8_decode("Listado de Marcas para el Boletín");
...
if ($tipo=='CONCEDIDAS' or $tipo=='SOLICITADAS' or $tipo=='CONCEDIDAS RECLASIF.' or $tipo=='DEVUELTAS FORMA' or $tipo=='DEVUELTAS FONDO'
   or $tipo=='OBSERVADAS' or $tipo=='PRIORIDAD EXTINGUIDA' or $tipo=='PERIMIDAS X PUBLICACION PRENSA EXTEMPORANEA' or $tipo=='PRIORIDAD EXT.PRENSA DEFECTUOSA'   or $tipo=='PERIMIDAS X NO PUBLICACION EN PRENSA' or $tipo=='CADUCAS' or $tipo=='DESISTIDAS' 
