...
if ($vopc==2) {
 ...
 if ($boletin < 602) {
   mensajenew('ERROR: El Boletin a generar y firmar NO puede ser menor al 602 ...!!!','javascript:history.back();','N');   
   $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
 }
 ...
 //echo "$line<br>"; }
   ...
   echo "   </tr>";
   echo "</table>";
   echo "<p align='center'><a href='../marcas/m_gendevolucion.php?vopc=1'><input type='image' name='continuar' value='Continuar' onclick='window.close()' src='../imagenes/apply_f2.png' alt='Continuar' align='middle' border='0' />Continuar</a></p>";
   echo "<br>";
...
$smarty->display('m_gendevolucion.tpl');
$smarty->display('pie_pag.tpl');
}
$sql->disconnect();
?>
