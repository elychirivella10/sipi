...
<?php
// *************************************************************************************
// Programa: m_ingcombol.php 
// Realizado por el Analista de Sistema Romulo Mendoza 
// Coordinación de Informática / Dirección de Soporte Administrativo / SAPI / MICO
// Desarrollado en Año: 2015 II Semestre
// *************************************************************************************
...
$fecha   = fechahoy();
$vopc    = $_GET['vopc'];
$subtitulo = "Pago de Derechos de Registros de Marcas en Dolares";

// ****************************************
$smarty->assign('titulo',$substmar);
$smarty->assign('subtitulo','Pago de Derechos de Registros de Marcas en Dolares'); 
...
$smarty->assign('campo1','Comprobante No.:');
$smarty->assign('campo2','Pago correspondiente al Bolet&iacute;n No.:');
if ($vopc==1) {
...
//$manphp = vman_php("m_ingfacbol.php");
//if ($manphp==1) {
...
$smarty->display('m_ingcombol.tpl');
