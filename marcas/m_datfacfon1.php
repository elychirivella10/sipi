...
if ($vopc==1) {
  ...
  if ($factura!='') { 
    ...
    if ($objtotdtalle==0) { $nbusfon = 0; }
      ...
      if ($nfac=='F0192784') { $nbusfon = 1; }
      if ($nfac=='F0191509') { $nbusfon = 1; }
      if ($nfac=='F0225966') { $nbusfon = 19; }
    ...
    if ($objtotdtalle==0) { $nbusgra = 0; }
      ...
      if ($nfac=='F0151107') { $nbusgra = 5; } //Solo anexo 5 planillas blancas con los logos, falto una 
      if ($nfac=='F0173210') { $nbusgra = 1; } //Solo anexo 1 planilla blanca  
      if ($nfac=='F0174079') { $nbusgra = 1; } //Solo anexo 1 planilla blanca 
      if ($nfac=='F0184234') { $nbusgra = 3; } //Solo anexo 3 planillas blancas con los logos, falto una para 4. Req. 2014014145
      if ($nfac=='F0172844') { $nbusgra = 0; $nbusfon = 1;}  // Pago 1 Grafica pero realmente debe ser 1 fonetica
      if ($nfac=='F0194610') { $nbusgra = 10; }
      if ($serid=='003') { $prioridad='B'; $prioridad1='B'; }
      else  { $prioridad='A'; $prioridad1='A'; }
    }
   //if ($nfac=='F0203971') { $nbusgra = 0; $nbusfon = 1;}  // Pago 1 Grafica pero realmente debe ser 1 fonetica
   if ($nfac=='F0200709') { $nbusgra = 1; $nbusfon = 0; }
   if ($nfac=='F0219032') { $nbusfon = 4; $nbusgra = 0;}
   if ($nfac=='F0219035') { $nbusfon = 1; $nbusgra = 4;}
...
$smarty->display('m_datfacfon1.tpl');
