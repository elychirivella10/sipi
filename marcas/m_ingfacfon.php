...
$fecha   = fechahoy();
$vopc    = $_GET['vopc'];
$subtitulo = "Carga de Solicitud de B&uacute;squeda Fon&eacute;tica";

// ****************************************
$smarty->assign('titulo',$substmar);
$smarty->assign('subtitulo','Carga de Solicitud(es) de B&uacute;squeda(s) Fon&eacute;tica'); 
...
$manphp = vman_php("m_ingfacfon.php");
if ($manphp==1) {
...
$smarty->display('m_ingfacfon.tpl');
