...
$fecha   = fechahoy();
$vopc    = $_GET['vopc'];
$subtitulo = "Carga de Solicitud de B&uacute;squeda Fon&eacute;tica y/o Gr&aacute;ficas";

// ****************************************
$smarty->assign('titulo',$substmar);
$smarty->assign('subtitulo','Carga de Solicitud(es) de B&uacute;squeda(s) Fon&eacute;tica y/o Gr&aacute;ficas'); 
...
$smarty->assign('campo1','Ingrese No Factura:');
$smarty->assign('campo2','Ingrese Clave:');
...
//MensageError('AVISO: M&oacute;dulo Fuera de Servicio por Aviso Oficial del 07/05/2015 publicado en nuestro portal, contacte al Administrador del Sistema ...!!!','N');
...
$smarty->display('m_ingfacfon1.tpl');
