...
include ("../z_includes.php");
   ...
   //$vtipest=array(1006,1101,1390,1200,1116,1003,1025,1023,1024,1030,1750,1910,1125,1130,1914,1996,1913);
   //$vtipsol=array("Solicitadas","Concedidas","Concedidas Reclasificadas","Devueltas Forma","Devueltas Fondo","Observadas","Prioridad Extinguida", " Prioridad Ext. Extemporanea", "Prioridad Ext. Defectuosa", "Perimidas X No Publicacion en Prensa", "Caducas", "Desistidas","Desistimiento de Observaciones","Desistim. Observaciones Mejor Derecho", "Desistimiento de Observacion x Ley","Caducas por No Renovacion","Registros No Renovados"); 
   
   $vtipest=array(1006,1200,1116,1003,1023,1024,1030,1910,1125,1130,1914);
   $vtipsol=array("Solicitadas","Devueltas Forma","Devueltas Fondo","Observadas","Prioridad Ext. Extemporanea", "Prioridad Ext. Defectuosa", "Perimidas X No Publicacion en Prensa","Desistidas","Desistimiento de Observaciones","Desistim. Observaciones Mejor Derecho", "Desistimiento de Observacion x Ley"); 
...
if ($vtip==1030) {
   $resul=pg_exec("SELECT b.solicitud, b.nombre,b.nro_derecho,b.agente, b.tramitante, a.modalidad,a.clase, a.distingue 	
	...
	ORDER BY b.solicitud");
         ...
         $cantreg = pg_numrows($resul);
         if ($cantreg==0) {
	  $mensaje=$mensaje."No existen  Permidas X No Publicaci\F3n en Prensa "; }
	 else {
         $reg = pg_fetch_array($resul); 
	 $archivo = "@ENCAB00=REPUBLICA DE VENEZUELA, MINISTERIO DE INDUSTRIA Y COMERCIO - SERVICIO AUTONOMO DE LA PROPIEDAD INTELECTUAL"."\n"."\n";
	 $archivo = $archivo."@TEXTO01=Caracas,"."\n"."\n";
...
//generacion del TXT 
  ...
  $smarty ->assign('subtitulo','Generaci\F3n de Archivos del Boletin para Ventura'); 
  $smarty->assign('login',$usuario);
  $smarty->assign('fechahoy',$fecha);
  $smarty->display('encabezado1.tpl');
  mensajebrowse("Proceso Terminado...!!",'m_gentxt.php');
  ...
  exit();    
   ...
   //Asignaci\F3n de variables para pasarlas a Smarty
   ...
   $smarty ->assign('titulo','Sistema de Marcas'); 
   $smarty ->assign('subtitulo','Generaci&oacute;n de Archivos de Marcas del Bolet&iacute;n para Ventura'); 
   ...
   $smarty ->assign('espacios','\A0\A0\A0\A0\A0\A0\A0\A0\A0\A0\A0\A0'); 
   $smarty->display('encabezado1.tpl');
   $smarty ->display('m_gentxt.tpl'); 
   $smarty->display('pie_pag.tpl');
?>
