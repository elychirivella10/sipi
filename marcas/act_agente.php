...
if ($vsol=='-') 
   {echo "<hr>";
   echo "<p align='center'><b>Introduzca primero el numero de Solicitud que desea Incluir</b>";
   echo "<hr>";
...
<div align="center">
 ...
 if ($vmod=='Buscar/Eliminar'  || $vmod=='Eliminar')
  {$resultado=pg_exec("SELECT * FROM tmpagenr WHERE solicitud='$vsol' and tipo_mp='$vtipo'");
   ...
   echo "<p align='center'><b>Selecciones los Agentes que desea eliminar:</b></p>";
   echo "<table border='1' cellpadding='0' cellspacing='0' width='100%'>";
   echo "<tr>";
   echo " <td width='1%' bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font color='#000000'></font>Sel</td>";   
   echo " <td width='10%' bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font color='#000000'>CODIGO</font></td>";
 ...
 if ($vmod=='Ver')
  {$resultado=pg_exec("SELECT * FROM tmpagenr WHERE solicitud='$vsol' and tipo_mp='$vtipo'");
   $reg=pg_fetch_array($resultado);
   $filas_found=pg_numrows($resultado);
   echo "<p align='center'><b>AGENTES ASOCIADOS A LA SOLICITUD $vsol:</b></p>";
   echo "<table border='1' cellpadding='0' cellspacing='0' width='100%'>";
   echo "<tr>";
   echo " <td width='10%' bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font color='#000000'>CODIGO</font></td>";
   echo " <td width='40%' bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font color='#000000'>NOMBRE</font></td>";
