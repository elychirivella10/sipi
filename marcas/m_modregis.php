...
<?php
// *************************************************************************************
// Programa: m_modregis.php 
// Realizado por el Analista de Sistema Romulo Mendoza 
// Coordinación de Informática / Dirección de Soporte Administrativo / SAPI / MILCO
// Desarrollado Año: 2006
// Modificado Año 2009 I Semestre BD - Relacional 
// *************************************************************************************
...
if ($vopc==3) {
  $smarty->assign('subtitulo','Modificaci&oacute;n de Registros'); }
if ($vopc==4) {
  $smarty->assign('subtitulo','Modificaci&oacute;n de Registros '.$nveces); }
$smarty->assign('login',$usuario);
$smarty->assign('fechahoy',$fecha);
$smarty->display('encabezado1.tpl');

//if (($usuario=='mcastellano') || ($usuario=='fobando') || ($usuario=='dadiaz')) { }
//else {
...
if ($vopc==1) {
  ...
  if (($estatus==1555)) { }
    ...
    mensajenew("Solo se pueden modificar Marcas Registradas - Estatus 555 ...!","m_modregis.php?vopc=4&vaccion=2&vauxnum=0","N");
    $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
  }
...
if (($vopc==2) || ($vopc==6)) {
  ...
  $req_fields = array("fecha_solic","fecha_regis","fecha_venc","tipo_marca","modalidad","distingue");
  $valores = array($fecha_solic,$fecha_regis,$fecha_venc,$tipo_marca,$modalidad,$distingue);
  ...
  if ($accion==1) {
    ...
    $insert_str = "'$fechahoy','$horactual','$dirIP','$usuario','$varsol','$varreg','M','m_modregis.php'"; 
    ...
    poder='$vpoder',agente=$vcodage,tramitante='$tramitante',pais_resid='$input2',fecha_regis='$fecha_regis',fecha_venc='$fecha_venc'";
    ...
    if ($numtitu==0 AND $numccv==0 AND $inslema AND $inslogo AND 
      ...
      Mensajenew("DATOS GUARDADOS CORRECTAMENTE ...!!!","m_modregis.php?vopc=4&nconexion=".$nconexion,"S");
      $smarty->display('pie_pag.tpl'); exit();
    } 
    else {
