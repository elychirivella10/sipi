...
if ($vopc==1) {
   ...
   if (empty($vsol1) && empty($vsol2)) {
      mensajenew("No introdujo ningún valor de Expediente ...!!!","m_reversarfondo.php","N");
...
if (!$resultado) { 
     mensajenew("Nro. de Expediente ingresado NO existe en la Base de Datos ...!!!","m_reversarfondo.php","N");
     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
   }
$filas_found=pg_numrows($resultado); 
if ($filas_found==0) {
     mensajenew("No existen Datos asociados al Expediente en Maestra de Marcas ...!!!","m_reversarfondo.php","N");
     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
   } 
...
if ($filas_found==0) {
  Mensajenew("No existen Eventos de Tramite para la Solicitud ...!!!","m_reversarfondo.php","N");
  $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
} 
...
$smarty->display('m_reversofon1.tpl');
