...
$smarty ->assign('subtitulo','Devoluci&oacute;n de Forma (L.P.I. 10/12/1956) NUEVO FORMATO'); 
...
$vuser = $usuario;
   ...
   $vcausa25=$_POST['causa25']; $vsubcausa1=$_POST['subcausa1']; $vsubcausa2=$_POST['subcausa2']; 
   ...
   $manphp = vman_php("m_devoluci56n.php");
   if ($manphp==1) {
     $sql->disconnect(); 
   ...
   if ($vopc==1) {
      ...
      if (!$resultado) { 
         $sql->disconnect(); 
         //$smarty->display('encabezado1.tpl');
         mensajenew('ERROR AL PROCESAR LA BUSQUEDA','m_devoluci56n.php','N');
	 $smarty->display('pie_pag.tpl'); exit(); 
      }	 
      ...
      if ($filas_found==0) {
         $sql->disconnect();
         //$smarty->display('encabezado1.tpl');
         mensajenew('NO EXISTEN DATOS ASOCIADOS','m_devoluci56n.php','N');
	 $smarty->display('pie_pag.tpl'); exit(); 
      }	 
	...
	$smarty ->assign('lcausadev','Causales de Devoluci&oacute;n - Examen de Forma:'); 
        ...
        $sql->disconnect();
        //$smarty->display('encabezado1.tpl');
        mensajenew('Solo Aplica en Solicitudes que tengan Estatus: 1','m_devoluci56n.php','N');
	$smarty->display('pie_pag.tpl'); exit(); 
      }
   }
   ...
   if ($vopc==3) {
    ...
    if($vsubcausa16=='on'){$vsc16='X';}
      ...
      $allcausas = $vc1.$vc2.$vc3.$vc4.$vc5.$vc6.$vc7.$vc8.$vc9.$vc10.$vc11.$vc12.$vc13.
      			   $vc14.$vc15.$vc16.$vc17.$vc18.$vc19.$vc20.$vc21.$vc22.$vc23.$vc24.$vc25.
	 ...
	 $smarty->display('pie_pag.tpl'); exit();  
      ...
      if ($vest-1000==1) { //Esta bien
      } else {
         $sql->disconnect(); 
         //$smarty->display('encabezado1.tpl');
         mensajenew($vest.'ERROR: PROBLEMA AL INTENTAR GRABAR - La solicitud ha sido modificada por otro usuario ...!!!','m_devoluci56n.php','N');
	      $smarty->display('pie_pag.tpl'); exit(); 
      }
      ...
      if ($vcausa24=='on') {
        ...
        if (!$ins_de) { $inscaus = $inscaus + 1; } }
      if ($vcausa25=='on') {
        $ins_de=$sql->insert("stzsoldev","$col_campos","'$nderec',25,0,'M','M','M','$vfec','$hh','$vuser'","");
        if (!$ins_de) { $inscaus = $inscaus + 1; } }
      ...
      if ($inscaus==0) { 
        ...
        echo "<p align='center'><a href='m_devoluci56n.php'><img src='../imagenes/apply_f2.png' border='0'></a>  Continuar&nbsp;&nbsp;&nbsp;&nbsp;<a href='m_rptdevform.php?vsol=$vsold&vusr=$usuario' target='_blank'><img src='../imagenes/printmgr.png' border='0'></a> Imprimir </p>";
        $smarty->display('pie_pag.tpl'); exit();   
      }
      else {
   ...
   //$smarty ->display('encabezado1.tpl');
   $smarty ->display('m_devoluci56n.tpl'); 
