...
$objquery = $sql->query("SELECT email,count(email) FROM stmbusqueda WHERE envio='S' GROUP BY email");
//$objs = $sql->objects('',$objquery);
$filas_found=$sql->nums('',$obj_query);
$totemail = $filas_found;
...
$smarty->assign('temail',$totemail);
$smarty->assign('modo','disabled'); 

$smarty->display('m_panelfon.tpl');
