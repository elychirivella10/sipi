...
// Armando el query
$resultado=pg_exec("SELECT stzderec.solicitud, stzderec.nombre, stmmarce.clase, stzderec.registro, stzsolic.nombre as titular, stzderec.agente, trim(tramitante) as tramitante, stzottid.nacionalidad, stzottid.domicilio 
