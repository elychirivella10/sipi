...
$smarty ->assign('fechahoy',$fecha); 
   ...
   if ($vopc==1 || $vopc==2) {
      ...
      if (!$resultado) { 
         ...
         mensajenew('ERROR AL PROCESAR LA BUSQUEDA...!!!','m_marginalfm04.php','N');
	 $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }	 
      $filas_found=pg_numrows($resultado); 
      if ($filas_found==0) {
         $smarty->display('encabezado1.tpl');
         mensajenew('NO EXISTEN DATOS ASOCIADOS...!!!','m_marginalfm04.php','N');
	 $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }	 
      ...
      if ($vreg!='') { //Esta bien 
         ...
         $smarty->display('encabezado1.tpl');
         mensajenew('Solo aplica a MARCAS con REGISTRO ASIGNADO ...!!!','m_marginalfm04.php','N');
	      $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
      }
   ...
   $smarty ->assign('lpropietario','Datos del Titular o Solicitante al momento de presentar la Renovaci&oacute;n'); 
   ...
   $smarty->display('encabezado1.tpl');
   $smarty->display('m_marginalfm04.tpl'); 
