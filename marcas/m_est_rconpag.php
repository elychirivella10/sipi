...
$resultado=pg_exec("SELECT count(*) FROM stzderec a, stzevtrd b
	WHERE a.nro_derecho=b.nro_derecho and tipo_mp='M' and
              ...
              a.nro_derecho in (select nro_derecho from stzevtrd where evento=1066)".$pquery2);
...
// Setup the titles
if ($boletin2==$boletin) {
$graph->title->Set("RELACION DE MARCAS CONCEDIDAS Y PAGADAS".$ptit." (Boletin ".$boletin.")\n \n "); 
} else {
$graph->title->Set("RELACION DE MARCAS CONCEDIDAS Y PAGADAS".$ptit." (Boletines: ".$boletin."-".$boletin2.")\n \n ");
}
...
<tr><td class="cnt"><a href="m_est_rconpag.php?vopc=0"><img src="../imagenes/salir_f2.png" border="0"></a>  Salir  </td></tr></table><?php
...
$smarty->display('m_est_rconpag.tpl');
$smarty->display('pie_pag.tpl');
}
