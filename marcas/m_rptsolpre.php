...
$where = $where." and stzevtrd.evento=1200 ";	
...
// Armando el query
$resultado=pg_exec("SELECT stzderec.solicitud,stzderec.fecha_solic,stzderec.nombre,stmmarce.clase,stmmarce.ind_claseni,stzderec.tipo_derecho,stzderec.tramitante,stzderec.agente,stzderec.poder,stmmarce.modalidad,stzsolic.nombre as ntitular,stzottid.domicilio,stzottid.nacionalidad,stzevtrd.fecha_trans,stzevtrd.hora,stzevtrd.usuario
