...
// Armando el query
$resultado=pg_exec("SELECT stzderec.nro_derecho,stzderec.solicitud,stzderec.fecha_solic,stzderec.tipo_derecho,stzderec.nombre,stzderec.poder,stmmarce.clase,stmmarce.ind_claseni,stzderec.estatus,stzevtrd.comentario
...
//Dibujando la Tabla 
 for($cont=0;$cont<$filas_resultado;$cont++) { 
	...
	$result = pg_exec("SELECT stzottid.titular, stzsolic.nombre, stzottid.nacionalidad, stzottid.domicilio, stzsolic.indole 
