  ...
  //for($cont=0;$cont<50;$cont++) { 
    ...
    //imagen
      ...
      if (($reg['modalidad']!="D") AND file($nameimagen)) {
    		$pdf->Image($nameimagen,116,128,85,80,'JPG');  }
    ...
    if ($esmayor==1) {
      ...
      $fil=286; $inc=3; 
      $pdf->SetXY(2,$fil+($inc*1));$pdf->Cell(0,0,'_______________________________________________');
      $pdf->SetXY(2,$fil+($inc*3));$pdf->Cell(0,0,utf8_decode('Certificado suscrito en fecha: __________________ por la Abog. SUSANA GISELA RAMIREZ ARAQUE'));
      $pdf->SetXY(49,$fil+($inc*3));$pdf->Cell(0,0,$fechahoy);  
