...
$resultado=false;
$subtitulo = "Control de Entrega de Oficios de Devoluci&oacute;n de Marcas";
...
if ($vopc==2) {
  ...
  if ($filas_found == 0) {
    ...
    if (($instcer) AND ($errorgrabar == 0)) {    //Validacion del Numero de Solicitud
      ...
      Mensajenew("Falla de Inserci&oacute;n de Datos en la BD $error_cer $error_reg  ...!!!","javascript:history.back();","N");
      $smarty->display('pie_pag.tpl'); exit();
    }
...
$smarty->assign('campo3','Expedientes:');
