...
if ($vopc==1) {
  ...
  if ($factura!='') { 
    ...
    if ($filas_found==0) {
      mensajenew("ERROR: NO. DE FACTURA ".$nfac." NO SE LE IMPRIMIO PLANILLAS BUSQUEDAS ...!!!","javascript:history.back();","N");
      $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit();	 
    } else {
...
$smarty->assign('factura',$nfac);
$smarty->assign('cantidad',$cant);
$smarty->assign('nplan1',$nplan1);
$smarty->assign('nplan2',$nplan2);
$smarty->assign('fechadep',$fechadep);
...
$smarty->display('m_datplanbus1.tpl');
