...
//Modificado por Ing. Romulo Mendoza I Semestre 2022, 22/02/2022 Caducidad por NO Uso  
...
$smarty->display('encabezado1.tpl');
  ...
  //}
   ...
   $vtipest=   array(1002,1023,1024,1030,1006,1101,1390,1200,1116,1003,1011,1025,1750,1910,1914,1125,1130,1913,1996,1102,1846,1564,1800,1801,1802,1803,1804,1805,1806,1807,1808,1809,1821,1822,1823,1824,1825,1830,1831,1833,1835,1836,1837,1838);
   $vtipsol=array("Orden de Publicacion","Perimidas x Publicacion en Prensa Extemporanea","Publicacion Prensa Defectuosa","Perimidas por NO Publicacion Prensa","Solicitadas","Concedidas","Concedidas Reclasificadas","Devueltas de Forma","Devueltas por Fondo","Observadas","Observadas Inadmisible por LOPA","Prioridad Extinguida","Caducas","Desistidas","Desistimiento a Observadas por Ley","Desistimiento de Observaciones","Observacion Mejor Derecho","Registros No Renovados","Caducas por no Renovacion","Negadas","Caducidad por NO Uso","Devolucion de Notas Marginales","Ratificacion Estatus 800","Ratificacion Estatus 801","Ratificacion Estatus 802","Ratificacion Estatus 803","Ratificacion Estatus 804",
   ...
   if ($vopc==1) {
      ...
      if ($vtip==1130) {$codeve=1216; $vcomen="PUBLICACION DE OPOSICION POR MEJOR DERECHO EN BOLETIN $vbol";}
      ...
      if ($vtip==1846) {$codeve=1328; $vcomen="NOTIFICACION PARA SUBSANAR ESCRITO DE CADUCIDAD EN BOLETIN $vbol";}

      //Ratificaciones del Boletin 588 I Parte 
      ...
      //Perimidas por No Ratificaciones del Boletin 588 II Parte 
      //if (($vtip==1800) || ($vtip==1801) || ($vtip==1802) || ($vtip==1803) || ($vtip==1804) || ($vtip==1805) || ($vtip==1806) || ($vtip==1807) ||
      //    ($vtip==1808) || ($vtip==1809) || ($vtip==1821) || ($vtip==1822) || ($vtip==1823) || ($vtip==1824) || ($vtip==1825) || ($vtip==1830) ||
      //    ($vtip==1831) || ($vtip==1833) || ($vtip==1835) || ($vtip==1836) || ($vtip==1837) || ($vtip==1838)) {
      ...
      //  $result=pg_exec("SELECT * FROM stzevder WHERE evento='$codeve'");
      //  $regt = pg_fetch_array($result);
      //  $deseve=$regt[descripcion];
      //  $vcomen=$regt[descripcion];
      //  $plaley=15;
      //  $tippla="H";
      //  //fecha de vencimiento
      //  $fecven=calculo_fechas($vfvig,$plaley,$tippla,'/'); 
