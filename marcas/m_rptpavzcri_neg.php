...
$resestatus=pg_exec("select estatus,descripcion from stzstder where (estatus=1111 or estatus=1102) and tipo_mp ='M' order by estatus");
...
$smarty->display('m_rptpavzcri_neg.tpl');
