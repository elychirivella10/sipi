...
$res_bus=pg_exec("SELECT * FROM stmcntrl WHERE pedido='$vsol1'");
$regbus = pg_fetch_array($res_bus);
$sede= trim($regbus['sede']);
//echo "la sede es $sede con $vsol1 ";
...
if ($vopc==5) {
  if ($vtp==0) {
   ...
   if ($letrafac!='F') {
     ...
     $obj_query = $sql->query("SELECT * FROM stmcvbgra WHERE stmcvbgra.solicitud='$vsol1'ORDER BY stmcvbgra.ccv");
   }
...
if ($vopc==4) {
   ...
   echo "<table border='0' cellpadding='0' cellspacing='0' width='960px'>";
   echo "<tr valign='top'>";
   if ($vtp==0) {
    ...
    if ($sede=='3') {
     ...
     //$imagenbusq="../graficos/logbext/".$vsol1.".jpg";
     $imagenbusq="../graficos/planblog/".$planilla.".jpg";
     if (file($imagenbusq)) { $tipoimg = 1; }
     else {
      //$imagenbusq="../graficos/logbext/".$vsol1.".png";
      $imagenbusq="../graficos/planblog/".$planilla.".png";
      $tipoimg = 2;
     }
     //if (file($buscaimage)) {
     if ($tipoimg==1) { 
     ...
     echo "<td class='celda9' width='50%'>";
     echo "&nbsp;</font></br>";
     echo "&nbsp;&nbsp;Pedido Nro&nbsp;&nbsp;: $vsol1</br>";
     echo "&nbsp;&nbsp;Factura Nro : $recibo</br>";
     echo "&nbsp;&nbsp;de Fecha&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $fecharec</br>";
     echo "&nbsp;&nbsp;en Clase&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $clase I </br>";
     echo "&nbsp;&nbsp;Solicitante&nbsp;&nbsp;: $solicitant </br>";
     echo "&nbsp;&nbsp;Planilla&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: $planilla </br>";
     echo "</td>";
     echo "<td align='center' width='50%'>";
     echo "&nbsp;";
     echo "</td>";
     echo "<td align='right' width='50%'>";
     echo "<font color='#000000'><b>Imagen a Buscar:</b>&nbsp;</font>";
   ...
   if ($vtp==1) {
     ...
     //$imagenbusq="http://imagenes.sapi.gob.ve/marcas/ef".$dirano."/".$vs1.$vs2.".jpg"; 
     //$imagenbusq = "../../../graficos/marcas/ef".$dirano."/".$vs1.$vs2.".jpg"; 
     echo "<td align='center' width='50%'>";
   ...
   $vexp=1;
   $totalf=((int)($total/$topecolum))+1;
   // rango normal de chequeos   
   //for($cont=0;$cont<$filas_resultado;$cont++) {
   $cont=0;
   while ( $cont < $filas_resultado ) {
    $fila = 1;
    while ( $fila <= $topefilas ) {
     echo "<tr>";
     $colu=1;
     while ( $colu <= $topecolum )
     {
       if ($vexp<=$filas_resultado) {
         ...
         for($cont2=0;$cont2<$cantcampos;$cont2++) {
             $namecampo=$vectorcampos[$cont2];
               ...
               case "solicitud":
                 ...
                 //$nameimagen="http://imagenes.sapi.gob.ve/marcas/ef".$dirano."/".$vs1.$vs2.".jpg"; 
                 //$nameimagen = "../../../graficos/marcas/ef".$dirano."/".$vs1.$vs2.".jpg"; 
                 break;
               case "clase":
                 $vclase = $reg['clase'];
         ...
         //echo "<td bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' align='center'><font color='#000000'>Solicitud:<a href='m_rptcronol.php?vsol1={$vs1}&vsol2={$vs2}'>$vs1-$vs2</font><br></a>";
         echo "<td class='Estilo5'>Solicitud:<a href='m_rptcronol.php?vsol1={$vs1}&vsol2={$vs2}'>$vs1-$vs2<br></a>";
         echo "<a href='$nameimagen' target='_blank'><img border='1' src='$nameimagen' width='160' height='160'><br></a>"; 
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input type='submit' class="boton_blue" name='fmodo' value='<?=$modo?>' /> 
   <? if ($new_windows=='S') { ?>
      <input type="button" class="boton_blue" img="../imagenes/salir_f2.png" value="Salir" onclick="cerrarwindows();"> </font></p> 
   <? } else { ?>  
      <input type="button" class="boton_blue" img="../imagenes/salir_f2.png" value="Salir" onclick="location.href='<?=$vurl?>'"> </font></p> 
   <? } ?>
   </table> 
   <!-- </div> -->      
   ...
   if($inicio > 0) {
     ?>
     <!-- <input type="image" src="../imagenes/control_rewind_blue.png" name='fmodo' value="Anteriores <?= min($inicio, $cuanto) ?> " /> Anteriores <?= min($inicio, $cuanto) ?> -->   
   ...
   if($total - $inicio > $cuanto) {
     ?>
     <!-- <input type='image' src="../imagenes/control_fastforward_blue.png" name='fmodo' value='Siguientes <?= min(($total - ($inicio + $cuanto)), $cuanto)?>' /> Siguientes <?= min(($total - ($inicio + $cuanto)), $cuanto)?> -->
