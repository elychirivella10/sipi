...
// Desarrollado Año: 2022 II Semestre
// *************************************************************************************
...
$smarty->assign('subtitulo','Generaci&oacute;n de Oficios de Devoluci&oacute;n Fondo x Bolet&iacute;n sin Firma Digital');
...
if ($vopc==2) {
 ...
 exec($cmd,$salida);
   ...
   echo "   </tr>";
   echo "</table>";
   echo "<p align='center'><a href='../marcas/m_devfonsinfir.php?vopc=1'><input type='image' name='continuar' value='Continuar' onclick='window.close()' src='../imagenes/apply_f2.png' alt='Continuar' align='middle' border='0' />Continuar</a></p>";
   echo "<br>";
...
$smarty->display('m_devfonsinfir.tpl');
$smarty->display('pie_pag.tpl');
}
$sql->disconnect();
?>
