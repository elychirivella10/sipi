...
if ($vopc==3) {
   ...
   echo "<tr>";
   if ($vtp==1) {
     echo "<form name='formab' method='POST' action='z_browvie.php?vopc=1&vtp=1'>"; }
   else {
     echo "<form name='formab' method='POST' action='z_browvie.php?vopc=1&vtp=0'>"; }
