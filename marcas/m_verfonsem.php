...
$resul=pg_exec("SELECT distinct on (b.solicitud) a.expediente,b.solicitud,b.nro_derecho,b.tipo_derecho,c.modalidad,b.estatus,b.fecha_solic,b.nombre,c.clase,c.ind_claseni,b.registro,a.porc,a.partebusq 
                    INTO TEMP semejantes FROM stmfondo a,stzderec b,stmmarce c WHERE a.expediente like '$vsoli' AND a.expediente!='0000-000000' AND a.solicitud=b.solicitud AND b.nro_derecho=c.nro_derecho AND b.tipo_mp='M' AND a.partebusq='S'");

$resultado=pg_exec("SELECT * FROM semejantes ORDER BY 12 DESC,2");

$filas_found=pg_numrows($resultado); 
echo "<table style='font-size:13' border='1' width='100%' cellpadding='0' cellspacing='0'>";
echo "<tr><td bgcolor='#CCCCCC' align='center' width='02%'></td>";
...
echo "    <td bgcolor='#CCCCCC' align='center' width='30%'>Titular.</td>";
echo "    <td bgcolor='#CCCCCC' align='center' width='01%'>%</td></tr>";
for ($cont=0;$cont<$filas_found;$cont++) {
    ...
    echo "<tr><td bgcolor='#CCCCCC' bordercolorlight='#FFFFFF' 
          align='center' width='02%'><font color='#0000FF'>";
    echo $cont+1;
