...
if ($vopc==1) {
   ...
   if (empty($vsol1) && empty($vsol2)) {
      mensajenew("ERROR: No introdujo ning&uacute;n valor de Expediente ...!!!","m_evpagoexo.php","N");
...
if (!$resultado) { 
     mensajenew("ERROR: Nro. de Expediente ingresado NO existe en la Base de Datos ...!!!","m_evpagoexo.php","N");
     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
   }
$filas_found=pg_numrows($resultado); 
if ($filas_found==0) {
     mensajenew("ERROR: No existen Datos asociados al Expediente en Maestra de Marcas ...!!!","m_evpagoexo.php","N");
     $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit(); 
   } 
...
for($cont=0;$cont<$filas_res_evento;$cont++) 
  { 
