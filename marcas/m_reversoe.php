...
if (($usuario=='ngonzalez') || ($usuario=='rmendoza')) { }
  ...
  $smarty->display('pie_pag.tpl'); $sql->disconnect(); exit();
   ...
   for($cont=1;$cont<=$filas_found;$cont++) 
   { 
     $arraycodeve[$cont]=$objs->evento-1000;
   ...
   if ($vopc==3) {
      ...
      $vcodeve=$vcodeve+1000;
      $vcodest=$vcodest+1000; 
	 ...
	 $reg = pg_fetch_array($resul);
      ...
      if ($error_t==0) {
         ...
         $sql->disconnect();
         $smarty->display('encabezado1.tpl');
         mensajenew("Se Reversaron $filasr Solicitudes Correctamente",'m_reversoe.php','S');
         $smarty->display('pie_pag.tpl'); exit(); }
      } else {
