...
if(!empty($pais)) { 
	if(!empty($where)) {
       if ($opelog=='=') {$where = $where." and"." (stzderec.pais_resid = '$pais')";
                          $titulo= $titulo." Pais="." $pais";}
                    else {$where = $where." and"." (stzderec.pais_resid <> '$pais')";
                          $titulo= $titulo." Pais<>"." $pais";}  
	}
	else { 
       if ($opelog=='=') {$where = $where." (stzderec.pais_resid = '$pais')";
                          $titulo= $titulo." Pais="." $pais";}
                    else {$where = $where." (stzderec.pais_resid <> '$pais')";
                          $titulo= $titulo." Pais<>"." $pais";}
	}
}
if(!empty($nombre)) { 
