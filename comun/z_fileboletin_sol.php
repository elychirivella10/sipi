...
//Crea el archivo
$vruta="../../sms/";
$txt=$vruta.'Boletin'.$boletin.'_sms_solicitadas.txt';
$open=fopen($vruta.'Boletin'.$boletin.'_sms_solicitadas.txt',"w+");
...
fclose($open);  
 ...
 $adjuntos[$count+1]['filename']=$vruta.'Boletin'.$boletin.'_sms_solicitadas.txt';
...
$smarty->display('z_fileboletin_sol.tpl');
$smarty->display('pie_pag.tpl');
...
// $mail->Subject = "Envio de Solicitud(es) de Busqueda(s) en Linea, Tramite WEBPI No. ".$tramite;
 ...
 $mail->Subject = "SAPI - Mensajes de Texto - Boletin ".$boletin." - SOLICITADAS de MARCAS";
...
//  $mail->AddAttachment($filetxt);
 ...
 $body .= "Anexo al presente, se hace entrega de archivo plano con los datos de las solicitudes de marcas publicadas como SOLICITADAS ";
