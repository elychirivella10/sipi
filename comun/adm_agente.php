...
if ($vsol=='-') 
   {echo "<hr>";
   echo "<p align='center'><font class='nota3'><b>Introduzca primero el Agente que desea Incluir</b></font>";
   echo "<hr>";
...
$hiddenvars['total']=$total;
 ...
 if ($vmod=='Buscar/Incluir' || $vmod=='Buscar')  {
   ...
   if ($filas_resultado==0) {
       echo "<p align='center'><font class='nota3'><b>AVISO: NO EXISTE EL AGENTE ASOCIADO ...!!!</b></font></p>"; 
       ?>
       <form action="../comun/m_gbagente.php" name="formtitular" method="POST" >
       <?php
   ...
   echo " <td width='40%' class='celda4'><small>Nombre</small></td>";
   echo " <td width='45%' class='celda4'><small>Domicilio</small></td>";
   echo "</tr>";
   echo "<form name='formti' action='../comun/m_gbagente.php' method='POST'>";
   for($cont=0;$cont<$filas_resultado;$cont++) {
     echo "<tr>";
     echo " <td width='1%'  class='celda3'><input type='checkbox' name='B$cont'></td>";
     echo " <td width='10%' class='celda3'><small>$reg[agente]</small></td>";
     echo " <td width='40%' class='celda3'><small>$reg[nombre]</small></td>";
     echo " <td width='45%' class='celda3'><small>$reg[domicilio]</small></td>";
     echo "</tr>";
   ...
   echo "</form>";
   echo "<form method='POST' action='adm_agente.php?vsol=$vsol&vmod=$vmod&vtex=$vtex&vder=$vder'>"; 
?>
...
<div align="center">
 ...
 if ($vmod=='Buscar/Eliminar' || $vmod=='Eliminar')
  {$resultado=pg_exec("SELECT * FROM stztmpage WHERE solicitud='$vsol' AND tipo_mp='$vder'"); 
   $reg=pg_fetch_array($resultado);
   ...
   echo "<p align='center'><font class='nota3'><b>Seleccione los Agentes que desea eliminar:</b></font></p>";
   ...
   echo " <td width='40%' class='celda4'>Domicilio</td>";
   echo "</tr>";
   for($cont=0;$cont<$filas_found;$cont++) {
     echo "<tr>";
     echo " <td width='1%'  class='celda3'><input type='checkbox' name='B$cont'></font></td>";
     echo " <td width='10%' class='celda3'>$reg[agente]</td>";
     echo " <td width='40%' class='celda3'>$reg[nombre]</td>";
     echo " <td width='40%' class='celda3'>$reg[domicilio]</td>";
   ...
   echo "</table>"; 
   if ($filas_found==0){echo "<p align='center'><font class='nota3'>AVISO: SOLICITUD NO PRESENTA AGENTE(S) ASOCIADO(S)</font></p>";
      echo "<p align='center'><font color='#0000FF'>
   ...
   {  echo "<p align='center'><font color='#0000FF'>";
      ...
      echo "<input type='image' src='../imagenes/boton_eliminar_rojo.png' value='Guardar'>
