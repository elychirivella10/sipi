...
$smarty->assign('subtitulo','Mantenimiento de Representante Legal');
...
if ($vsol=='-') 
   {echo "<hr>";
   echo "<p align='center'><font class='nota3'><b>Introduzca primero el Representante Legal que desea Incluir</b></font>";
   echo "<hr>";
 ...
 if ($vmod=='Buscar/Incluir' || $vmod=='Buscar')
  {$resultado=pg_exec("SELECT * FROM stzsolic WHERE nombre like '%$vtex%' ORDER BY nombre OFFSET $inicio LIMIT $cuanto");
   ...
   if ($filas_resultado==0){
       echo "<p align='center'><font class='nota3'><b>INGRESO DE REPRESENTANTE LEGAL NUEVO</p></b></font>"; 
       ?>
       <form action="../comun/m_gbrepre.php" name="formtitular" method="POST" >
       <?php
       echo "<p><small><I><b><blink><U>RECUERDE EL CARACTER OBLIGATORIO DE:</U></blink> Cargar el <blink>RIF</blink> en caso de Empresas Nacionales y/o <blink>CEDULA DE IDENTIDAD</blink> del representante legal, el cual se encuentra en el expediente por ser requisito para su presentaci&oacute;n; ademas de seleccionar la <blink>INDOLE</blink> del mismo. </b></I></small><p>";
...
//Insertado
       ...
       echo "<tr><td></td></tr>";
       echo "<tr>";
       echo " <td width='23%' class='izq-color'><small><b>* Cargo que ejerce:</b></small></td>";
       echo " <td width='77%' class='der-color'>";
       echo "  &nbsp;<input type='text' name='vcargo' size='78' maxlength='200'></font></td>";
       echo "</tr>";
       echo "<tr><td></td></tr>";
       echo "<tr>";
       echo " <td width='23%' class='izq-color'><small><b>* Caracter con el que actua:</b></small></td>";
       echo " <td width='77%' class='der-color'>";
       echo "  &nbsp;<input type='text' name='vcarac' size='78' maxlength='200'></font></td>";
       echo "</tr>";
// Fin insertado
       echo "<tr><td></td></tr>";
       echo "<tr>";
...
<?php
   echo "<p align='center'><font class='nota3'><b>Seleccione el Represntante Legal que desea Incluir:</b></font></p>";
   echo "<p><small><I><b><blink><U>RECUERDE EL CARACTER OBLIGATORIO DE:</U></blink> Cargar el <blink>RIF</blink> en caso de Empresas Nacionales y/o <blink>CEDULA DE IDENTIDAD</blink> del representante legal, el cual se encuentra en el expediente por ser requisito para su presentaci&oacute;n; ademas de seleccionar la <blink>INDOLE</blink> del mismo. </b></I></small><p>";
   ...
   echo "</tr>";
   echo "<form name='formti' action='../comun/m_gbrepre.php' method='POST'>";
...
// Fin insertado 2
   ...
   echo "</form>";
   echo "<form method='POST' action='adm_repre.php?vsol=$vsol&vmod=$vmod&vtex=$vtex&vder=$vder'>"; 
?>
   <!-- <p align='center'><I><b><font class='nota4'>Mostrando <?= $inicio + 1 ?>-<?= min($inicio + $cuanto, $total) ?> de <?= $total?> ocurrencias encontradas </font></b></I></p> -->
<div align="center">
   <?php
 ...
 if ($vmod=='Buscar/Eliminar' || $vmod=='Eliminar')
  {$resultado=pg_exec("SELECT * FROM stztmprepre WHERE solicitud='$vsol' AND tipo_mp='$vder'");
   $reg=pg_fetch_array($resultado);
   ...
   echo "<p align='center'><b>Selecciones los Representantes Legales que desea Eliminar:</b></p>";
   echo "<table border='1' cellpadding='0' cellspacing='1' width='100%'>";
   echo "<tr>";
   ...
   echo "</table>"; 
   if ($filas_found==0){echo "<p align='center'><font class='nota3'>NINGUN REPRESENTANTE LEGAL ASOCIADO</font></p>";
      echo "<p align='center'><font color='#0000FF'>
 ...
 if ($vmod=='Modificar') {
   ...
   if (empty($vtex) OR ($vtex1c!='-') OR (!is_numeric($vtit))) {
     ...
     echo "<tr><td>";
     echo "<p align='center'><b>Introduzca primero el C&oacute;digo del Representante Legal que desea Modificar ... !!!</b>";
   ...
   if ($vtex1c=='-') {
     $resultado=pg_exec("SELECT * FROM stztmprepre WHERE solicitud='$vsol' AND tipo_mp='$vder' AND titular='$vtit'");
   }
   $reg=pg_fetch_array($resultado);
   $filas_found=pg_numrows($resultado);
   if ($filas_found==0) {
     ...
     echo "<table width='100%' border='0' cellpadding='0' cellspacing='1'>";
     echo "<tr><td>";
     echo "<p align='center'><b>C&oacute;digo del Representante Legal NO pertenece a la Solicitud ... !!!</b>";
     echo "<p align='center'><font color='#0000FF'><input type='button' value='Aceptar' name='aceptar' onclick='window.close();' class='boton_blue'></font></p>";
     echo "</td></tr>";
     echo "</table>";
     echo "</fieldset>";
   ...
   if ($filas_found>0) {
      ...
      $vcargo=trim($reg[cargo]);
      $vcarac=trim($reg[caracter]);
   ...
   echo "<form name='formtitular' action='m_gbrepre' method='post'>";
   ...
   echo "<tr><td>";
   echo "<fieldset>";
   echo "<legend align='center'><strong>DATOS DEL REPRESENTANTE LEGAL</strong></legend>";  
   echo "<table width='100%' border='0' cellpadding='0' cellspacing='1'>";
   echo " <tr><td>&nbsp;</td></tr>";
   echo " <tr>";
   echo " <td class='der8-color'>C&oacute;digo del Representante Legal:</td>";
...
//Fin insertado 3
 ...
 if ($vmod=='Corregir') {
   ...
   if (empty($vtex) OR ($vtex1c!='-') OR (!is_numeric($vtit))) {
     ...
     echo "<table width='100%' border='0' cellpadding='0' cellspacing='1'>";
     echo "<tr><td>";
     echo "<p align='center'><b>Aviso: Introduzca primero el C&oacute;digo del Representante Legal que desea Corregir ... !!!</b>";
     echo "<p align='center'><font color='#0000FF'><input type='button' value='Aceptar' name='aceptar' onclick='window.close();' class='boton_blue'></font></p>";
     echo "</td></tr>";
     echo "</table>";
     echo "</fieldset>";
   ...
   echo "<tr><td>";
   echo "<fieldset>";
   echo "<legend align='center'><strong>CORRECCION DE DOMICILIO Y PAIS DEL REPRESENTANTE LEGAL</strong></legend>";  
   echo "<table width='100%' border='1' cellpadding='0' cellspacing='1'>";
   //echo " <tr><td>&nbsp;</td></tr>";
   echo " <tr>&nbsp;</tr>";
   echo " <tr>";
   echo " <td class='izq-color'>C&oacute;digo del Representante Legal:</td>";
