...
if ($vopc==2) {
 ...
 FROM stzderec a, stzevtrd b, stzottid c, stzsolic d
	WHERE a.nro_derecho=b.nro_derecho and a.tipo_mp='M' and
              ...
              b.evento-1000 in (122,181,182) and b.estat_ant-1000 in (101,390,399) and
...
//Crea el archivo
$vruta="../../sms/";
$txt=$vruta.'Boletin'.$boletin.'_sms_concedidas.txt';
$open=fopen($vruta.'Boletin'.$boletin.'_sms_concedidas.txt',"w+");
...
fclose($open);  
 ...
 $adjuntos[$count+1]['filename']=$vruta.'Boletin'.$boletin.'_sms_concedidas.txt';
...
$smarty->display('z_fileboletin_con.tpl');
$smarty->display('pie_pag.tpl');
...
// $mail->Subject = "Envio de Solicitud(es) de Busqueda(s) en Linea, Tramite WEBPI No. ".$tramite;
 ...
 $mail->Subject = "SAPI - Mensajes de Texto - Boletin ".$boletin." - CONCEDIDAS de MARCAS";
...
//  $mail->AddAttachment($filetxt);
 ...
 $body .= "Anexo al presente, se hace entrega de archivo plano con los datos de las solicitudes de marcas publicadas como CONCEDIDAS ";
