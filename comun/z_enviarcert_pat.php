...
$smarty->display('encabezado1.tpl');
 ...
 // Pase al Servidor de Firma Electronica
  $cmd= "scp /apl/certificados/patentes/*.pdf www-data@172.16.0.10:/var/www/apl/sifel/documentos/certificado/patentes";
  $cmd= "rsync /apl/certificados/patentes/*.pdf www-data@172.16.0.10:/var/www/apl/sifel/documentos/certificado/patentes";
    exec($cmd,$salida);
      echo $cmd."<br>";
      echo $salida."<br>";
...
//		$cmd= 'rm -f /apl/certificados/patentes/*.pdf';
//		exec($cmd,$salida); 	
		  
$smarty->display('z_enviarcert_pat.tpl');
