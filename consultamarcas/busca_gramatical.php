...
$vsel=    $_GET['vsel'];
$vtex=    strtoupper($_GET['vtex']);

echo "parametros= $vsel, $vtex ";
...
if (!empty($vtex)) {$count_criterios++;
    if (strlen($vtex)<3)
       {echo "<hr>";
       echo "<p align='center'><b>EL TEXTO PARA BUSQUEDAS POR NOMBRE DEBE CONTENER AL MENOS 3 LETRAS...!</b>";
       echo "<hr>";
...
if (empty($count_criterios)) 
   {echo "<hr>";
   echo "<p align='center'><b>DEBE INGRESAR UNO O VARIOS CRITERIOS DE BUSQUEDAS...!</b>";
   echo "<hr>";
   echo "<table border='0' cellpadding='0' cellspacing='0' width='100%' height='15'>";
...
if ($filas_resultado==0) 
   {
   echo "<hr>";     
   echo "<p align='center'><b>NO EXISTEN DATOS ASOCIADOS...!</b>\n"; 
   echo "<hr>";
   //pg_close($conexdb);
...
<table border="0" cellpadding="1" cellspacing="1" width="95%" align="center">
  ...
  <?php    
   ...
   for($cont=0;$cont<$filas_resultado;$cont++) 
     ...
     echo "<td width='12%' style='background-color: #87cefa; border: 1 solid #D8E6FF'><font face='Tahoma'><a href='busca_marcas_n.php?vnsol=$vsol&vusuario=$vtipuser&lastupdate=$lastupdate'>$vsol</a></font></td>";
     echo "<td width='12%' style='background-color: #87cefa; border: 1 solid #D8E6FF'><font face='Tahoma'>$varfecha</td>";
     echo "<td width='3%' style='background-color: #87cefa; border: 1 solid #D8E6FF'><font face='Tahoma'>$reg[tipo_marca]</td>";
