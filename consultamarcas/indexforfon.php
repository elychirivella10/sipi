...
<?php 
  ...
  echo "<form name='formarca' action='busca_marforfon.php?vopc=1&vusuario=$vtipuser' method='POST'>"; 
?>
...
<br /><br />
<!-- <?php $vtipuser=5; echo "<form action='busca_marcas_n.php?vopc=2&vusuario=$vtipuser' method='POST'>";  ?>
