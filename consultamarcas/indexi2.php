...
<?php 
  ...
  echo "<form name='formarca' action='busca_marcas_n.php?vopc=1&vusuario=$vtipuser' method='POST'>"; 
?>
...
<br /><br />
<?php $vtipuser=6; echo "<form action='busca_marcas_n.php?vopc=2&vusuario=$vtipuser' method='POST'>"; ?>
...
<br /><br />
<?php echo "<form action='busca_marcas_t.php?vusuario=$vtipuser' method='POST'>"; ?>
...
//   echo "<p align='center'><font size='1' face='Tahoma'><input type='submit' class='boton_blue' value='Busqueda Avanzada' name='B2'></font>";
//   echo "</form>";
//  }
?>
  <td>
